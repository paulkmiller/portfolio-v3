import { defineComponent, computed, ref, watchEffect, openBlock, createElementBlock, withDirectives, createElementVNode, isRef, vModelText, unref, toDisplayString, createCommentVNode, createTextVNode, createVNode, withKeys, withModifiers, Fragment, renderList, normalizeClass, createBlock } from "@histoire/vendors/vue";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        withDirectives(createElementVNode("input", {
          ...
          required: __props.prompt.required,
          tabindex: "-1",
        ...
        createElementVNode("label", _hoisted_3, [
          createElementVNode("span", _hoisted_4, [
            createElementVNode("span", null, toDisplayString(__props.prompt.label), 1),
            __props.prompt.required ? (openBlock(), createElementBlock("span", _hoisted_5, "*")) : createCommentVNode("", true),
        ...
        createElementVNode("div", _hoisted_7, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(formattedOptions), (option, index) => {
            return openBlock(), createElementBlock("button", {
              key: option.value,
              type: "button",
              tabindex: "-1",
              class: normalizeClass([[
                unref(model) === option.value ? "htw-bg-primary-500/20" : index === unref(selectedIndex) ? "htw-bg-primary-500/10" : "htw-bg-transparent"
              ...
              unref(model) === option.value ? (openBlock(), createBlock(unref(Icon), {
                key: 0,
