  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("form", {
        ...
        createElementVNode("div", _hoisted_1, toDisplayString(__props.command.label), 1),
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.command.prompts, (prompt, index) => {
