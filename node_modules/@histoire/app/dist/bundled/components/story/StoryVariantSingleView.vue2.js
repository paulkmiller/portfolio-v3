    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        !unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2, [
          createVNode(_sfc_main$1, { variant: __props.variant }, null, 8, ["variant"]),
          !__props.variant.responsiveDisabled ? (openBlock(), createBlock(_sfc_main$2, { key: 0 })) : createCommentVNode("", true),
          ...
          _ctx.__HISTOIRE_DEV__ ? (openBlock(), createBlock(_sfc_main$5, {
            key: 1,
            file: (_a = __props.story.file) == null ? void 0 : _a.filePath,
            tooltip: "Edit story in editor"
          }, null, 8, ["file"])) : createCommentVNode("", true)
        ])) : createCommentVNode("", true),
        ((_b = __props.story.layout) == null ? void 0 : _b.iframe) === false ? (openBlock(), createBlock(_sfc_main$6, {
          key: 1,
          story: __props.story,
          variant: __props.variant
