import { defineComponent, computed, openBlock, createElementBlock, toDisplayString, unref } from "@histoire/vendors/vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("span", _hoisted_1, toDisplayString(unref(formatted)), 1);
    };
  }
});
export {
