import { defineComponent as X, openBlock as D, createElementBlock as z, normalizeClass as ut, renderSlot as ot, createBlock as q, resolveDynamicComponent as aa, withCtx as W, withDirectives as Rt, createTextVNode as ee, toDisplayString as At, unref as xt, createElementVNode as B, computed as et, Fragment as ce, renderList as Be, watch as ts, ref as it, withKeys as Ke, withModifiers as qe, createVNode as Ss, normalizeStyle as Ot, mergeProps as Re, onUnmounted as ca, vModelText as Fn, createCommentVNode as Yt, onMounted as fa, watchEffect as ua } from "@histoire/vendors/vue";
import { VTooltip as fe, Dropdown as da } from "@histoire/vendors/floating-vue";
import { Icon as zn } from "@histoire/vendors/iconify";
import { useClipboard as pa } from "@histoire/vendors/vue-use";
const ga = {
  name: "HstButton"
}, Uo = /* @__PURE__ */ X({
  ...ga,
  ...
  setup(n) {
    ...
    return (e, i) => (D(), z("button", {
      class: ut(["histoire-button htw-cursor-pointer htw-rounded-sm", t[e.color ?? "default"]])
    }, [
      ot(e.$slots, "default")
    ], 2));
  }
  ...
  setup(n) {
    return (t, e) => (D(), q(aa(t.tag), { class: "histoire-wrapper htw-p-2 hover:htw-bg-primary-100 dark:hover:htw-bg-primary-800 htw-flex htw-gap-2 htw-flex-wrap" }, {
      default: W(() => [
        Rt((D(), z("span", ma, [
          ee(At(t.title), 1)
        ])), [
...
}), ka = { class: "htw-flex htw-gap-px htw-border htw-border-solid htw-border-black/25 dark:htw-border-white/25 htw-rounded-sm htw-p-px" }, xa = {
  name: "HstButtonGroup"
}, va = /* @__PURE__ */ X({
  ...xa,
  props: {
  ...
  setup(n, { emit: t }) {
    const e = n, i = et(() => Array.isArray(e.options) ? e.options.map((r) => typeof r == "string" || typeof r == "number" ? { value: r, label: String(r) } : r) : Object.keys(e.options).map((r) => ({
      value: r,
      label: e.options[r]
    })));
    function s(r) {
    ...
    return (r, o) => (D(), q(Lt, {
      ...
      default: W(() => [
        B("div", ka, [
          (D(!0), z(ce, null, Be(i.value, ({ label: l, value: h }) => (D(), q(Uo, {
            key: h,
            class: "htw-px-1 htw-h-[22px] htw-flex-1 !htw-rounded-[3px]",
            color: h === r.modelValue ? "primary" : "flat",
            rounded: !1,
            onClick: (a) => s(h)
          }, {
            default: W(() => [
...
}, Ca = ["stroke-dasharray", "stroke-dashoffset"], Aa = {
  ...
  setup(n, { emit: t }) {
    ...
    const s = it(), r = it(0), o = et(() => e.modelValue ? 1 : 0), l = et(() => (1 - o.value) * r.value), h = it(!1);
    return ts(s, () => {
      var a, c;
      r.value = ((c = (a = s.value).getTotalLength) == null ? void 0 : c.call(a)) ?? 21.21;
    }), (a, c) => (D(), z("div", {
      class: ut(["histoire-simple-checkbox htw-group htw-text-white htw-w-[16px] htw-h-[16px] htw-relative", { "htw-cursor-pointer": a.withToggle }]),
      onClick: i
    }, [
      B("div", {
        class: ut(["htw-border htw-border-solid group-active:htw-bg-gray-500/20 htw-rounded-sm htw-box-border htw-absolute htw-inset-0 htw-transition-border htw-duration-150 htw-ease-out group-hover:htw-border-primary-500 group-hover:dark:htw-border-primary-500", [
          a.modelValue ? "htw-border-primary-500 htw-border-8" : "htw-border-black/25 dark:htw-border-white/25 htw-delay-150"
        ]])
      }, null, 2),
      (D(), z("svg", Sa, [
        B("path", {
          ...
          fill: "none",
          class: ut(["htw-stroke-white htw-stroke-2 htw-duration-200 htw-ease-in-out", [
            h.value ? "htw-transition-all" : "htw-transition-none",
            {
              "htw-delay-150": a.modelValue
            }
          ]]),
  ...
  setup(n, { emit: t }) {
    ...
    const s = et(() => typeof e.modelValue == "string" ? e.modelValue !== "false" : e.modelValue);
    return (r, o) => (D(), q(Lt, {
      role: "checkbox",
      tabindex: "0",
      ...
      onClick: o[0] || (o[0] = (l) => i()),
      onKeydown: [
        o[1] || (o[1] = Ke(qe((l) => i(), ["prevent"]), ["enter"])),
        o[2] || (o[2] = Ke(qe((l) => i(), ["prevent"]), ["space"]))
      ]
    }, {
      actions: W(() => [
        ot(r.$slots, "actions")
      ...
      default: W(() => [
        Ss(Qo, { "model-value": s.value }, null, 8, ["model-value"])
      ]),
      _: 3
    }, 8, ["title"]));
  }
}), Da = { class: "-htw-my-1" }, Ta = ["for", "onKeydown", "onClick"], Pa = {
  ...
  emits: ["update:modelValue"],
  setup(n, { emit: t }) {
    const e = n, i = et(() => Array.isArray(e.options) ? Object.fromEntries(e.options.map((r) => typeof r == "string" ? [r, r] : [r.value, r.label])) : e.options);
    function s(r) {
    ...
    return (r, o) => (D(), q(Lt, {
      role: "group",
      title: r.title,
      class: ut(["histoire-checkbox-list htw-cursor-text", r.$attrs.class]),
      style: Ot(r.$attrs.style)
    }, {
      actions: W(() => [
        ot(r.$slots, "actions")
      ]),
      default: W(() => [
        B("div", Da, [
          (D(!0), z(ce, null, Be(i.value, (l, h) => (D(), z("label", {
            key: h,
            tabindex: "0",
            for: `${h}-radio`,
            class: "htw-cursor-pointer htw-flex htw-items-center htw-relative htw-py-1 htw-group",
            onKeydown: [
              Ke(qe((a) => s(h), ["prevent"]), ["enter"]),
              Ke(qe((a) => s(h), ["prevent"]), ["space"])
            ],
            onClick: (a) => s(h)
          }, [
            Ss(Qo, {
              "model-value": r.modelValue.includes(h),
              class: "htw-mr-2"
            }, null, 8, ["model-value"]),
            ee(" " + At(l), 1)
          ], 40, Ta))), 128))
  ...
  setup(n, { emit: t }) {
    ...
    return (i, s) => (D(), q(Lt, {
      title: i.title,
      class: ut(["histoire-text htw-cursor-text htw-items-center", i.$attrs.class]),
      style: Ot(i.$attrs.style),
      onClick: s[1] || (s[1] = (r) => e.value.focus())
    }, {
      actions: W(() => [
        ot(i.$slots, "actions")
      ]),
  ...
  setup(n, { emit: t }) {
    ...
    return ca(() => {
      ...
      class: ut(["histoire-number htw-cursor-ew-resize htw-items-center", [
        u.$attrs.class,
        { "htw-select-none": o.value }
      ]]),
      title: u.title,
      style: Ot(u.$attrs.style),
      onClick: r,
      onMousedown: a
    }, {
      actions: W(() => [
...
}), Va = { class: "htw-relative htw-w-full htw-flex htw-items-center" }, Ha = /* @__PURE__ */ B("div", { class: "htw-absolute htw-inset-0 htw-flex htw-items-center" }, [
  ...
  setup(n, { emit: t }) {
    const e = n, i = it(!1), s = it(null), r = et({
      get: () => e.modelValue,
      set: (h) => {
        t("update:modelValue", h);
      }
    }), o = et(() => (e.modelValue - e.min) / (e.max - e.min)), l = et(() => s.value ? {
      left: 8 + (s.value.clientWidth - 16) * o.value + "px"
    } : {});
    return (h, a) => (D(), q(Lt, {
      class: ut(["histoire-slider htw-items-center", h.$attrs.class]),
      title: h.title,
      style: Ot(h.$attrs.style)
    }, {
      default: W(() => [
        B("div", Va, [
          Ha,
          ...
          i.value ? Rt((D(), z("div", {
            ...
            [xt(fe), { content: h.modelValue.toString(), shown: !0, distance: 16, delay: 0 }]
          ]) : Yt("", !0)
        ])
      ]),
      _: 1
...
const Fa = ["value"], za = {
  ...
  setup(n, { emit: t }) {
    ...
    return (i, s) => (D(), q(Lt, {
      title: i.title,
      class: ut(["histoire-textarea htw-cursor-text", i.$attrs.class]),
      style: Ot(i.$attrs.style),
      onClick: s[1] || (s[1] = (r) => e.value.focus())
    }, {
      actions: W(() => [
  ...
  emits: ["update:modelValue"],
  setup(n, { emit: t }) {
    const e = n, i = et(() => Array.isArray(e.options) ? e.options.map((o) => typeof o == "string" || typeof o == "number" ? [o, String(o)] : [o.value, o.label]) : Object.entries(e.options)), s = et(() => {
      var o;
    ...
    return (o, l) => (D(), q(xt(da), {
      "auto-size": "",
      "auto-boundary-max-size": ""
    }, {
      popper: W(({ hide: h }) => [
        B("div", qa, [
          (D(!0), z(ce, null, Be(i.value, ([a, c]) => (D(), z("div", Re({ ...o.$attrs, class: null, style: null }, {
            key: c,
      ...
      default: W(() => [
        B("div", ja, [
          B("div", Ka, [
            ot(o.$slots, "default", { label: s.value }, () => [
              ee(At(s.value), 1)
            ])
          ]),
          Ss(xt(zn), {
...
const Ja = {
  ...
  setup(n, { emit: t }) {
    return (e, i) => (D(), q(Lt, {
      title: e.title,
      class: ut(["histoire-select htw-cursor-text htw-items-center", e.$attrs.class]),
      style: Ot(e.$attrs.style)
    }, {
      actions: W(() => [
        ot(e.$slots, "actions")
      ]),
  ...
  setup(n) {
    const t = n, { copy: e, copied: i } = pa(), s = async () => {
      const r = typeof t.content == "function" ? await t.content() : t.content;
      e(r);
    };
    return (r, o) => Rt((D(), q(xt(zn), {
...
}, tc = ["onMouseenter"], ec = { class: "htw-flex htw-gap-1" }, ic = { class: "htw-my-0 htw-truncate htw-shrink" }, sc = { class: "htw-flex htw-gap-1" }, nc = { class: "htw-my-0 htw-opacity-50 htw-truncate htw-shrink" }, rc = {
  name: "HstColorShades"
}, oc = /* @__PURE__ */ X({
  ...rc,
  props: {
  ...
  setup(n) {
    ...
    return (o, l) => s.value.length ? (D(), z("div", Za, [
      (D(!0), z(ce, null, Be(s.value, (h) => (D(), z("div", {
        key: h.key,
        ...
        B("div", null, [
          B("div", ec, [
            Rt((D(), z("pre", ic, [
              ...
              [xt(fe), h.name.length > 23 ? h.name : ""]
            ]),
            r.value === h.key ? (D(), q(Me, {
              key: 0,
              content: h.name,
              class: "htw-flex-none"
            }, null, 8, ["content"])) : Yt("", !0)
          ...
          B("div", sc, [
            Rt((D(), z("pre", nc, [
              ...
              [xt(fe), h.color.length > 23 ? h.color : ""]
            ]),
            r.value === h.key ? (D(), q(Me, {
              key: 0,
              content: h.color,
  ...
  setup(n) {
    ...
    return (s, r) => (D(!0), z(ce, null, Be(e.value, (o) => (D(), z("div", {
      key: o.key,
      ...
      ot(s.$slots, "default", { token: o }),
      B("div", hc, [
        B("div", ac, [
          B("pre", cc, At(o.name), 1),
          i.value === o.key ? (D(), q(Me, {
            key: 0,
            content: o.name,
            class: "htw-flex-none"
          }, null, 8, ["content"])) : Yt("", !0)
...
}), gc = ["onMouseenter"], mc = { class: "htw-flex htw-gap-1" }, wc = { class: "htw-my-0 htw-truncate htw-shrink" }, yc = { class: "htw-flex htw-gap-1" }, bc = { class: "htw-my-0 htw-opacity-50 htw-truncate htw-shrink" }, kc = {
  name: "HstTokenGrid"
}, xc = /* @__PURE__ */ X({
  ...kc,
  props: {
  ...
  setup(n) {
    ...
    return (r, o) => (D(), z("div", {
      ...
      (D(!0), z(ce, null, Be(e.value, (l) => (D(), z("div", {
        key: l.key,
        class: "htw-flex htw-flex-col htw-gap-2",
        onMouseenter: (h) => s.value = l.key,
        onMouseleave: o[0] || (o[0] = (h) => s.value = null)
      }, [
        ot(r.$slots, "default", { token: l }),
        B("div", null, [
          B("div", mc, [
            Rt((D(), z("pre", wc, [
              ee(At(l.name), 1)
            ])), [
              [xt(fe), l.name.length > r.colSize / 8 ? l.name : ""]
            ]),
            s.value === l.key ? (D(), q(Me, {
              key: 0,
              content: l.name,
              class: "htw-flex-none"
            }, null, 8, ["content"])) : Yt("", !0)
          ...
          B("div", yc, [
            Rt((D(), z("pre", bc, [
              ...
              [xt(fe), l.value.length > r.colSize / 8 ? l.value : ""]
            ]),
            s.value === l.key ? (D(), q(Me, {
              key: 0,
...
const vc = { class: "-htw-my-1" }, Sc = ["id", "name", "value", "checked", "onChange"], Cc = ["for", "onKeydown"], Ac = {
  name: "HstRadio"
}, Oc = /* @__PURE__ */ X({
  ...Ac,
  props: {
  ...
  emits: ["update:modelValue"],
  setup(n, { emit: t }) {
    const e = n, i = et(() => Array.isArray(e.options) ? Object.fromEntries(e.options.map((o) => typeof o == "string" ? [o, o] : [o.value, o.label])) : e.options);
    function s(o) {
    ...
    return (o, l) => (D(), q(Lt, {
      role: "group",
      title: o.title,
      class: ut(["histoire-radio htw-cursor-text", o.$attrs.class]),
      style: Ot(o.$attrs.style)
    }, {
      actions: W(() => [
        ot(o.$slots, "actions")
      ]),
      default: W(() => [
        B("div", vc, [
          (D(!0), z(ce, null, Be(i.value, (h, a) => (D(), z(ce, { key: a }, [
            B("input", {
              id: `${a}-radio_${o.title}`,
              type: "radio",
            ...
            B("label", {
              tabindex: "0",
              for: `${a}-radio_${o.title}`,
              class: "htw-cursor-pointer htw-flex htw-items-center htw-relative htw-py-1 htw-group",
              onKeydown: [
                Ke(qe((c) => s(a), ["prevent"]), ["enter"]),
                Ke(qe((c) => s(a), ["prevent"]), ["space"])
              ]
            }, [
              (D(), z("svg", {
                width: "16",
                height: "16",
                viewBox: "-12 -12 24 24",
                class: ut(["htw-relative htw-z-10 htw-border htw-border-solid htw-text-inherit htw-rounded-full htw-box-border htw-inset-0 htw-transition-border htw-duration-150 htw-ease-out htw-mr-2 group-hover:htw-border-primary-500", [
                  o.modelValue === a ? "htw-border-primary-500" : "htw-border-black/25 dark:htw-border-white/25"
                ]])
              }, [
                B("circle", {
                  r: "7",
                  class: ut(["htw-will-change-transform", [
                    r.value ? "htw-transition-all" : "htw-transition-none",
                    {
                      "htw-delay-150": o.modelValue === a
                    },
                    o.modelValue === a ? "htw-fill-primary-500" : "htw-fill-transparent htw-scale-0"
                  ]])
                }, null, 2)
              ], 2)),
              ee(" " + At(h), 1)
...
class L {
  ...
  */
  replace(t, e, i) {
    ...
    return this.decompose(
      ...
      1
      /* Open.From */
    ), Ft.from(s, this.length - (e - t) + i.length);
  }
  /**
  ...
  */
  eq(t) {
    ...
    if (t.length != this.length || t.lines != this.lines)
      return !1;
    let e = this.scanIdentical(t, 1), i = this.length - this.scanIdentical(t, -1), s = new hi(this), r = new hi(t);
    for (let o = e, l = e; ; ) {
  ...
  */
  static of(t) {
    ...
    return t.length == 1 && !t[0] ? L.empty : t.length <= 32 ? new G(t) : Ft.from(G.split(t, []));
  }
}
class G extends L {
  constructor(t, e = Mc(t)) {
  ...
  decompose(t, e, i, s) {
    ...
    if (s & 1) {
      let o = i.pop(), l = Wi(r.text, o.text.slice(), 0, r.length);
      if (l.length <= 32)
  ...
  replace(t, e, i) {
    ...
    let s = Wi(this.text, Wi(i.text, dr(this.text, 0, t)), e), r = this.length + i.length - (e - t);
    return s.length <= 32 ? new G(s, r) : Ft.from(G.split(s, []), r);
  }
...
`) {
  ...
  static split(t, e) {
    let i = [], s = -1;
    for (let r of t)
      i.push(r), s += r.length + 1, i.length == 32 && (e.push(new G(i, s)), i = [], s = -1);
      ...
      for (let s = 0, r = 0; s < this.children.length; s++) {
        ...
        if (t >= r && e <= l) {
          ...
          if (h.lines < a >> 5 - 1 && h.lines > a >> 5 + 1) {
            ...
            return c[s] = h, new Ft(c, this.length - (e - t) + i.length);
          }
  ...
  static from(t, e = t.reduce((i, s) => i + s.length + 1, -1)) {
    ...
    function f(d) {
      ...
      if (d.lines > r && d instanceof Ft)
        ...
        d.lines > o && (h > o || !h) ? (u(), l.push(d)) : d instanceof G && h && (p = c[c.length - 1]) instanceof G && d.lines + p.lines <= 32 ? (h += d.lines, a += d.length + 1, c[c.length - 1] = new G(p.text.concat(d.text), p.length + 1 + d.length)) : (h + d.lines > s && u(), h += d.lines, a += d.length + 1, c.push(d));
    }
    function u() {
      h != 0 && (l.push(c.length == 1 ? c[0] : Ft.from(c, a)), a = -1, h = c.length = 0);
    }
    for (let d of t)
      f(d);
    return u(), l.length == 1 ? l[0] : new Ft(l, e);
  }
}
L.empty = /* @__PURE__ */ new G([""], 0);
function Mc(n) {
  let t = -1;
  for (let e of n)
    t += e.length + 1;
...
class hi {
  ...
  nextInner(t, e) {
    for (this.done = this.lineBreak = !1; ; ) {
      let i = this.nodes.length - 1, s = this.nodes[i], r = this.offsets[i], o = r >> 1, l = s instanceof G ? s.text.length : s.children.length;
      if (o == (e > 0 ? l : 0)) {
        if (i == 0)
...
class Jo {
  constructor(t, e, i) {
    this.value = "", this.done = !1, this.cursor = new hi(t, e > i ? -1 : 1), this.pos = e > i ? t.length : 0, this.from = Math.min(e, i), this.to = Math.max(e, i);
  }
  nextInner(t, e) {
...
typeof Symbol < "u" && (L.prototype[Symbol.iterator] = function() {
  return this.iter();
}, hi.prototype[Symbol.iterator] = Jo.prototype[Symbol.iterator] = Yo.prototype[Symbol.iterator] = function() {
  return this;
});
class Dc {
  /**
...
const gr = 8205;
function mt(n, t, e = !0, i = !0) {
  return (e ? Xo : Pc)(n, t, i);
}
function Xo(n, t, e) {
  if (t == n.length)
    return t;
  t && Zo(n.charCodeAt(t)) && tl(n.charCodeAt(t - 1)) && t--;
  let i = ai(n, t);
  for (t += tn(i); t < n.length; ) {
    let s = ai(n, t);
    if (i == gr || s == gr || e && Tc(s))
      t += tn(s), i = s;
    else if (pr(s)) {
...
class Xt {
  ...
  */
  mapDesc(t, e = !1) {
    return t.empty ? this : nn(this, t, e);
  }
  mapPos(t, e = -1, i = gt.Simple) {
    ...
    for (let o = 0; o < this.sections.length; ) {
      ...
      if (h < 0) {
        ...
        if (i != gt.Simple && a >= t && (i == gt.TrackDel && s < t && a > t || i == gt.TrackBefore && s < t || i == gt.TrackAfter && a > t))
          return null;
        if (a > t || a == t && e < 0 && !l)
...
class Z extends Xt {
  ...
  */
  apply(t) {
    ...
    return sn(this, (e, i, s, r, o) => t = t.replace(s, s + (i - e), o), !1), t;
  }
  mapDesc(t, e = !1) {
    return nn(this, t, e, !0);
  }
  /**
  ...
  */
  map(t, e = !1) {
    return t.empty ? this : nn(this, t, e, !0);
  }
  /**
    ...
    t:
      for (let o = 0, l = 0; ; ) {
        ...
        for (; l < h || l == h && r.len == 0; ) {
          ...
          lt(e, c, f), f > 0 && he(i, e, r.text), r.forward(c), l += c;
        }
        let a = t[o++];
        for (; l < a; ) {
          if (r.done)
  ...
  static of(t, e, i) {
    ...
    function a(c) {
      if (Array.isArray(c))
        ...
        let p = d ? typeof d == "string" ? L.of(d.split(i || en)) : d : L.empty, w = p.length;
        if (f == u && w == 0)
          return;
        f < o && h(), f > o && lt(s, f - o, -1), lt(s, u - f, w), he(r, s, p), o = u;
      }
    }
    return a(t), h(!l), l;
  }
...
function nn(n, t, e, i = !1) {
  let s = [], r = i ? [] : null, o = new ui(n), l = new ui(t);
  for (let h = -1; ; )
    if (o.ins == -1 && l.ins == -1) {
      let a = Math.min(o.len, l.len);
      lt(s, a, -1), o.forward(a), l.forward(a);
    } else if (l.ins >= 0 && (o.ins < 0 || h == o.i || o.off == 0 && (l.len < o.len || l.len == o.len && !e))) {
      let a = l.len;
      for (lt(s, l.ins, -1); a; ) {
        let c = Math.min(o.len, a);
        o.ins >= 0 && h < o.i && o.len <= c && (lt(s, 0, o.ins), r && he(r, s, o.text), h = o.i), o.forward(c), a -= c;
      }
      l.next();
    } else if (o.ins >= 0) {
      let a = 0, c = o.len;
      for (; c; )
        if (l.ins == -1) {
          ...
          break;
      lt(s, a, h < o.i ? o.ins : 0), r && h < o.i && he(r, s, o.text), h = o.i, o.forward(o.len - c);
    } else {
      if (o.done && l.done)
...
function el(n, t, e = !1) {
  let i = [], s = e ? [] : null, r = new ui(n), o = new ui(t);
  for (let l = !1; ; ) {
    if (r.done && o.done)
    ...
    if (r.ins == 0)
      ...
      lt(i, 0, o.ins, l), s && he(s, i, o.text), o.next();
    else {
      if (r.done || o.done)
        throw new Error("Mismatched change set lengths");
      {
        ...
        if (r.ins == -1) {
          ...
          lt(i, h, c, l), s && c && he(s, i, o.text);
        } else
          o.ins == -1 ? (lt(i, r.off ? 0 : r.len, h, l), s && he(s, i, r.textBit(h))) : (lt(i, r.off ? 0 : r.len, o.off ? 0 : o.ins, l), s && !o.off && he(s, i, o.text));
...
class b {
  ...
  */
  static cursor(t, e = 0, i, s) {
    return Se.create(t, t, (e == 0 ? 0 : e < 0 ? 4 : 8) | (i == null ? 3 : Math.min(2, i)) | (s ?? 33554431) << 5);
  }
  /**
  ...
  */
  static range(t, e, i, s) {
    ...
    return e < t ? Se.create(e, t, 24 | r) : Se.create(t, e, (e > t ? 4 : 0) | r);
  }
  /**
  @internal
  */
...
class A {
  constructor(t, e, i, s, r) {
    this.combine = t, this.compareInput = e, this.compare = i, this.isStatic = s, this.id = Wn++, this.default = t([]), this.extensions = typeof r == "function" ? r(this) : r;
  }
  /**
  Define a new facet.
  */
  static define(t = {}) {
    return new A(t.combine || ((e) => e), t.compareInput || ((e, i) => e === i), t.compare || (t.combine ? (e, i) => e === i : jn), !!t.static, t.enables);
  }
  /**
  Returns an extension that adds the given value to this facet.
  */
  of(t) {
    return new ji([], this, 0, t);
  }
  /**
...
class ji {
  constructor(t, e, i, s) {
    this.dependencies = t, this.facet = e, this.type = i, this.value = s, this.id = Wn++;
  }
  dynamicSlot(t) {
    var e;
    ...
    return {
      ...
      update(f, u) {
        if (h && u.docChanged || a && (u.docChanged || u.selection) || rn(f, c)) {
          let d = i(f);
          if (l ? !mr(d, f.values[o], s) : !s(d, f.values[o]))
      ...
      reconfigure: (f, u) => {
        ...
        if (p != null) {
          let w = is(u, p);
          if (this.dependencies.every((g) => g instanceof A ? u.facet(g) === f.facet(g) : g instanceof Et ? u.field(g, !1) == f.field(g, !1) : !0) || (l ? mr(d = i(f), w, s) : s(d = i(f), w)))
...
function Bc(n, t, e) {
  ...
  return {
    ...
    reconfigure(h, a) {
      let c = rn(h, i), f = a.config.facets[t.id], u = a.facet(t);
      if (f && !c && jn(e, f))
...
const wr = /* @__PURE__ */ A.define({ static: !0 });
class Et {
  constructor(t, e, i, s, r) {
  ...
  */
  static define(t) {
    let e = new Et(Wn++, t.create, t.update, t.compare || ((i, s) => i === s), t);
...
const xe = { lowest: 4, low: 3, default: 2, high: 1, highest: 0 };
function ti(n) {
  return (t) => new sl(t, n);
}
const Kn = {
  ...
  */
  highest: /* @__PURE__ */ ti(xe.highest),
  /**
  A higher-than-default precedence, for extensions that should
  come before those with default precedence.
  */
  high: /* @__PURE__ */ ti(xe.high),
  /**
  The default precedence, which is also used for extensions
  without an explicit precedence.
  */
  default: /* @__PURE__ */ ti(xe.default),
  /**
  A lower-than-default precedence.
  */
  low: /* @__PURE__ */ ti(xe.low),
  /**
  The lowest precedence level. Meant for things that should end up
  near the end of the extension order.
  */
  lowest: /* @__PURE__ */ ti(xe.lowest)
};
class sl {
  constructor(t, e) {
...
class es {
  ...
  static resolve(t, e, i) {
    ...
    for (let u of Rc(t, e, o))
      u instanceof Et ? s.push(u) : (r[u.facet.id] || (r[u.facet.id] = [])).push(u);
    ...
    for (let u in r) {
      ...
      if (d.every(
        ...
        l[p.id] = a.length << 1, a.push((g) => Bc(g, p, d));
      }
    }
    let f = a.map((u) => u(l));
    return new es(t, o, f, l, h, r);
  }
}
function Rc(n, t, e) {
  ...
  function r(o, l) {
    ...
    if (h != null) {
      if (h <= l)
        return;
      let a = i[h].indexOf(o);
      a > -1 && i[h].splice(a, 1), o instanceof on && e.delete(o.compartment);
    }
    if (s.set(o, l), Array.isArray(o))
      ...
      i[l].push(o), o.facet.extensions && r(o.facet.extensions, xe.default);
    else {
      let a = o.extension;
      if (!a)
  ...
  return r(n, xe.default), i.reduce((o, l) => o.concat(l));
}
function ci(n, t) {
  if (t & 1)
    return 2;
...
const nl = /* @__PURE__ */ A.define(), rl = /* @__PURE__ */ A.define({
  combine: (n) => n.some((t) => t),
  static: !0
}), ol = /* @__PURE__ */ A.define({
  combine: (n) => n.length ? n[0] : void 0,
  static: !0
}), ll = /* @__PURE__ */ A.define(), hl = /* @__PURE__ */ A.define(), al = /* @__PURE__ */ A.define(), cl = /* @__PURE__ */ A.define({
...
class ht {
  constructor(t, e, i, s, r, o) {
    this.startState = t, this.changes = e, this.selection = i, this.effects = s, this.annotations = r, this.scrollIntoView = o, this._doc = null, this._state = null, i && il(i, e.newLength), r.some((l) => l.type == ht.time) || (this.annotations = r.concat(ht.time.of(Date.now())));
  }
  /**
  @internal
  */
  static create(t, e, i, s, r, o) {
    return new ht(t, e, i, s, r, o);
  }
  /**
...
ht.time = /* @__PURE__ */ Xe.define();
ht.userEvent = /* @__PURE__ */ Xe.define();
ht.addToHistory = /* @__PURE__ */ Xe.define();
ht.remote = /* @__PURE__ */ Xe.define();
function Nc(n, t) {
  let e = [];
  for (let i = 0, s = 0; ; ) {
    let r, o;
...
function ln(n, t, e) {
  let i = t.selection, s = Fe(t.annotations);
  return t.userEvent && (s = s.concat(ht.userEvent.of(t.userEvent))), {
    changes: t.changes instanceof Z ? t.changes : Z.of(t.changes || [], e, n.facet(ol)),
    selection: i && (i instanceof b ? i : b.single(i.anchor, i.head)),
    effects: Fe(t.effects),
    annotations: s,
    scrollIntoView: !!t.scrollIntoView
  };
}
function ul(n, t, e) {
  let i = ln(n, t.length ? t[0] : {}, n.doc.length);
  t.length && t[0].filter === !1 && (e = !1);
  for (let r = 1; r < t.length; r++) {
    t[r].filter === !1 && (e = !1);
    let o = !!t[r].sequential;
    i = fl(i, ln(n, t[r], o ? i.changes.newLength : n.doc.length), o);
  }
  let s = ht.create(n, i.changes, i.selection, i.effects, i.annotations, i.scrollIntoView);
  return Vc(e ? Ic(s) : s);
}
function Ic(n) {
  let t = n.startState, e = !0;
  for (let s of t.facet(ll)) {
    let r = s(n);
    if (r === !1) {
      e = !1;
      break;
    }
    Array.isArray(r) && (e = e === !0 ? r : Nc(e, r));
  }
  if (e !== !0) {
    let s, r;
    if (e === !1)
    ...
    n = ht.create(t, s, n.selection && n.selection.map(r), _.mapEffects(n.effects, r), n.annotations, n.scrollIntoView);
  }
  let i = t.facet(hl);
  for (let s = i.length - 1; s >= 0; s--) {
    let r = i[s](n);
    r instanceof ht ? n = r : Array.isArray(r) && r.length == 1 && r[0] instanceof ht ? n = r[0] : n = ul(t, Fe(r), !1);
  }
  return n;
}
function Vc(n) {
  let t = n.startState, e = t.facet(al), i = n;
  for (let s = e.length - 1; s >= 0; s--) {
    let r = e[s](n);
    r && Object.keys(r).length && (i = fl(i, ln(t, r, n.changes.newLength), !0));
  }
  return i == n ? n : ht.create(t, n.changes, n.selection, i.effects, i.annotations, i.scrollIntoView);
}
const Hc = [];
function Fe(n) {
  return n == null ? Hc : Array.isArray(n) ? n : [n];
}
var Jt = /* @__PURE__ */ function(n) {
  return n[n.Word = 0] = "Word", n[n.Space = 1] = "Space", n[n.Other = 2] = "Other", n;
}(Jt || (Jt = {}));
const _c = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/;
let hn;
try {
  hn = /* @__PURE__ */ new RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {
}
function $c(n) {
  if (hn)
  ...
  for (let t = 0; t < n.length; t++) {
    let e = n[t];
    if (/\w/.test(e) || e > "" && (e.toUpperCase() != e.toLowerCase() || _c.test(e)))
      return !0;
  }
  return !1;
}
...
class N {
  ...
  */
  applyTransaction(t) {
    ...
    for (let o of t.effects)
      o.is(yi.reconfigure) ? (e && (s = /* @__PURE__ */ new Map(), e.compartments.forEach((l, h) => s.set(h, l)), e = null), s.set(o.value.compartment, o.value.extension)) : o.is(_.reconfigure) ? (e = null, i = o.value) : o.is(_.appendConfig) && (e = null, i = Fe(i).concat(o.value));
    let r;
    e ? r = t.startState.values.slice() : (e = es.resolve(i, s, this), r = new N(e, this.doc, this.selection, e.dynamicSlots.map(() => null), (l, h) => h.reconfigure(l, this), null).values), new N(e, t.newDoc, t.newSelection, r, (o, l) => l.update(o, t), t);
  }
  /**
  ...
  */
  changeByRange(t) {
    let e = this.selection, i = t(e.ranges[0]), s = this.changes(i.changes), r = [i.range], o = Fe(i.effects);
    for (let l = 1; l < e.ranges.length; l++) {
      let h = t(e.ranges[l]), a = this.changes(h.changes), c = a.map(s);
      for (let u = 0; u < l; u++)
        r[u] = r[u].map(c);
      let f = s.mapDesc(a, !0);
      r.push(h.range.map(f)), s = s.compose(c), o = _.mapEffects(o, c).concat(_.mapEffects(Fe(h.effects), f));
    }
    return {
      changes: s,
  ...
  */
  toText(t) {
    return L.of(t.split(this.facet(N.lineSeparator) || en));
  }
  /**
  ...
  */
  facet(t) {
    ...
    return e == null ? t.default : (ci(this, e), is(this, e));
  }
  /**
  ...
  */
  toJSON(t) {
    ...
    if (t)
      for (let i in t) {
        let s = t[i];
        s instanceof Et && this.config.address[s.id] != null && (e[i] = s.spec.toJSON(this.field(t[i]), this));
      }
    return e;
  }
  /**
  ...
  */
  static create(t = {}) {
    let e = es.resolve(t.extensions || [], /* @__PURE__ */ new Map()), i = t.doc instanceof L ? t.doc : L.of((t.doc || "").split(e.staticFacet(N.lineSeparator) || en)), s = t.selection ? t.selection instanceof b ? t.selection : b.single(t.selection.anchor, t.selection.head) : b.single(0);
    return il(s, i.length), e.staticFacet(rl) || (s = s.asSingle()), new N(e, i, s, e.dynamicSlots.map(() => null), (r, o) => o.create(r), null);
  }
  /**
...
N.tabSize = /* @__PURE__ */ A.define({
  combine: (n) => n.length ? n[0] : 4
});
N.lineSeparator = ol;
N.readOnly = cl;
N.phrases = /* @__PURE__ */ A.define({
  compare(n, t) {
...
yi.reconfigure = /* @__PURE__ */ _.define();
function Cs(n, t, e = {}) {
  let i = {};
  for (let s of n)
...
Ge.prototype.startSide = Ge.prototype.endSide = 0;
Ge.prototype.point = !1;
Ge.prototype.mapMode = gt.TrackDel;
let an = class dl {
  constructor(t, e, i) {
...
class qn {
  ...
  map(t, e) {
    ...
    return { mapped: i.length ? new qn(s, r, i, l) : null, pos: o };
  }
}
class H {
  constructor(t, e, i, s) {
  ...
  */
  update(t) {
    ...
    if (e.length == 0 && !o)
      return this;
    if (i && (e = e.slice().sort(cn)), this.isEmpty)
    ...
    for (; l.value || h < e.length; )
      if (h < e.length && (l.from - e[h].from || l.startSide - e[h].value.startSide) >= 0) {
        ...
        l.rangeIndex == 1 && l.chunkIndex < this.chunk.length && (h == e.length || this.chunkEnd(l.chunkIndex) < e[h].from) && (!o || s > this.chunkEnd(l.chunkIndex) || r < this.chunkPos[l.chunkIndex]) && c.addChunk(this.chunkPos[l.chunkIndex], this.chunk[l.chunkIndex]) ? l.nextChunk() : ((!o || s > l.to || r < l.from || o(l.from, l.to, l.value)) && (c.addInner(l.from, l.to, l.value) || a.push(an.create(l.from, l.to, l.value))), l.next());
    return c.finishInner(this.nextLayer.isEmpty && !a.length ? H.empty : this.nextLayer.update({ add: a, filter: o, filterFrom: s, filterTo: r }));
  }
  /**
  ...
  */
  static compare(t, e, i, s, r = -1) {
    let o = t.filter((f) => f.maxPoint > 0 || !f.isEmpty && f.maxPoint >= r), l = e.filter((f) => f.maxPoint > 0 || !f.isEmpty && f.maxPoint >= r), h = yr(o, l, i), a = new ei(o, h, r), c = new ei(l, h, r);
    i.iterGaps((f, u, d) => br(a, f, c, u, d, s)), i.empty && i.length == 0 && br(a, 0, c, 0, 0, s);
  }
  /**
  ...
  */
  static eq(t, e, i = 0, s) {
    ...
    if (!r.length)
      return !0;
    let l = yr(r, o), h = new ei(r, l, 0).goto(i), a = new ei(o, l, 0).goto(i);
    for (; ; ) {
      if (h.to != a.to || !fn(h.active, a.active) || h.point && (!a.point || !h.point.eq(a.point)))
        return !1;
      if (h.to > s)
        return !0;
      h.next(), a.next();
  ...
  */
  static spans(t, e, i, s, r = -1) {
    let o = new ei(t, null, r).goto(e), l = e, h = o.openStart;
    for (; ; ) {
  ...
  */
  static of(t, e = !1) {
    let i = new De();
    for (let s of t instanceof an ? [t] : e ? zc(t) : t)
...
class De {
  finishChunk(t) {
    this.chunks.push(new qn(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, t && (this.from = [], this.to = [], this.value = []);
  }
  /**
...
class di {
  ...
  static from(t, e = null, i = -1) {
    ...
    for (let r = 0; r < t.length; r++)
      for (let o = t[r]; !o.isEmpty; o = o.nextLayer)
        o.maxPoint >= i && s.push(new pl(o, e, i, r));
  ...
  next() {
    if (this.heap.length == 0)
      ...
      let t = this.heap[0];
      this.from = t.from, this.to = t.to, this.value = t.value, this.rank = t.rank, t.value && t.next(), Ns(this.heap, 0);
    }
  }
}
function Ns(n, t) {
...
class ei {
  ...
  addActive(t) {
    ...
    for (; e < this.activeRank.length && this.activeRank[e] <= r; )
      e++;
    Ai(this.active, e, i), Ai(this.activeTo, e, s), Ai(this.activeRank, e, r), t && Ai(t, e, this.cursor.from), this.minActive = kr(this.active, this.activeTo);
  }
...
function br(n, t, e, i, s, r) {
  ...
  for (; ; ) {
    ...
    if (n.point || e.point ? n.point && e.point && (n.point == e.point || n.point.eq(e.point)) && fn(n.activeForPoint(n.to), e.activeForPoint(e.to)) || r.comparePoint(l, f, n.point, e.point) : f > l && !fn(n.active, e.active) && r.compareRange(l, f, n.active, e.active), c > o)
      break;
...
function As(n, t, e = n.length) {
  let i = 0;
  for (let s = 0; s < e; )
    n.charCodeAt(s) == 9 ? (i += t - i % t, s++) : (i++, s = mt(n, s));
  return i;
}
function Wc(n, t, e, i) {
  for (let s = 0, r = 0; ; ) {
    ...
    if (s == n.length)
      break;
    r += n.charCodeAt(s) == 9 ? e - r % e : 1, s = mt(n, s);
  }
  return i === !0 ? -1 : n.length;
}
const un = "ͼ", xr = typeof Symbol > "u" ? "__" + un : Symbol.for(un), dn = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), vr = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {};
class ue {
...
`);
  ...
  static newName() {
    let t = vr[xr] || 1;
    return vr[xr] = t + 1, un + t.toString(36);
  }
  ...
  static mount(t, e) {
    (t[dn] || new jc(t)).mount(Array.isArray(e) ? e : [e]);
  }
}
let Sr = /* @__PURE__ */ new Map();
class jc {
  constructor(t) {
    let e = t.ownerDocument || t, i = e.defaultView;
    if (!t.head && t.adoptedStyleSheets && i.CSSStyleSheet) {
      let s = Sr.get(e);
      if (s)
        return t.adoptedStyleSheets = [s.sheet, ...t.adoptedStyleSheets], t[dn] = s;
      this.sheet = new i.CSSStyleSheet(), t.adoptedStyleSheets = [this.sheet, ...t.adoptedStyleSheets], Sr.set(e, this);
    } else {
...
var de = {
  ...
  221: "}",
  222: '"'
}, Kc = typeof navigator < "u" && /Mac/.test(navigator.platform), qc = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
for (var rt = 0; rt < 10; rt++)
  de[48 + rt] = de[96 + rt] = String(rt);
for (var rt = 1; rt <= 24; rt++)
  de[rt + 111] = "F" + rt;
for (var rt = 65; rt <= 90; rt++)
  de[rt] = String.fromCharCode(rt + 32), pi[rt] = String.fromCharCode(rt);
for (var Is in de)
  pi.hasOwnProperty(Is) || (pi[Is] = de[Is]);
function Gc(n) {
  var t = Kc && n.metaKey && n.shiftKey && !n.ctrlKey && !n.altKey || qc && n.shiftKey && n.key && n.key.length == 1 || n.key == "Unidentified", e = !t && n.key || (n.shiftKey ? pi : de)[n.keyCode] || n.key || "Unidentified";
...
function Ki(n, t) {
  if (!t.anchorNode)
    return !1;
  try {
    return pn(n, t.anchorNode);
  } catch {
    return !1;
  }
}
function gi(n) {
  return n.nodeType == 3 ? Te(n, 0, n.nodeValue.length).getClientRects() : n.nodeType == 1 ? n.getClientRects() : [];
}
function ns(n, t, e, i) {
  return e ? Cr(n, t, e, i, -1) || Cr(n, t, e, i, 1) : !1;
}
function rs(n) {
  for (var t = 0; ; t++)
  ...
  for (let c = n, f = !1; c && !f; )
    if (c.nodeType == 1) {
      ...
      if (s == "nearest")
        ...
        let g = t.bottom - t.top, y = u.bottom - u.top;
        w = (s == "center" && g <= y ? t.top + g / 2 - y / 2 : s == "start" || s == "center" && e < 0 ? t.top - o : t.bottom - y + o) - u.top;
      }
      if (i == "nearest" ? t.left < u.left ? (p = -(u.left - t.left + r), e > 0 && t.right > u.right + p && (p = t.right - u.right + p + r)) : t.right > u.right && (p = t.right - u.right + r, e < 0 && t.left < u.left + p && (p = -(u.left + p - t.left + r))) : p = (i == "center" ? t.left + (t.right - t.left) / 2 - (u.right - u.left) / 2 : i == "start" == l ? t.left - r : t.right - (u.right - u.left) + r) - u.left, p || w)
        if (d)
          ...
          if (w) {
            let S = c.scrollTop;
            c.scrollTop += w, y = c.scrollTop - S;
          }
          if (p) {
            let S = c.scrollLeft;
            c.scrollLeft += p, g = c.scrollLeft - S;
          }
          t = {
            left: t.left - g,
            top: t.top - y,
            right: t.right - g,
            bottom: t.bottom - y
          }, g && Math.abs(g - p) < 1 && (i = "nearest"), y && Math.abs(y - w) < 1 && (s = "nearest");
        }
      if (d)
        break;
      c = c.assignedSlot || c.parentNode;
...
class Xc {
  ...
  setRange(t) {
    ...
    this.set(e, Math.min(t.anchorOffset, e ? pe(e) : 0), i, Math.min(t.focusOffset, i ? pe(i) : 0));
  }
  set(t, e, i, s) {
...
function tf(n, t) {
  ...
  if (!e || t.anchorNode != e || t.anchorOffset != i)
    return !1;
  for (i = Math.min(i, pe(e)); ; )
    if (i) {
      if (e.nodeType != 1)
        return !1;
      let s = e.childNodes[i - 1];
      s.contentEditable == "false" ? i-- : (e = s, i = pe(e));
    } else {
      if (e == n)
        return !0;
      i = rs(e), e = e.parentNode;
    }
}
function wl(n) {
...
class ft {
  ...
  static before(t, e) {
    return new ft(t.parentNode, rs(t), e);
  }
  static after(t, e) {
    return new ft(t.parentNode, rs(t) + 1, e);
  }
}
const Un = [];
class $ {
...
function bl(n, t, e, i, s, r, o, l, h) {
  ...
  if (!(t == i && c && !o && !u && r.length < 2 && c.merge(e, s, r.length ? f : null, e == 0, l, h))) {
    if (i < a.length) {
      let d = a[i];
      d && s < d.length ? (t == i && (d = d.split(s), s = 0), !u && f && d.merge(0, s, f, !0, 0, h) ? r[r.length - 1] = d : (s && d.merge(0, s, null, !1, 0, h), r.push(d))) : d != null && d.breakAfter && (f ? f.breakAfter = 1 : o = 1), i++;
    }
  ...
  readRange(t, e) {
    ...
    for (let s = t; ; ) {
      ...
      if (o == e)
        break;
      let l = $.get(s), h = $.get(o);
      (l && h ? l.breakAfter : (l ? l.breakAfter : Mr(s)) || Mr(o) && (s.nodeName != "BR" || s.cmIgnore) && this.text.length > r) && this.lineBreak(), s = o;
    }
...
let bt = typeof navigator < "u" ? navigator : { userAgent: "", vendor: "", platform: "" }, gn = typeof document < "u" ? document : { documentElement: { style: {} } };
const mn = /* @__PURE__ */ /Edge\/(\d+)/.exec(bt.userAgent), vl = /* @__PURE__ */ /MSIE \d/.test(bt.userAgent), wn = /* @__PURE__ */ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(bt.userAgent), Os = !!(vl || wn || mn), Tr = !Os && /* @__PURE__ */ /gecko\/(\d+)/i.test(bt.userAgent), Vs = !Os && /* @__PURE__ */ /Chrome\/(\d+)/.exec(bt.userAgent), Pr = "webkitFontSmoothing" in gn.documentElement.style, Sl = !Os && /* @__PURE__ */ /Apple Computer/.test(bt.vendor), Br = Sl && (/* @__PURE__ */ /Mobile\/\w+/.test(bt.userAgent) || bt.maxTouchPoints > 2);
var v = {
  mac: Br || /* @__PURE__ */ /Mac/.test(bt.platform),
  windows: /* @__PURE__ */ /Win/.test(bt.platform),
  linux: /* @__PURE__ */ /Linux|X11/.test(bt.platform),
  ie: Os,
  ie_version: vl ? gn.documentMode || 6 : wn ? +wn[1] : mn ? +mn[1] : 0,
  gecko: Tr,
  gecko_version: Tr ? +(/* @__PURE__ */ /Firefox\/(\d+)/.exec(bt.userAgent) || [0, 0])[1] : 0,
  chrome: !!Vs,
  ...
  webkit: Pr,
  safari: Sl,
  webkit_version: Pr ? +(/* @__PURE__ */ /\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0,
  tabSize: gn.documentElement.style.tabSize != null ? "tab-size" : "-moz-tab-size"
};
const ef = 256;
class Kt extends $ {
  constructor(t) {
  ...
  merge(t, e, i) {
    return this.flags & 8 || i && (!(i instanceof Kt) || this.length - (e - t) + i.length > ef || i.flags & 8) ? !1 : (this.text = this.text.slice(0, t) + (i ? i.text : "") + this.text.slice(e), this.markDirty(), !0);
  }
  split(t) {
...
class ie extends $ {
  ...
  setAttrs(t) {
    if (ml(t), this.mark.class && (t.className = this.mark.class), this.mark.attrs)
  ...
  merge(t, e, i, s, r, o) {
    return i && (!(i instanceof ie && i.mark.eq(this.mark)) || t && r <= 0 || e < this.length && o <= 0) ? !1 : (kl(this, t, e, i ? i.children : [], r - 1, o - 1), this.markDirty(), !0);
  }
  split(t) {
    let e = [], i = 0, s = -1, r = 0;
    ...
    let o = this.length - t;
    return this.length = t, s > -1 && (this.children.length = s, this.markDirty()), new ie(this.mark, e, o);
  }
  domAtPos(t) {
    return Cl(this, t);
  }
...
function sf(n, t, e) {
  ...
  t > i && (t = i);
  let s = t, r = t, o = 0;
  t == 0 && e < 0 || t == i && e >= 0 ? v.chrome || v.gecko || (t ? (s--, o = 1) : r < i && (r++, o = -1)) : e < 0 ? s-- : r < i && r++;
  let l = Te(n, s, r).getClientRects();
  if (!l.length)
    return null;
  let h = l[(o ? o < 0 : e >= 0) ? 0 : l.length - 1];
  return v.safari && !o && h.width == 0 && (h = Array.prototype.find.call(l, (a) => a.width) || h), o ? Gn(h, o < 0) : h || null;
}
class Ce extends $ {
  constructor(t, e, i) {
  ...
  split(t) {
    let e = Ce.create(this.widget, this.length - t, this.side);
  ...
  merge(t, e, i, s, r, o) {
    return i && (!(i instanceof Ce) || !this.widget.compare(i.widget) || t > 0 && r <= 0 || e < this.length && o <= 0) ? !1 : (this.length = t + (i ? i.length : 0) + (this.length - e), !0);
  }
  become(t) {
    return t instanceof Ce && t.side == this.side && this.widget.constructor == t.widget.constructor ? (this.widget.compare(t.widget) || this.markDirty(!0), this.dom && !this.prevWidget && (this.prevWidget = this.widget), this.widget = t.widget, this.length = t.length, !0) : !1;
  }
  ignoreMutation() {
    return !0;
  }
...
class Ue extends $ {
  ...
  become(t) {
    return t instanceof Ue && t.side == this.side;
  }
  split() {
    return new Ue(this.side);
  }
  sync() {
    if (!this.dom) {
...
Kt.prototype.children = Ce.prototype.children = Ue.prototype.children = Un;
function Cl(n, t) {
...
function Al(n, t, e) {
  let i, { children: s } = n;
  e > 0 && t instanceof ie && s.length && (i = s[s.length - 1]) instanceof ie && i.mark.eq(t.mark) ? Al(i, t.children[0], e - 1) : (s.push(t), t.setParent(n)), n.length += t.length;
}
function Ol(n, t, e) {
  ...
  l(n, t);
  let h = (e < 0 ? i : r) || i || r;
  return h ? h.coordsAt(Math.max(0, h == i ? s : o), e) : nf(n);
}
function nf(n) {
...
function bn(n, t, e) {
  ...
  if (t)
    for (let s in t)
      e && s in e || n.removeAttribute(i = s);
  if (e)
    for (let s in e)
      t && t[s] == e[s] || n.setAttribute(i = s, e[s]);
  return !!i;
}
function rf(n) {
...
class E extends Ge {
  ...
  */
  static widget(t) {
    ...
    return e += i && !t.inlineOrder ? e > 0 ? 3e8 : -4e8 : e > 0 ? 1e8 : -1e8, new ge(t, e, e, i, t.widget || null, !1);
  }
  /**
  ...
  */
  static replace(t) {
    ...
    if (t.isBlockGap)
      ...
      let { start: r, end: o } = Ml(t, e);
      i = (r ? e ? -3e8 : -1 : 5e8) - 1, s = (o ? e ? 2e8 : 1 : -6e8) + 1;
    }
    return new ge(t, i, s, e, t.widget || null, !0);
  }
  /**
...
class bi extends E {
  constructor(t) {
    let { start: e, end: i } = Ml(t);
    super(e ? -1 : 5e8, i ? 1 : -6e8, null, t), this.tagName = t.tagName || "span", this.class = t.class || "", this.attrs = t.attributes || null;
  }
  eq(t) {
    var e, i;
    return this == t || t instanceof bi && this.tagName == t.tagName && (this.class || ((e = this.attrs) === null || e === void 0 ? void 0 : e.class)) == (t.class || ((i = t.attrs) === null || i === void 0 ? void 0 : i.class)) && Qn(this.attrs, t.attrs, "class");
  }
  range(t, e = t) {
    if (t >= e)
...
class ki extends E {
  ...
  eq(t) {
    return t instanceof ki && this.spec.class == t.spec.class && Qn(this.spec.attributes, t.spec.attributes);
  }
  range(t, e = t) {
    if (e != t)
...
class ge extends E {
  constructor(t, e, i, s, r, o) {
    super(e, i, r, t), this.block = s, this.isReplace = o, this.mapMode = s ? e <= 0 ? gt.TrackBefore : gt.TrackAfter : gt.TrackDel;
  }
  ...
  eq(t) {
    return t instanceof ge && of(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
  }
  range(t, e = t) {
...
class ct extends $ {
  ...
  merge(t, e, i, s, r, o) {
    ...
    return s && this.setDeco(i ? i.attrs : null), kl(this, t, e, i ? i.children : [], r, o), !0;
  }
  split(t) {
    let e = new ct();
  ...
  setDeco(t) {
    Qn(this.attrs, t) || (this.dom && (this.prevAttrs = this.attrs, this.markDirty()), this.attrs = t);
  }
  append(t, e) {
    Al(this, t, e);
  }
  ...
  addLineDeco(t) {
    ...
    e && (this.attrs = yn(e, this.attrs || {})), i && (this.attrs = yn({ class: i }, this.attrs || {}));
  }
  domAtPos(t) {
    return Cl(this, t);
  }
  ...
  sync(t, e) {
    ...
    for (; s && $.get(s) instanceof ie; )
      s = s.lastChild;
    if (!s || !this.length || s.nodeName != "BR" && ((i = $.get(s)) === null || i === void 0 ? void 0 : i.isEditable) == !1 && (!v.ios || !this.children.some((r) => r instanceof Kt))) {
  ...
  measureTextSize() {
    ...
    let t = 0, e;
    for (let i of this.children) {
      if (!(i instanceof Kt) || /[^ -~]/.test(i.text))
        return null;
      let s = gi(i.dom);
      if (s.length != 1)
        return null;
...
class fi {
  ...
  posCovered() {
    ...
    return !t.breakAfter && !(t instanceof Ae && t.type == Y.WidgetBefore);
  }
  getLine() {
    return this.curLine || (this.content.push(this.curLine = new ct()), this.atCursorPos = !0), this.curLine;
  }
  flushBuffer(t = this.bufferMarks) {
    this.pendingBuffer && (this.curLine.append(Oi(new Ue(-1), t), t.length), this.pendingBuffer = 0);
  }
  addBlockWidget(t) {
  ...
  buildText(t, e, i) {
    for (; t > 0; ) {
      ...
      this.flushBuffer(e.slice(e.length - i)), this.getLine().append(Oi(new Kt(this.text.slice(this.textOff, this.textOff + s)), e), i), this.atCursorPos = !0, this.textOff += s, t -= s, i = 0;
    }
  }
  span(t, e, i, s) {
  ...
  point(t, e, i, s, r, o) {
    if (this.disallowBlockEffectsFor[o] && i instanceof ge) {
      if (i.block)
    ...
    if (i instanceof ge)
      if (i.block) {
        let { type: h } = i;
        h == Y.WidgetAfter && !this.posCovered() && this.getLine(), this.addBlockWidget(new Ae(i.widget || new Lr("div"), l, h));
      } else {
        let h = Ce.create(i.widget || new Lr("span"), l, l ? 0 : i.startSide), a = this.atCursorPos && !h.isEditable && r <= s.length && (t < e || i.startSide > 0), c = !h.isEditable && (t < e || r > s.length || i.startSide <= 0), f = this.getLine();
        this.pendingBuffer == 2 && !a && !h.isEditable && (this.pendingBuffer = 0), this.flushBuffer(s), a && (f.append(Oi(new Ue(1), s), r), r = s.length + Math.max(0, r - s.length)), f.append(Oi(h, s), r), this.atCursorPos = c, this.pendingBuffer = c ? t < e || r > s.length ? 1 : 2 : 0, this.pendingBuffer && (this.bufferMarks = s.slice());
      }
    else
...
const Dl = /* @__PURE__ */ A.define(), Tl = /* @__PURE__ */ A.define(), Pl = /* @__PURE__ */ A.define(), Bl = /* @__PURE__ */ A.define(), xn = /* @__PURE__ */ A.define(), Rl = /* @__PURE__ */ A.define(), Ll = /* @__PURE__ */ A.define(), El = /* @__PURE__ */ A.define({
  combine: (n) => n.some((t) => t)
}), lf = /* @__PURE__ */ A.define({
  combine: (n) => n.some((t) => t)
});
class os {
  ...
  map(t) {
    return t.empty ? this : new os(this.range.map(t), this.y, this.x, this.yMargin, this.xMargin);
  }
}
const Er = /* @__PURE__ */ _.define({ map: (n, t) => n.map(t) });
function Zt(n, t, e) {
  let i = n.facet(Bl);
  i.length ? i[0](t) : window.onerror ? window.onerror(String(t), e, void 0, void 0, t) : e ? console.error(e + ":", t) : console.error(t);
}
const Ms = /* @__PURE__ */ A.define({ combine: (n) => n.length ? n[0] : !0 });
let hf = 0;
const ri = /* @__PURE__ */ A.define();
class vt {
  constructor(t, e, i, s) {
  ...
  */
  static define(t, e) {
    ...
    return new vt(hf++, t, i, (o) => {
      let l = [ri.of(o)];
      return r && l.push(mi.of((h) => {
        let a = h.plugin(o);
        return a ? r(a) : E.none;
      })), s && l.push(s(o)), l;
    });
...
const Nl = /* @__PURE__ */ A.define(), Jn = /* @__PURE__ */ A.define(), mi = /* @__PURE__ */ A.define(), Yn = /* @__PURE__ */ A.define(), Il = /* @__PURE__ */ A.define();
function Vl(n) {
  let t = 0, e = 0, i = 0, s = 0;
...
const oi = /* @__PURE__ */ A.define();
class Ct {
  constructor(t, e, i, s) {
    this.fromA = t, this.toA = e, this.fromB = i, this.toB = s;
  }
  join(t) {
    return new Ct(Math.min(this.fromA, t.fromA), Math.max(this.toA, t.toA), Math.min(this.fromB, t.fromB), Math.max(this.toB, t.toB));
  }
  addToSet(t) {
  ...
  static extendWithRanges(t, e) {
    ...
    for (let s = 0, r = 0, o = 0, l = 0; ; s++) {
      ...
      for (; r < e.length && e[r] < c; ) {
        ...
        if (d <= p && new Ct(d + a, p + a, d, p).addToSet(i), u > c)
          break;
        r += 2;
      }
      if (!h)
        return i;
      new Ct(h.fromA, h.toA, h.fromB, h.toB).addToSet(i), o = h.toA, l = h.toB;
    }
  }
}
class ls {
  constructor(t, e, i) {
    ...
    let s = [];
    this.changes.iterChangedRanges((r, o, l, h) => s.push(new Ct(r, o, l, h))), this.changedRanges = s;
  }
  /**
  @internal
  */
...
const cf = /* @__PURE__ */ Hl("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), ff = /* @__PURE__ */ Hl("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), Sn = /* @__PURE__ */ Object.create(null), It = [];
for (let n of ["()", "[]", "{}"]) {
  let t = /* @__PURE__ */ n.charCodeAt(0), e = /* @__PURE__ */ n.charCodeAt(1);
  Sn[t] = e, Sn[e] = -t;
}
function uf(n) {
  return n <= 247 ? cf[n] : 1424 <= n && n <= 1524 ? 2 : 1536 <= n && n <= 1785 ? ff[n - 1536] : 1774 <= n && n <= 2220 ? 4 : 8192 <= n && n <= 8203 ? 256 : 64336 <= n && n <= 65023 ? 4 : n == 8204 ? 256 : 1;
}
const df = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/;
class We {
  /**
...
const j = [];
function pf(n, t) {
  let e = n.length, i = t == vn ? 1 : 2, s = t == vn ? 2 : 1;
  if (!n || i == 1 && !df.test(n))
    return _l(e);
  for (let o = 0, l = i, h = i; o < e; o++) {
    let a = uf(n.charCodeAt(o));
  ...
  for (let o = 0, l = 0, h = 0, a, c, f; o < e; o++)
    if (c = Sn[a = n.charCodeAt(o)])
      if (c < 0) {
        for (let u = l - 3; u >= 0; u -= 3)
          if (It[u + 1] == -c) {
            let d = It[u + 2], p = d & 2 ? i : d & 4 ? d & 1 ? s : i : 0;
            p && (j[o] = j[It[u]] = p), l = u;
            break;
          }
      } else {
...
function gf(n, t, e, i, s) {
  ...
  l < 0 && (l = We.find(t, o, (r = i.bidiLevel) !== null && r !== void 0 ? r : -1, i.assoc));
  let h = t[l];
  o == h.side(s, e) && (h = t[l += s ? 1 : -1], o = h.side(!s, e));
  let a = s == (h.dir == e), c = mt(n.text, o, a);
  if ($l = n.text.slice(Math.min(o, c), Math.max(o, c)), c != h.side(s, e))
...
class Nr extends $ {
  ...
  update(t) {
    ...
    this.minWidth > 0 && e.length && (e.every(({ fromA: l, toA: h }) => h < this.minWidthFrom || l > this.minWidthTo) ? (this.minWidthFrom = t.changes.mapPos(this.minWidthFrom, 1), this.minWidthTo = t.changes.mapPos(this.minWidthTo, 1)) : this.minWidth = this.minWidthFrom = this.minWidthTo = 0);
    let i = this.view.inputState.composing < 0 ? null : wf(this.view, t.changes);
    if (this.hasComposition) {
      this.markedForComposition.clear();
      let { from: l, to: h } = this.hasComposition;
      e = new Ct(l, h, t.changes.mapPos(l, -1), t.changes.mapPos(h, 1)).addToSet(e.slice());
    }
    this.hasComposition = i ? { from: i.range.fromB, to: i.range.toB } : null, (v.ie || v.chrome) && !i && t && t.state.doc.lines != t.startState.doc.lines && (this.forceSelection = !0);
    let s = this.decorations, r = this.updateDeco(), o = kf(s, r, t.changes);
    return e = Ct.extendWithRanges(e, o), !(this.flags & 7) && e.length == 0 ? !1 : (this.updateInner(e, t.startState.doc.length, i), t.transactions.length && (this.lastUpdate = Date.now()), !0);
  }
  ...
  updateChildren(t, e, i) {
    ...
    for (let o = s.length - 1; ; o--) {
      ...
      if (!l)
        break;
      let { fromA: h, toA: a, fromB: c, toB: f } = l, u, d, p, w;
      if (i && i.range.fromB < f && i.range.toB > c) {
        let x = fi.build(this.view.state.doc, c, i.range.fromB, this.decorations, this.dynamicDecorationMap), M = fi.build(this.view.state.doc, i.range.toB, f, this.decorations, this.dynamicDecorationMap);
        d = x.breakAtStart, p = x.openStart, w = M.openEnd;
        let C = this.compositionView(i);
        M.breakAtStart ? C.breakAfter = 1 : M.content.length && C.merge(C.length, C.length, M.content[0], !1, M.openStart, 0) && (C.breakAfter = M.content[0].breakAfter, M.content.shift()), x.content.length && C.merge(0, 0, x.content[x.content.length - 1], !0, 0, x.openEnd) && x.content.pop(), u = x.content.concat(C).concat(M.content);
      } else
        ({ content: u, breakAtStart: d, openStart: p, openEnd: w } = fi.build(this.view.state.doc, c, f, this.decorations, this.dynamicDecorationMap));
      let { i: g, off: y } = r.findPos(a, 1), { i: S, off: O } = r.findPos(h, -1);
      bl(this, S, O, g, y, u, d, p, w);
    }
  ...
  updateSelection(t = !1, e = !1) {
    ...
    let i = this.view.root.activeElement, s = i == this.dom, r = !s && Ki(this.dom, this.view.observer.selectionRange) && !(i && this.dom.contains(i));
    if (!(s || e || r))
      return;
    let o = this.forceSelection;
    this.forceSelection = !1;
    let l = this.view.state.selection.main, h = this.domAtPos(l.anchor), a = l.empty ? h : this.domAtPos(l.head);
    if (v.gecko && l.empty && !this.hasComposition && mf(h)) {
      let f = document.createTextNode("");
      this.view.observer.ignore(() => h.node.insertBefore(f, h.node.childNodes[h.offset] || null)), h = a = new ft(f, 0), o = !0;
    }
    let c = this.view.observer.selectionRange;
    (o || !c.focusNode || !ns(h.node, h.offset, c.anchorNode, c.anchorOffset) || !ns(a.node, a.offset, c.focusNode, c.focusOffset)) && (this.view.observer.ignore(() => {
      v.android && v.chrome && this.dom.contains(c.focusNode) && xf(c.focusNode, this.dom) && (this.dom.blur(), this.dom.focus({ preventScroll: !0 }));
      let f = ss(this.view.root);
      if (f)
        if (l.empty) {
          if (v.gecko) {
            let u = yf(h.node, h.offset);
            if (u && u != 3) {
              let d = zl(h.node, h.offset, u == 1 ? 1 : -1);
              d && (h = new ft(d, u == 1 ? 0 : d.nodeValue.length));
            }
          }
          f.collapse(h.node, h.offset), l.bidiLevel != null && c.cursorBidiLevel != null && (c.cursorBidiLevel = l.bidiLevel);
        } else if (f.extend) {
    ...
    }), this.view.observer.setSelectionRange(h, a)), this.impreciseAnchor = h.precise ? null : new ft(c.anchorNode, c.anchorOffset), this.impreciseHead = a.precise ? null : new ft(c.focusNode, c.focusOffset);
  }
  enforceCursorAssoc() {
    if (this.hasComposition)
      return;
    let { view: t } = this, e = t.state.selection.main, i = ss(t.root), { anchorNode: s, anchorOffset: r } = t.observer.selectionRange;
    if (!i || !e.empty || !e.assoc || !i.modify)
      return;
    let o = ct.find(this, e.head);
    if (!o)
      return;
    let l = o.posAtStart;
  ...
  coordsAt(t, e) {
    for (let i = this.length, s = this.children.length - 1; ; s--) {
      ...
      if (t > o || t == o && r.type != Y.WidgetBefore && r.type != Y.WidgetAfter && (!s || e == 2 || this.children[s - 1].breakAfter || this.children[s - 1].type == Y.WidgetBefore && e > -2))
  ...
  coordsForChar(t) {
    ...
    if (r == i)
      return null;
    let o = Te(s.dom, i, r).getClientRects();
    return !o.length || o[0].top >= o[0].bottom ? null : o[0];
  }
  measureVisibleLineHeights(t) {
    let e = [], { from: i, to: s } = t, r = this.view.contentDOM.clientWidth, o = r > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, l = -1, h = this.view.textDirection == J.LTR;
    for (let a = 0, c = 0; c < this.children.length; c++) {
      ...
      if (a >= i) {
        ...
        if (e.push(d.height), o) {
          let p = f.dom.lastChild, w = p ? gi(p) : [];
          if (w.length) {
  ...
  updateDeco() {
    let t = this.view.state.facet(mi).map((e, i) => (this.dynamicDecorationMap[i] = typeof e == "function") ? e(this.view) : e);
  ...
  scrollIntoView(t) {
    ...
    Jc(this.view.scrollDOM, o, e.head < e.anchor ? -1 : 1, t.x, t.y, t.xMargin, t.yMargin, this.view.textDirection == J.LTR);
  }
}
function mf(n) {
...
function Fl(n) {
  let t = n.observer.selectionRange, e = t.focusNode && zl(t.focusNode, t.focusOffset, 0);
  if (!e)
    return null;
  let i = $.get(e), s, r;
  if (i instanceof Kt)
    ...
    t:
      for (let o = 0, l = e; ; ) {
        for (let a = l.previousSibling, c; a; a = a.previousSibling) {
          if (c = $.get(a)) {
            s = r = c.posAtEnd + o;
            break t;
          }
          let f = new xl([], n.state);
          if (f.readNode(a), f.text.indexOf(He) > -1)
            return null;
          o += f.text.length;
        }
        if (l = l.parentNode, !l)
  ...
  return { from: s, to: r, node: e };
}
function wf(n, t) {
  let e = Fl(n);
  if (!e)
    return null;
  let { from: i, to: s, node: r } = e, o = t.mapPos(i, -1), l = t.mapPos(s, 1), h = r.nodeValue;
  if (/[\n\r]/.test(h))
    return null;
  if (l - o != h.length) {
    ...
    if (d - u == h.length)
      o = u, l = d;
    else if (n.state.doc.sliceString(l - h.length, l) == h)
      o = l - h.length;
    else if (n.state.doc.sliceString(o, o + h.length) == h)
      l = o + h.length;
    else
      return null;
  }
  let { main: a } = n.state.selection;
  if (n.state.doc.sliceString(o, l) != h || o > a.head || l < a.head)
    return null;
  let c = [], f = new Ct(i, s, o, l);
  for (let u = r.parentNode; ; u = u.parentNode) {
    let d = $.get(u);
    if (d instanceof ie)
      c.push({ node: u, deco: d.mark });
    else {
      if (d instanceof ct || u.nodeName == "DIV" && u.parentNode == n.contentDOM)
        return { range: f, text: r, marks: c, line: u };
      if (u != n.contentDOM)
        c.push({ node: u, deco: new bi({
          inclusive: !0,
          attributes: rf(u),
...
function vf(n, t, e = 1) {
  ...
  let o = r, l = r;
  e < 0 ? o = mt(s.text, r, !1) : l = mt(s.text, r);
...
function Cn(n, t, e) {
  ...
  for (let p = n.firstChild; p; p = p.nextSibling) {
    ...
    for (let g = 0; g < w.length; g++) {
      let y = w[g];
      s && _s(s, y) && (y = Vr(Hr(y, s.bottom), s.top));
      let S = Sf(t, y), O = Cf(e, y);
      if (S == 0 && O == 0)
        return p.nodeType == 3 ? _r(p, t, e) : Cn(p, t, e);
      if (!i || o > O || o == O && r > S) {
        i = p, s = y, r = S, o = O;
        let x = O ? e < y.top ? -1 : 1 : S ? t < y.left ? -1 : 1 : 0;
        l = !x || (x > 0 ? g < w.length - 1 : g > 0);
      }
      S == 0 ? e > y.bottom && (!c || c.bottom < y.bottom) ? (h = p, c = y) : e < y.top && (!f || f.top > y.top) && (a = p, f = y) : c && _s(c, y) ? c = Hr(c, y.bottom) : f && _s(f, y) && (f = Vr(f, y.top));
    }
  }
...
function _r(n, t, e) {
  ...
  for (let l = 0; l < i; l++) {
    let h = Te(n, l, l + 1).getClientRects();
    for (let a = 0; a < h.length; a++) {
      ...
      if (c.left - 1 <= t && c.right + 1 >= t && f < r) {
        ...
        if ((v.chrome || v.gecko) && Te(n, l).getBoundingClientRect().left == c.right && (d = !u), f <= 0)
...
function Wl(n, t, e, i = -1) {
  ...
  for (let x = n.viewState.heightOracle.textHeight / 2, M = !1; h = n.elementAtHeight(u), h.type != Y.Text; )
    for (; u = i > 0 ? h.bottom + x : h.top - x, !(u >= 0 && u <= a); ) {
      if (M)
        return e ? null : 0;
      M = !0, i = -i;
    }
  ...
  if (d < n.viewport.from)
    return n.viewport.from == 0 ? 0 : e ? null : $r(n, o, h, c, f);
  if (d > n.viewport.to)
    return n.viewport.to == n.state.doc.length ? n.state.doc.length : e ? null : $r(n, o, h, c, f);
  let p = n.dom.ownerDocument, w = n.root.elementFromPoint ? n.root : p, g = w.elementFromPoint(c, f);
  g && !n.contentDOM.contains(g) && (g = null), g || (c = Math.max(o.left + 1, Math.min(o.right - 1, c)), g = w.elementFromPoint(c, f), g && !n.contentDOM.contains(g) && (g = null));
  let y, S = -1;
  if (g && ((s = n.docView.nearest(g)) === null || s === void 0 ? void 0 : s.isEditable) != !1) {
    if (p.caretPositionFromPoint) {
      let x = p.caretPositionFromPoint(c, f);
      x && ({ offsetNode: y, offset: S } = x);
    } else if (p.caretRangeFromPoint) {
      let x = p.caretRangeFromPoint(c, f);
      x && ({ startContainer: y, startOffset: S } = x, (!n.contentDOM.contains(y) || v.safari && Af(y, S, c) || v.chrome && Of(y, S, c)) && (y = void 0));
    }
  }
  if (!y || !n.docView.dom.contains(y)) {
    let x = ct.find(n.docView, d);
    if (!x)
      return u > h.top + h.height / 2 ? h.to : h.from;
    ({ node: y, offset: S } = Cn(x.dom, c, f));
  }
  let O = n.docView.nearest(y);
  if (!O)
    return null;
  if (O.isWidget && ((r = O.dom) === null || r === void 0 ? void 0 : r.nodeType) == 1) {
    let x = O.dom.getBoundingClientRect();
    return t.y < x.top || t.y <= x.bottom && t.x <= (x.left + x.right) / 2 ? O.posAtStart : O.posAtEnd;
  } else
    return O.localPosFromDOM(y, S) + O.posAtStart;
}
function $r(n, t, e, i, s) {
  ...
  return e.from + Wc(o, r, n.state.tabSize);
}
function Af(n, t, e) {
  let i;
  ...
  for (let s = n.nextSibling; s; s = s.nextSibling)
    if (s.nodeType != 1 || s.nodeName != "BR")
      return !1;
  return Te(n, i - 1, i).getBoundingClientRect().left > e;
}
function Of(n, t, e) {
  if (t != 0)
    return !1;
  ...
  let i = n.nodeType == 1 ? n.getBoundingClientRect() : Te(n, 0, Math.max(n.nodeValue.length, 1)).getBoundingClientRect();
  return e - i.left > 5;
}
function Mf(n, t) {
  ...
  if (Array.isArray(e.type)) {
    for (let i of e.type)
      if (i.to > t || i.to == t && (i.to == e.to || i.type == Y.Text))
        return i;
  }
  return e;
}
function Df(n, t, e, i) {
  let s = Mf(n, t.head), r = !i || s.type != Y.Text || !(n.lineWrapping || s.widgetLineBreaks) ? null : n.coordsAtPos(t.assoc < 0 && t.head > s.from ? t.head - 1 : t.head);
  if (r) {
...
function Pf(n, t, e, i) {
  ...
  for (let d = 0; ; d += 10) {
    let p = l + (u + d) * r, w = Wl(n, { x: f, y: p }, !1, r);
    if (p < h.top || p > h.bottom || (r < 0 ? w < s : w > s))
...
function $s(n, t, e) {
  let i = qi(n.state.facet(Yn).map((s) => s(n)), e.from, t.head > e.from ? -1 : 1);
...
class Bf {
  constructor(t) {
    ...
    for (let i in U) {
      ...
      t.contentDOM.addEventListener(i, (r) => {
        zr(t, r) && e(s, r);
      }, An[i]), this.registeredEvents.push(i);
    }
    t.scrollDOM.addEventListener("mousedown", (i) => {
      if (i.target == t.scrollDOM && i.clientY > t.contentDOM.getBoundingClientRect().bottom && (e(U.mousedown, i), !i.defaultPrevented && i.button == 2)) {
      ...
      i.target == t.scrollDOM && i.clientY > t.contentDOM.getBoundingClientRect().bottom && e(U.drop, i);
    }), v.chrome && v.chrome_version == 102 && t.scrollDOM.addEventListener("wheel", () => {
    ...
    }, { passive: !0 }), this.notifiedFocused = t.hasFocus, v.safari && t.contentDOM.addEventListener("input", () => null);
  }
  ...
  keydown(t, e) {
    if (this.lastKeyCode = e.keyCode, this.lastKeyTime = Date.now(), e.keyCode == 9 && Date.now() < this.lastEscPress + 2e3)
      return !0;
    if (e.keyCode != 27 && Kl.indexOf(e.keyCode) < 0 && (t.inputState.lastEscPress = 0), v.android && v.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8))
      return t.observer.delayAndroidKey(e.key, e.keyCode), !0;
    let i;
    return v.ios && !e.synthetic && !e.altKey && !e.metaKey && ((i = jl.find((s) => s.keyCode == e.keyCode)) && !e.ctrlKey || Rf.indexOf(e.key) > -1 && e.ctrlKey && !e.shiftKey) ? (this.pendingIOSKey = i || e, setTimeout(() => this.flushIOSKey(t), 250), !0) : !1;
  }
  flushIOSKey(t) {
    let e = this.pendingIOSKey;
    return e ? (this.pendingIOSKey = void 0, ze(t.contentDOM, e.key, e.keyCode)) : !1;
  }
  ignoreDuringComposition(t) {
    return /^key/.test(t.type) ? this.composing > 0 ? !0 : v.safari && !v.ios && this.compositionPendingKey && Date.now() - this.compositionEndedAt < 100 ? (this.compositionPendingKey = !1, !0) : !1 : !1;
  }
  mustFlushObserver(t) {
...
class Ef {
  constructor(t, e, i, s) {
    this.view = t, this.startEvent = e, this.style = i, this.mustSelect = s, this.scrollSpeed = { x: 0, y: 0 }, this.scrolling = -1, this.lastEvent = e, this.scrollParent = Yc(t.contentDOM), this.atoms = t.state.facet(Yn).map((o) => o(t));
    let r = t.contentDOM.ownerDocument;
    r.addEventListener("mousemove", this.move = this.move.bind(this)), r.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = e.shiftKey, this.multiple = t.state.facet(N.allowMultipleSelections) && Nf(t, e), this.dragging = Vf(t, e) && Ql(e) == 1 ? null : !1;
  }
  start(t) {
  ...
  move(t) {
    ...
    if (t.buttons == 0)
      return this.destroy();
    if (this.dragging || this.dragging == null && Lf(this.startEvent, t) < 10)
      return;
    this.select(this.lastEvent = t);
    let i = 0, s = 0, r = ((e = this.scrollParent) === null || e === void 0 ? void 0 : e.getBoundingClientRect()) || { left: 0, top: 0, right: this.view.win.innerWidth, bottom: this.view.win.innerHeight }, o = Vl(this.view);
    t.clientX - o.left <= r.left + Mi ? i = -Di(r.left - t.clientX) : t.clientX + o.right >= r.right - Mi && (i = Di(t.clientX - r.right)), t.clientY - o.top <= r.top + Mi ? s = -Di(r.top - t.clientY) : t.clientY + o.bottom >= r.bottom - Mi && (s = Di(t.clientY - r.bottom)), this.setScrollSpeed(i, s);
  }
  up(t) {
  ...
  skipAtoms(t) {
    ...
    for (let i = 0; i < t.ranges.length; i++) {
      ...
      if (s.empty) {
        let o = qi(this.atoms, s.from, 0);
        o != s.from && (r = b.cursor(o, -1));
      } else {
        let o = qi(this.atoms, s.from, -1), l = qi(this.atoms, s.to, 1);
...
function Nf(n, t) {
  ...
  return e.length ? e[0](t) : v.mac ? t.metaKey : t.ctrlKey;
}
function If(n, t) {
  let e = n.state.facet(Tl);
  return e.length ? e[0](t) : v.mac ? !t.altKey : !t.ctrlKey;
}
function Vf(n, t) {
...
const U = /* @__PURE__ */ Object.create(null), An = /* @__PURE__ */ Object.create(null), ql = v.ie && v.ie_version < 15 || v.ios && v.webkit_version < 604;
function Hf(n) {
  ...
  e.style.cssText = "position: fixed; left: -10000px; top: 10px", e.focus(), setTimeout(() => {
    n.focus(), e.remove(), Gl(n, e.value);
  }, 50);
}
function Gl(n, t) {
  let { state: e } = n, i, s = 1, r = e.toText(t), o = r.lines == e.selection.ranges.length;
  if (On != null && e.selection.ranges.every((h) => h.empty) && On == r.toString()) {
    let h = -1;
    i = e.changeByRange((a) => {
...
An.touchstart = An.touchmove = { passive: !0 };
U.mousedown = (n, t) => {
  if (n.observer.flush(), n.inputState.lastTouchTime > Date.now() - 2e3)
    return;
  let e = null;
  for (let i of n.state.facet(Pl))
    if (e = i(n, t), e)
      break;
  if (!e && t.button == 0 && (e = Ff(n, t)), e) {
    let i = !n.hasFocus;
    n.inputState.startMouseSelection(new Ef(n, t, e, i)), i && n.observer.ignore(() => gl(n.contentDOM)), n.inputState.mouseSelection && n.inputState.mouseSelection.start(t);
  }
};
function Wr(n, t, e, i) {
  if (i == 1)
    return b.cursor(t, e);
  if (i == 2)
    return vf(n.state, t, e);
  {
    let s = ct.find(n.docView, t), r = n.state.doc.lineAt(s ? s.posAtEnd : t), o = s ? s.posAtStart : r.from, l = s ? s.posAtEnd : r.to;
    return l < n.state.doc.length && l == r.to && l++, b.range(o, l);
  }
}
let Ul = (n, t) => n >= t.top && n <= t.bottom, jr = (n, t, e) => Ul(t, e) && n >= e.left && n <= e.right;
function _f(n, t, e, i) {
  let s = ct.find(n.docView, t);
  if (!s)
    return 1;
  ...
  return l && jr(e, i, l) ? 1 : o && Ul(i, o) ? -1 : 1;
}
function Kr(n, t) {
  let e = n.posAtCoords({ x: t.clientX, y: t.clientY }, !1);
  return { pos: e, bias: _f(n, e, t.clientX, t.clientY) };
}
const $f = v.ie && v.ie_version <= 11;
let qr = null, Gr = 0, Ur = 0;
function Ql(n) {
  if (!$f)
    return n.detail;
  let t = qr, e = Ur;
  return qr = n, Ur = Date.now(), Gr = !t || e > Date.now() - 400 && Math.abs(t.clientX - n.clientX) < 2 && Math.abs(t.clientY - n.clientY) < 2 ? (Gr + 1) % 3 : 1;
}
function Ff(n, t) {
  let e = Kr(n, t), i = Ql(t), s = n.state.selection;
  return {
    update(r) {
      r.docChanged && (e.pos = r.changes.mapPos(e.pos), s = s.map(r.changes));
    },
    get(r, o, l) {
      let h = Kr(n, r), a, c = Wr(n, h.pos, h.bias, i);
      if (e.pos != h.pos && !o) {
        let f = Wr(n, e.pos, e.bias, i), u = Math.min(f.from, c.from), d = Math.max(f.to, c.to);
        c = u < c.from ? b.range(u, d) : b.range(d, u);
      }
      return o ? s.replaceRange(s.main.extend(c.from, c.to)) : l && i == 1 && s.ranges.length > 1 && (a = zf(s, h.pos)) ? a : l ? s.addRange(c) : b.create([c]);
    }
  };
}
function zf(n, t) {
...
function Qr(n, t, e, i) {
  ...
  t.preventDefault();
  let { mouseSelection: r } = n.inputState, o = i && r && r.dragging && If(n, t) ? { from: r.dragging.from, to: r.dragging.to } : null, l = { from: s, insert: e }, h = n.state.changes(o ? [o, l] : l);
  n.focus(), n.dispatch({
    changes: h,
...
U.drop = (n, t) => {
  ...
  if (e && e.length) {
    ...
    let i = Array(e.length), s = 0, r = () => {
      ++s == e.length && Qr(n, t, i.filter((o) => o != null).join(n.state.lineBreak), !1);
    };
    ...
    Qr(n, t, t.dataTransfer.getData("Text"), !0);
};
U.paste = (n, t) => {
  if (n.state.readOnly)
    return t.preventDefault();
  ...
  e ? (Gl(n, e.getData("text/plain") || e.getData("text/uri-text")), t.preventDefault()) : Hf(n);
};
function Wf(n, t) {
...
let On = null;
U.copy = U.cut = (n, t) => {
  let { text: e, ranges: i, linewise: s } = jf(n.state);
  if (!e && !s)
    return;
  On = s ? e : null;
  let r = ql ? null : t.clipboardData;
  r ? (t.preventDefault(), r.clearData(), r.setData("text/plain", e)) : Wf(n, e), t.type == "cut" && !n.state.readOnly && n.dispatch({
    changes: i,
    scrollIntoView: !0,
    userEvent: "delete.cut"
  });
};
const Jl = /* @__PURE__ */ Xe.define();
function Yl(n, t) {
  let e = [];
  ...
  return e ? n.update({ effects: e, annotations: Jl.of(!0) }) : null;
}
function Xl(n) {
  setTimeout(() => {
    let t = n.hasFocus;
...
U.focus = (n) => {
  n.inputState.lastFocusTime = Date.now(), !n.scrollDOM.scrollTop && (n.inputState.lastScrollTop || n.inputState.lastScrollLeft) && (n.scrollDOM.scrollTop = n.inputState.lastScrollTop, n.scrollDOM.scrollLeft = n.inputState.lastScrollLeft), Xl(n);
};
U.blur = (n) => {
  n.observer.clearSelectionRange(), Xl(n);
};
...
U.beforeinput = (n, t) => {
  var e;
  let i;
  if (v.chrome && v.android && (i = jl.find((s) => s.inputType == t.inputType)) && (n.observer.delayAndroidKey(i.key, i.keyCode), i.key == "Backspace" || i.key == "Delete")) {
...
const Jr = ["pre-wrap", "normal", "pre-line", "break-spaces"];
class Kf {
  constructor(t) {
  ...
  mustRefreshForWrapping(t) {
    return Jr.indexOf(t) > -1 != this.lineWrapping;
  }
  ...
  refresh(t, e, i, s, r, o) {
    let l = Jr.indexOf(t) > -1, h = Math.round(e) != Math.round(this.lineHeight) || this.lineWrapping != l;
...
class zt {
  ...
  */
  get widget() {
    return this._content instanceof ge ? this._content.widget : null;
  }
  /**
  ...
  */
  join(t) {
    ...
    return new zt(this.from, this.length + t.length, this.top, this.height + t.height, e);
  }
}
...
class dt {
  ...
  setHeight(t, e) {
    this.height != e && (Math.abs(this.height - e) > Gi && (t.heightChanged = !0), this.height = e);
  }
  ...
  applyChanges(t, e, i, s) {
    ...
    for (let l = s.length - 1; l >= 0; l--) {
      let { fromA: h, toA: a, fromB: c, toB: f } = s[l], u = r.lineAt(h, F.ByPosNoHeight, i.setDoc(e), 0, 0), d = u.to >= a ? u : r.lineAt(a, F.ByPosNoHeight, i, 0, 0);
      for (f += d.to - a, a = d.to; l > 0 && u.from <= s[l - 1].toA; )
        h = s[l - 1].fromA, c = s[l - 1].fromB, l--, h < u.from && (u = r.lineAt(h, F.ByPosNoHeight, i, 0, 0));
      c += u.from - h, h = u.from;
      let p = Xn.build(i.setDoc(o), t, c, f);
      r = r.replace(h, a, p);
    }
  ...
  static of(t) {
    ...
    let o = 0;
    return t[e - 1] == null ? (o = 1, e--) : t[e] == null && (o = 1, i++), new Gf(dt.of(t.slice(0, e)), o, dt.of(t.slice(i)));
  }
}
dt.prototype.size = 1;
class Zl extends dt {
  ...
  blockAt(t, e, i, s) {
    return new zt(s, this.length, i, this.height, this.deco || 0);
  }
  lineAt(t, e, i, s, r) {
...
class yt extends Zl {
  ...
  blockAt(t, e, i, s) {
    return new zt(s, this.length, i, this.height, this.breaks);
  }
  replace(t, e, i) {
    let s = i[0];
    return i.length == 1 && (s instanceof yt || s instanceof nt && s.flags & 4) && Math.abs(this.length - s.length) < 10 ? (s instanceof nt ? s = new yt(s.length, this.height) : s.height = this.height, this.outdated || (s.outdated = !1), s) : dt.of(i);
  }
  updateHeight(t, e = 0, i = !1, s) {
...
class nt extends dt {
  ...
  lineAt(t, e, i, s, r) {
    ...
    return new zt(a.from, a.length, Math.max(s, Math.min(u, s + this.height - c)), c, 0);
  }
  forEachLine(t, e, i, s, r, o) {
    ...
    for (let c = t, f = s; c <= e; ) {
      ...
      let d = h + a * u.length;
      o(new zt(u.from, u.length, f, d, 0)), f += d, c = u.to + 1;
    }
  }
  replace(t, e, i) {
    let s = this.length - e;
  ...
  updateHeight(t, e = 0, i = !1, s) {
    ...
    if (s && s.from <= e + this.length && s.more) {
      ...
      for (s.from > e && o.push(new nt(s.from - e - 1).updateHeight(t, e)); l <= r && s.more; ) {
        ...
        h == -1 ? h = f : Math.abs(f - h) >= Gi && (h = -2);
        let u = new yt(c, f);
        u.outdated = !1, o.push(u), l += c + 1;
      }
      l <= r && o.push(null, new nt(r - l).updateHeight(t, l));
      let a = dt.of(o);
      return (h < 0 || Math.abs(a.height - this.height) >= Gi || Math.abs(h - this.heightMetrics(t, e).perLine) >= Gi) && (t.heightChanged = !0), a;
    } else
...
class Gf extends dt {
  ...
  lineAt(t, e, i, s, r) {
    let o = s + this.left.height, l = r + this.left.length + this.break, h = e == F.ByHeight ? t < o : t < l, a = h ? this.left.lineAt(t, e, i, s, r) : this.right.lineAt(t, e, i, o, l);
  ...
  forEachLine(t, e, i, s, r, o) {
    ...
    if (this.break)
      ...
      let a = this.lineAt(h, F.ByPos, i, s, r);
...
class Xn {
  ...
  span(t, e) {
    if (this.lineStart > -1) {
      ...
      s instanceof yt ? s.length += i - this.pos : (i > this.pos || !this.isCovered) && this.nodes.push(new yt(i - this.pos, -1)), this.writtenTo = i, e > i && (this.nodes.push(null), this.writtenTo++, this.lineStart = -1);
    }
    this.pos = e;
  }
  point(t, e, i) {
    if (t < e || i.heightRelevant) {
      ...
      let o = e - t;
      i.block ? this.addBlock(new Zl(o, s, i)) : (o || r || s >= Uf) && this.addLineDeco(s, r, o);
    } else
      e > t && this.span(t, e);
  ...
  enterLine() {
    ...
    this.lineStart = t, this.lineEnd = e, this.writtenTo < t && ((this.writtenTo < t - 1 || this.nodes[this.nodes.length - 1] == null) && this.nodes.push(this.blankContent(this.writtenTo, t - 1)), this.nodes.push(null)), this.pos > t && this.nodes.push(new yt(this.pos - t, -1)), this.writtenTo = this.pos;
  }
  blankContent(t, e) {
    let i = new nt(e - t);
  ...
  addBlock(t) {
    ...
    i == Y.WidgetAfter && !this.isCovered && this.ensureLine(), this.nodes.push(t), this.writtenTo = this.pos = this.pos + t.length, i != Y.WidgetBefore && (this.covering = t);
  }
  addLineDeco(t, e, i) {
  ...
  finish(t) {
    ...
    this.lineStart > -1 && !(e instanceof yt) && !this.isCovered ? this.nodes.push(new yt(0, -1)) : (this.writtenTo < this.pos || e == null) && this.nodes.push(this.blankContent(this.writtenTo, this.pos));
    let i = t;
...
class Jf {
  ...
  comparePoint(t, e, i, s) {
    (t < e || i && i.heightRelevant || s && s.heightRelevant) && kn(t, e, this.changes, 5);
  }
}
function Yf(n, t) {
...
class Fs {
  ...
  draw(t) {
    return E.replace({ widget: new Zf(this.size, t) }).range(this.from, this.to);
  }
}
class Zf extends Le {
  constructor(t, e) {
...
class Xr {
  constructor(t) {
    this.state = t, this.pixelViewport = { left: 0, right: window.innerWidth, top: 0, bottom: 0 }, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scrollTop = 0, this.scrolledToBottom = !0, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = Zr, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = J.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
    let e = t.facet(Jn).some((i) => typeof i != "function" && i.class == "cm-lineWrapping");
    this.heightOracle = new Kf(e), this.stateDeco = t.facet(mi).filter((i) => typeof i != "function"), this.heightMap = dt.empty().applyChanges(this.stateDeco, L.empty, this.heightOracle.setDoc(t.doc), [new Ct(0, 0, 0, t.doc.length)]), this.viewport = this.getViewport(0, null), this.updateViewportLines(), this.updateForViewport(), this.lineGaps = this.ensureLineGaps([]), this.lineGapDeco = E.set(this.lineGaps.map((i) => i.draw(!1))), this.computeVisibleRanges();
  }
  updateForViewport() {
    ...
    this.viewports = t.sort((i, s) => i.from - s.from), this.scaler = this.heightMap.height <= 7e6 ? Zr : new iu(this.heightOracle, this.heightMap, this.viewports);
  }
  updateViewportLines() {
    this.viewportLines = [], this.heightMap.forEachLine(this.viewport.from, this.viewport.to, this.heightOracle.setDoc(this.state.doc), 0, 0, (t) => {
      this.viewportLines.push(this.scaler.scale == 1 ? t : li(t, this.scaler));
    });
  }
  update(t, e = null) {
    this.state = t.state;
    ...
    let s = t.changedRanges, r = Ct.extendWithRanges(s, Qf(i, this.stateDeco, t ? t.changes : Z.empty(this.state.doc.length))), o = this.heightMap.height, l = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollTop);
  ...
  measure(t) {
    ...
    let a = 0, c = 0, f = parseInt(i.paddingTop) || 0, u = parseInt(i.paddingBottom) || 0;
    (this.paddingTop != f || this.paddingBottom != u) && (this.paddingTop = f, this.paddingBottom = u, a |= 10), this.editorWidth != t.scrollDOM.clientWidth && (s.lineWrapping && (h = !0), this.editorWidth = t.scrollDOM.clientWidth, a |= 8), this.scrollTop != t.scrollDOM.scrollTop && (this.scrollAnchorHeight = -1, this.scrollTop = t.scrollDOM.scrollTop), this.scrolledToBottom = wl(t.scrollDOM);
    let d = (this.printing ? Xf : Yf)(e, this.paddingTop), p = d.top - this.pixelViewport.top, w = d.bottom - this.pixelViewport.bottom;
    ...
    if (g != this.inView && (this.inView = g, g && (h = !0)), !this.inView && !this.scrollTarget)
      return 0;
    let y = l.width;
    if ((this.contentDOMWidth != y || this.editorHeight != t.scrollDOM.clientHeight) && (this.contentDOMWidth = l.width, this.editorHeight = t.scrollDOM.clientHeight, a |= 8), h) {
      ...
      if (s.mustRefreshForHeights(O) && (o = !0), o || s.lineWrapping && Math.abs(y - this.contentDOMWidth) > s.charWidth) {
        let { lineHeight: x, charWidth: M, textHeight: C } = t.docView.measureTextSize();
        o = x > 0 && s.refresh(r, x, M, C, y / M, O), o && (t.docView.minWidth = 0, a |= 8);
      }
      p > 0 && w > 0 ? c = Math.max(p, w) : p < 0 && w < 0 && (c = Math.min(p, w)), s.heightChanged = !1;
      for (let x of this.viewports) {
        let M = x.from == this.viewport.from ? O : t.docView.measureVisibleLineHeights(x);
        this.heightMap = (o ? dt.empty().applyChanges(this.stateDeco, L.empty, this.heightOracle, [new Ct(0, 0, 0, t.state.doc.length)]) : this.heightMap).updateHeight(s, 0, o, new qf(x.from, M));
      }
      s.heightChanged && (a |= 2);
    }
  ...
  getViewport(t, e) {
    let i = 0.5 - Math.max(-0.5, Math.min(0.5, t / 1e3 / 2)), s = this.heightMap, r = this.heightOracle, { visibleTop: o, visibleBottom: l } = this, h = new Ti(s.lineAt(o - i * 1e3, F.ByHeight, r, 0, 0).from, s.lineAt(l + (1 - i) * 1e3, F.ByHeight, r, 0, 0).to);
    if (e) {
      let { head: a } = e.range;
      if (a < h.from || a > h.to) {
        let c = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), f = s.lineAt(a, F.ByPos, r, 0, 0), u;
        e.y == "center" ? u = (f.top + f.bottom) / 2 - c / 2 : e.y == "start" || e.y == "nearest" && a < h.from ? u = f.top : u = f.bottom - c, h = new Ti(s.lineAt(u - 1e3 / 2, F.ByHeight, r, 0, 0).from, s.lineAt(u + c + 1e3 / 2, F.ByHeight, r, 0, 0).to);
      }
    }
    return h;
  }
  mapViewport(t, e) {
    ...
    return new Ti(this.heightMap.lineAt(i, F.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(s, F.ByPos, this.heightOracle, 0, 0).to);
  }
  ...
  mapLineGaps(t, e) {
    ...
    let i = [];
    for (let s of t)
      e.touchesRange(s.from, s.to) || i.push(new Fs(e.mapPos(s.from), e.mapPos(s.to), s.size));
    return i;
  }
  ...
  ensureLineGaps(t, e) {
    ...
    let l = [], h = (a, c, f, u) => {
      ...
      let w = eu(t, (g) => g.from >= f.from && g.to <= f.to && Math.abs(g.from - a) < r && Math.abs(g.to - c) < r && !p.some((y) => g.from < y && g.to > y));
      if (!w) {
        if (c < f.to && e && i && e.visibleRanges.some((g) => g.from <= c && g.to >= c)) {
          let g = e.moveToLineBoundary(b.cursor(c), !1, !0).head;
          g > a && (c = g);
        }
        w = new Fs(a, c, this.gapSize(f, a, c, u));
      }
      l.push(w);
    };
    for (let a of this.viewportLines) {
      if (a.length < o)
        continue;
      let c = tu(a.from, a.to, this.stateDeco);
      if (c.total < o)
        continue;
      let f = this.scrollTarget ? this.scrollTarget.range.head : null, u, d;
      if (i) {
        let p = s / this.heightOracle.lineLength * this.heightOracle.lineHeight, w, g;
        if (f != null) {
          let y = Bi(c, f), S = ((this.visibleBottom - this.visibleTop) / 2 + p) / a.height;
          w = y - S, g = y + S;
        } else
          w = (this.visibleTop - a.top - p) / a.height, g = (this.visibleBottom - a.top + p) / a.height;
        u = Pi(c, w), d = Pi(c, g);
      } else {
        let p = c.total * this.heightOracle.charWidth, w = s * this.heightOracle.charWidth, g, y;
        if (f != null) {
          let S = Bi(c, f), O = ((this.pixelViewport.right - this.pixelViewport.left) / 2 + w) / p;
          g = S - O, y = S + O;
        } else
  ...
  updateLineGaps(t) {
    Fs.same(t, this.lineGaps) || (this.lineGaps = t, this.lineGapDeco = E.set(t.map((e) => e.draw(this.heightOracle.lineWrapping))));
  }
  ...
  lineBlockAt(t) {
    return t >= this.viewport.from && t <= this.viewport.to && this.viewportLines.find((e) => e.from <= t && e.to >= t) || li(this.heightMap.lineAt(t, F.ByPos, this.heightOracle, 0, 0), this.scaler);
  }
  lineBlockAtHeight(t) {
    return li(this.heightMap.lineAt(this.scaler.fromDOM(t), F.ByHeight, this.heightOracle, 0, 0), this.scaler);
  }
  scrollAnchorAt(t) {
  ...
  elementAtHeight(t) {
    return li(this.heightMap.blockAt(this.scaler.fromDOM(t), this.heightOracle, 0, 0), this.scaler);
  }
  get docHeight() {
...
function Pi({ total: n, ranges: t }, e) {
  if (e <= 0)
    return t[0].from;
  if (e >= 1)
...
class iu {
  constructor(t, e, i) {
    ...
    this.viewports = i.map(({ from: l, to: h }) => {
      let a = e.lineAt(l, F.ByPos, t, 0, 0).top, c = e.lineAt(h, F.ByPos, t, 0, 0).bottom;
...
function li(n, t) {
  ...
  return new zt(n.from, n.length, e, i - e, Array.isArray(n._content) ? n._content.map((s) => li(s, t)) : n._content);
}
const Ri = /* @__PURE__ */ A.define({ combine: (n) => n.join(" ") }), Mn = /* @__PURE__ */ A.define({ combine: (n) => n.indexOf(!0) > -1 }), Dn = /* @__PURE__ */ ue.newName(), th = /* @__PURE__ */ ue.newName(), eh = /* @__PURE__ */ ue.newName(), ih = { "&light": "." + th, "&dark": "." + eh };
function Tn(n, t, e) {
  return new ue(t, {
    finish(i) {
...
class nu {
  constructor(t, e, i, s) {
    ...
    if (t.state.readOnly && e > -1)
      ...
      let l = r || o ? [] : ou(t), h = new xl(l, t.state);
      h.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = h.text, this.newSel = lu(l, this.bounds.from);
    } else {
      let l = t.observer.selectionRange, h = r && r.node == l.focusNode && r.offset == l.focusOffset || !pn(t.contentDOM, l.focusNode) ? t.state.selection.main.head : t.docView.posFromDOM(l.focusNode, l.focusOffset), a = o && o.node == l.anchorNode && o.offset == l.anchorOffset || !pn(t.contentDOM, l.anchorNode) ? t.state.selection.main.anchor : t.docView.posFromDOM(l.anchorNode, l.anchorOffset);
...
function sh(n, t) {
  ...
  if (t.bounds) {
    ...
    (r === 8 || v.android && t.text.length < l - o) && (h = s.to, a = "end");
    let c = ru(n.state.doc.sliceString(o, l, He), t.text, h - o, a);
    c && (v.chrome && r == 13 && c.toB == c.from + 2 && t.text.slice(c.from, c.toB) == He + He && c.toB--, e = {
      from: o + c.from,
      to: o + c.toA,
      insert: L.of(t.text.slice(c.from, c.toB).split(He))
    });
  } else
    i && (!n.hasFocus && n.state.facet(Ms) || i.main.eq(s)) && (i = null);
  if (!e && !i)
    return !1;
  ...
  } : (v.mac || v.android) && e && e.from == e.to && e.from == s.head - 1 && /^\. ?$/.test(e.insert.toString()) && n.contentDOM.getAttribute("autocorrect") == "off" ? (i && e.insert.length == 2 && (i = b.single(i.main.anchor - 1, i.main.head - 1)), e = { from: s.from, to: s.to, insert: L.of([" "]) }) : v.chrome && e && e.from == e.to && e.from == s.head && e.insert.toString() == `
 ` && n.lineWrapping && (i && (i = b.single(i.main.anchor - 1, i.main.head - 1)), e = { from: s.from, to: s.to, insert: L.of([" "]) }), e) {
    let o = n.state;
    if (v.ios && n.inputState.flushIOSKey(n) || v.android && (e.from == s.from && e.to == s.to && e.insert.length == 1 && e.insert.lines == 2 && ze(n.contentDOM, "Enter", 13) || (e.from == s.from - 1 && e.to == s.to && e.insert.length == 0 || r == 8 && e.insert.length < e.to - e.from) && ze(n.contentDOM, "Backspace", 8) || e.from == s.from && e.to == s.to + 1 && e.insert.length == 0 && ze(n.contentDOM, "Delete", 46)))
      return !0;
    let l = e.insert.toString();
    if (n.state.facet(Rl).some((c) => c(n, e.from, e.to, l)))
      return !0;
    n.inputState.composing >= 0 && n.inputState.composing++;
    let h;
    if (e.from >= s.from && e.to <= s.to && e.to - e.from >= (s.to - s.from) / 3 && (!i || i.main.empty && i.main.from == e.from + e.insert.length) && n.inputState.composing < 0) {
      let c = s.from < e.from ? o.sliceDoc(s.from, e.from) : "", f = s.to > e.to ? o.sliceDoc(e.to, s.to) : "";
      h = o.replaceSelection(n.state.toText(c + e.insert.sliceString(0, void 0, n.state.lineBreak) + f));
    } else {
      let c = o.changes(e), f = i && i.main.to <= c.newLength ? i.main : void 0;
      if (o.selection.ranges.length > 1 && n.inputState.composing >= 0 && e.to <= s.to && e.to >= s.to - 10) {
        let u = n.state.sliceDoc(e.from, e.to), d = Fl(n) || n.state.doc.lineAt(s.head), p = s.to - e.to, w = s.to - s.from;
        h = o.changeByRange((g) => {
          if (g.from == s.from && g.to == s.to)
            return { changes: c, range: f || g.map(c) };
          let y = g.to - p, S = y - u.length;
          if (g.to - g.from != w || n.state.sliceDoc(S, y) != u || // Unfortunately, there's no way to make multiple
          // changes in the same node work without aborting
          // composition, so cursors in the composition range are
          // ignored.
          d && g.to >= d.from && g.from <= d.to)
            return { range: g };
          let O = o.changes({ from: S, to: y, insert: e.insert }), x = g.to - s.to;
          return {
            changes: O,
            range: f ? b.range(Math.max(0, f.anchor + x), Math.max(0, f.head + x)) : g.map(O)
          };
        });
      } else
        h = {
    ...
    let a = "input.type";
    return (n.composing || n.inputState.compositionPendingChange && n.inputState.compositionEndedAt > Date.now() - 50) && (n.inputState.compositionPendingChange = !1, a += ".compose", n.inputState.compositionFirstChange && (a += ".start", n.inputState.compositionFirstChange = !1)), n.dispatch(h, { scrollIntoView: !0, userEvent: a }), !0;
...
function ou(n) {
  ...
  return e && (t.push(new Dr(e, i)), (s != e || r != i) && t.push(new Dr(s, r))), t;
}
function lu(n, t) {
  if (n.length == 0)
    return null;
...
class au {
  constructor(t) {
    this.view = t, this.active = !1, this.selectionRange = new Xc(), this.selectionChanged = !1, this.delayedFlush = -1, this.resizeTimeout = -1, this.queue = [], this.delayedAndroidKey = null, this.flushingAndroidKey = -1, this.lastChange = 0, this.scrollTargets = [], this.intersection = null, this.resizeScroll = null, this.resizeContent = null, this.intersecting = !1, this.gapIntersection = null, this.gaps = [], this.parentCheck = -1, this.dom = t.contentDOM, this.observer = new MutationObserver((e) => {
      for (let i of e)
        this.queue.push(i);
      (v.ie && v.ie_version <= 11 || v.ios && t.composing) && e.some((i) => i.type == "childList" && i.removedNodes.length || i.type == "characterData" && i.oldValue.length > i.target.nodeValue.length) ? this.flushSoon() : this.flush();
  ...
  onSelectionChange(t) {
    ...
    if (i.state.facet(Ms) ? i.root.activeElement != this.dom : !Ki(i.dom, s))
      return;
    ...
    s.focusNode && ns(s.focusNode, s.focusOffset, s.anchorNode, s.anchorOffset) ? this.flushSoon() : this.flush(!1);
  }
  readSelectionRange() {
    let { view: t } = this, e = v.safari && t.root.nodeType == 11 && Uc(this.dom.ownerDocument) == this.dom && cu(this.view) || ss(t.root);
  ...
  start() {
    this.active || (this.observer.observe(this.dom, hu), zs && this.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.active = !0);
  }
  stop() {
  ...
  delayAndroidKey(t, e) {
    ...
    if (!this.delayedAndroidKey) {
      let s = () => {
        ...
        r && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = r.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && r.force && ze(this.dom, r.key, r.keyCode));
      };
  ...
  readChange() {
    let { from: t, to: e, typeOver: i } = this.processRecords(), s = this.selectionChanged && Ki(this.dom, this.selectionRange);
    return t < 0 && !s ? null : (t > -1 && (this.lastChange = Date.now()), this.view.inputState.lastFocusTime = 0, this.selectionChanged = !1, new nu(this.view, t, e, i));
  }
  ...
  readMutation(t) {
    ...
    if (e.markDirty(t.type == "attributes"), t.type == "attributes" && (e.flags |= 4), t.type == "childList") {
      let i = to(e, t.previousSibling || t.target.previousSibling, -1), s = to(e, t.nextSibling || t.target.nextSibling, 1);
      return {
...
function cu(n) {
  ...
  return ns(l.node, l.offset, r, o) && ([i, s, r, o] = [r, o, i, s]), { anchorNode: i, anchorOffset: s, focusNode: r, focusOffset: o };
}
class T {
  /**
  ...
  */
  ...
  dispatch(...t) {
    let e = t.length == 1 && t[0] instanceof ht ? t[0] : this.state.update(...t);
  ...
  */
  update(t) {
    ...
    t.some((u) => u.annotation(Jl)) ? (this.inputState.notifiedFocused = o, l = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, h = Yl(r, o), h || (l = 1));
    let a = this.observer.delayedAndroidKey, c = null;
    if (a ? (this.observer.clearDelayedAndroidKey(), c = this.observer.readChange(), (c && !this.state.doc.eq(r.doc) || !this.state.selection.eq(r.selection)) && (c = null)) : this.observer.clear(), r.facet(N.phrases) != this.state.facet(N.phrases))
      return this.setState(r);
    s = ls.create(this, r, t), s.flags |= l;
    ...
    try {
      ...
      for (let u of t) {
        if (f && (f = f.map(u.changes)), u.scrollIntoView) {
          ...
          f = new os(d.empty ? d : b.cursor(d.head, d.head > d.anchor ? -1 : 1));
        }
        for (let d of u.effects)
          d.is(Er) && (f = d.value);
      }
      this.viewState.update(s, f), this.bidiCache = hs.update(this.bidiCache, s.changes), s.empty || (this.updatePlugins(s), this.inputState.update(s)), e = this.docView.update(s), this.state.facet(oi) != this.styleModules && this.mountStyles(), i = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(e, t.some((u) => u.isUserEvent("select.pointer")));
    } finally {
      this.updateState = 0;
    }
    if (s.startState.facet(Ri) != s.state.facet(Ri) && (this.viewState.mustMeasureContent = !0), (e || i || f || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), !s.empty)
      for (let u of this.state.facet(xn))
        u(s);
    (h || c) && Promise.resolve().then(() => {
      h && this.state == h.startState && this.dispatch(h), c && !sh(this, c) && a.force && ze(this.contentDOM, a.key, a.keyCode);
    });
  }
  /**
  ...
  */
  setState(t) {
    ...
    try {
      for (let i of this.plugins)
        i.destroy(this);
      this.viewState = new Xr(t), this.plugins = t.facet(ri).map((i) => new Hs(i)), this.pluginMap.clear();
      for (let i of this.plugins)
        i.update(this);
  ...
  updatePlugins(t) {
    let e = t.startState.facet(ri), i = t.state.facet(ri);
    if (e != i) {
      let s = [];
      for (let r of i) {
        let o = e.indexOf(r);
  ...
  */
  measure(t = !0) {
    ...
    let e = null, i = this.scrollDOM, { scrollTop: s } = i, { scrollAnchorPos: r, scrollAnchorHeight: o } = this.viewState;
      ...
      for (let l = 0; ; l++) {
        ...
        let c = a.map((d) => {
          try {
            ...
            return Zt(this.state, p), eo;
          }
        }), f = ls.create(this, this.state, []), u = !1;
    ...
    if (e && !e.empty)
      for (let l of this.state.facet(xn))
        l(e);
  }
  /**
  ...
  */
  get themeClasses() {
    return Dn + " " + (this.state.facet(Mn) ? eh : th) + " " + this.state.facet(Ri);
  }
  updateAttrs() {
    let t = io(this, Nl, {
    ...
    this.state.readOnly && (e["aria-readonly"] = "true"), io(this, Jn, e);
    let i = this.observer.ignore(() => {
      let s = bn(this.contentDOM, this.contentAttrs, e), r = bn(this.dom, this.editorAttrs, t);
      return s || r;
    });
  ...
  mountStyles() {
    this.styleModules = this.state.facet(oi), ue.mount(this.root, this.styleModules.concat(su).reverse());
  }
  readMeasured() {
  ...
  */
  moveByGroup(t, e) {
    return $s(this, t, Fr(this, t, e, (i) => Tf(this, t.head, i)));
  }
  /**
  ...
  */
  ...
  posAtCoords(t, e = !0) {
    return this.readMeasured(), Wl(this, t, e);
  }
  /**
  ...
  */
  coordsAtPos(t, e = 1) {
    ...
    if (!i || i.left == i.right)
      return i;
    let s = this.state.doc.lineAt(t), r = this.bidiSpans(s), o = r[We.find(r, t - s.from, -1, e)];
    return Gn(i, o.dir == J.LTR == e > 0);
  }
  /**
  ...
  */
  bidiSpans(t) {
    ...
    for (let s of this.bidiCache)
      if (s.from == t.from && s.dir == e)
        return s.order;
    let i = pf(t.text, e);
    return this.bidiCache.push(new hs(t.from, t.to, e, i)), i;
  }
  /**
  ...
  */
  get hasFocus() {
    var t;
    return (this.dom.ownerDocument.hasFocus() || v.safari && ((t = this.inputState) === null || t === void 0 ? void 0 : t.lastContextMenu) > Date.now() - 3e4) && this.root.activeElement == this.contentDOM;
  }
  /**
  ...
  */
  static scrollIntoView(t, e = {}) {
    return Er.of(new os(typeof t == "number" ? b.cursor(t) : t, e.y, e.x, e.yMargin, e.xMargin));
  }
  /**
  ...
  */
  static theme(t, e) {
    let i = ue.newName(), s = [Ri.of(i), oi.of(Tn(`.${i}`, t))];
    return e && e.dark && s.push(Mn.of(!0)), s;
  }
  /**
  ...
  */
  static baseTheme(t) {
    return Kn.lowest(oi.of(Tn("." + Dn, t, ih)));
  }
  /**
...
T.styleModule = oi;
T.inputHandler = Rl;
T.focusChangeEffect = Ll;
T.perLineTextDirection = El;
T.exceptionSink = Bl;
T.updateListener = xn;
T.editable = Ms;
T.mouseSelectionStyle = Pl;
T.dragMovesSelection = Tl;
T.clickAddsSelectionRange = Dl;
T.decorations = mi;
T.atomicRanges = Yn;
T.scrollMargins = Il;
T.darkTheme = Mn;
T.contentAttributes = Jn;
T.editorAttributes = Nl;
...
class hs {
  ...
  static update(t, e) {
    ...
    for (let r = Math.max(0, t.length - 10); r < t.length; r++) {
      let o = t[r];
      o.dir == s && !e.touchesRange(o.from, o.to) && i.push(new hs(e.mapPos(o.from, 1), e.mapPos(o.to, -1), o.dir, o.order));
    }
    return i;
  }
}
...
const uu = v.mac ? "mac" : v.windows ? "win" : v.linux ? "linux" : "key";
function du(n, t) {
  const e = n.split(/-(?!$)/);
  let i = e[e.length - 1];
  i == "Space" && (i = " ");
...
const pu = /* @__PURE__ */ Kn.default(/* @__PURE__ */ T.domEventHandlers({
  keydown(n, t) {
    return yu(gu(t.state), n, t, "editor");
  }
})), nh = /* @__PURE__ */ A.define({ enables: pu }), so = /* @__PURE__ */ new WeakMap();
function gu(n) {
  let t = n.facet(nh), e = so.get(t);
  return e || so.set(t, e = wu(t.reduce((i, s) => i.concat(s), []))), e;
}
let le = null;
const mu = 4e3;
function wu(n, t = uu) {
  let e = /* @__PURE__ */ Object.create(null), i = /* @__PURE__ */ Object.create(null), s = (o, l) => {
    ...
    for (let y = 1; y < p.length; y++) {
      ...
      s(S, !0), d[S] || (d[S] = {
        ...
        stopPropagation: !1,
        run: [(O) => {
          let x = le = { view: O, prefix: S, scope: o };
          return setTimeout(() => {
            le == x && (le = null);
          }, mu), !0;
        }]
...
function yu(n, t, e, i) {
  let s = Gc(t), r = ai(s, 0), o = tn(r) == s.length && s != " ", l = "", h = !1, a = !1, c = !1;
  le && le.view == e && le.scope == i && (l = le.prefix + " ", Kl.indexOf(t.keyCode) < 0 && (a = !0, le = null));
  ...
  return d && (u(d[l + Li(s, t, !o)]) ? h = !0 : o && (t.altKey || t.metaKey || t.ctrlKey) && // Ctrl-Alt may be used for AltGr on Windows
  !(v.windows && t.ctrlKey && t.altKey) && (p = de[t.keyCode]) && p != s ? (u(d[l + Li(p, t, !0)]) || t.shiftKey && (w = pi[t.keyCode]) != s && w != p && u(d[l + Li(w, t, !1)])) && (h = !0) : o && t.shiftKey && u(d[l + Li(s, t, !0)]) && (h = !0), !h && u(d._any) && (h = !0)), a && (h = !0), h && c && t.stopPropagation(), h;
}
const bu = !v.ios, ku = {
  ".cm-line": {
...
bu && (ku[".cm-line"].caretColor = "transparent !important");
...
class vu {
  ...
  */
  createDeco(t) {
    ...
    for (let { from: s, to: r } of xu(t, this.maxLength))
      no(t.state.doc, this.regexp, s, r, (o, l) => this.addMatch(l, t, o, i));
    return e.finish();
  }
  /**
...
const Pn = /x/.unicode != null ? "gu" : "g", Su = /* @__PURE__ */ new RegExp(`[\0-\b
--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩\uFEFF￹-￼]`, Pn), Cu = {
  0: "null",
  7: "bell",
  8: "backspace",
...
const Ui = /* @__PURE__ */ A.define({
  combine(n) {
    ...
    return (t.replaceTabs = !Au()) && (t.specialChars = new RegExp("	|" + t.specialChars.source, Pn)), t.addSpecialChars && (t.specialChars = new RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, Pn)), t;
  }
});
function Ou(n = {}) {
  return [Ui.of(n), Mu()];
...
let ro = null;
function Mu() {
  return ro || (ro = vt.fromClass(class {
    constructor(n) {
      this.view = n, this.decorations = E.none, this.decorationCache = /* @__PURE__ */ Object.create(null), this.decorator = this.makeDecorator(n.state.facet(Ui)), this.decorations = this.decorator.createDeco(n);
    }
    makeDecorator(n) {
      return new vu({
        regexp: n.specialChars,
        decoration: (t, e, i) => {
          let { doc: s } = e.state, r = ai(t[0], 0);
          if (r == 9) {
            let o = s.lineAt(i), l = e.state.tabSize, h = As(o.text, l, i - o.from);
            return E.replace({ widget: new Bu((l - h % l) * this.view.defaultCharacterWidth) });
          }
          return this.decorationCache[r] || (this.decorationCache[r] = E.replace({ widget: new Pu(n, r) }));
        },
    ...
    update(n) {
      ...
      n.startState.facet(Ui) != t ? (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(n.view)) : this.decorations = this.decorator.updateDeco(n, this.decorations);
    }
  }, {
...
const Du = "•";
function Tu(n) {
  return n >= 32 ? Du : n == 10 ? "␤" : String.fromCharCode(9216 + n);
}
class Pu extends Le {
  constructor(t, e) {
  ...
  toDOM(t) {
    let e = Tu(this.code), i = t.state.phrase("Control character") + " " + (Cu[this.code] || "0x" + this.code.toString(16)), s = this.options.render && this.options.render(this.code, i, e);
    if (s)
      return s;
...
const Lu = /* @__PURE__ */ E.line({ class: "cm-activeLine" }), Eu = /* @__PURE__ */ vt.fromClass(class {
  constructor(n) {
  ...
  getDeco(n) {
    ...
    for (let i of n.state.selection.ranges) {
      ...
      s.from > t && (e.push(Lu.range(s.from)), t = s.from);
    }
    return E.set(e);
  }
}, {
...
const js = /* @__PURE__ */ A.define({
  combine: (n) => {
    var t, e, i;
    return {
      position: v.ios ? "absolute" : ((t = n.find((s) => s.position)) === null || t === void 0 ? void 0 : t.position) || "fixed",
      parent: ((e = n.find((s) => s.parent)) === null || e === void 0 ? void 0 : e.parent) || null,
      tooltipSpace: ((i = n.find((s) => s.tooltipSpace)) === null || i === void 0 ? void 0 : i.tooltipSpace) || Nu
    };
  }
}), oo = /* @__PURE__ */ new WeakMap(), Iu = /* @__PURE__ */ vt.fromClass(class {
  constructor(n) {
    this.view = n, this.inView = !0, this.lastTransaction = 0, this.measureTimeout = -1;
    let t = n.state.facet(js);
    this.position = t.position, this.parent = t.parent, this.classes = n.themeClasses, this.createContainer(), this.measureReq = { read: this.readMeasure.bind(this), write: this.writeMeasure.bind(this), key: this }, this.manager = new rh(n, oh, (e) => this.createTooltip(e)), this.intersectionObserver = typeof IntersectionObserver == "function" ? new IntersectionObserver((e) => {
  ...
  update(n) {
    ...
    let e = t || n.geometryChanged, i = n.state.facet(js);
  ...
  readMeasure() {
    ...
    return {
      ...
      space: this.view.state.facet(js).tooltipSpace(this.view)
    };
  }
  writeMeasure(n) {
    var t;
    let { editor: e, space: i } = n, s = [];
    for (let r = 0; r < this.manager.tooltips.length; r++) {
      let o = this.manager.tooltips[r], l = this.manager.tooltipViews[r], { dom: h } = l, a = n.pos[r], c = n.size[r];
      if (!a || a.bottom <= Math.max(e.top, i.top) || a.top >= Math.min(e.bottom, i.bottom) || a.right < Math.max(e.left, i.left) - 0.1 || a.left > Math.min(e.right, i.right) + 0.1) {
        h.style.top = Ei;
        continue;
      }
      let f = o.arrow ? l.dom.querySelector(".cm-tooltip-arrow") : null, u = f ? 7 : 0, d = c.right - c.left, p = (t = oo.get(l)) !== null && t !== void 0 ? t : c.bottom - c.top, w = l.offset || Hu, g = this.view.textDirection == J.LTR, y = c.width > i.right - i.left ? g ? i.left : i.right - c.width : g ? Math.min(a.left - (f ? 14 : 0) + w.x, i.right - d) : Math.max(i.left, a.left - d + (f ? 14 : 0) - w.x), S = !!o.above;
      !o.strictSide && (S ? a.top - (c.bottom - c.top) - w.y < i.top : a.bottom + (c.bottom - c.top) + w.y > i.bottom) && S == i.bottom - a.bottom > a.top - i.top && (S = !S);
      let O = (S ? a.top - i.top : i.bottom - a.bottom) - u;
      if (O < p && l.resize !== !1) {
        if (O < this.view.defaultLineHeight) {
          h.style.top = Ei;
          continue;
        }
        oo.set(l, p), h.style.height = (p = O) + "px";
      } else
        h.style.height && (h.style.height = "");
      let x = S ? a.top - p - u - w.y : a.bottom + u + w.y, M = y + d;
      if (l.overlap !== !0)
        for (let C of s)
          C.left < M && C.right > y && C.top < x + p && C.bottom > x && (x = S ? C.top - p - 2 - u : C.bottom + u + 2);
      this.position == "absolute" ? (h.style.top = x - n.parent.top + "px", h.style.left = y - n.parent.left + "px") : (h.style.top = x + "px", h.style.left = y + "px"), f && (f.style.left = `${a.left + (g ? w.x : -w.x) - (y + 14 - 7)}px`), l.overlap !== !0 && s.push({ left: y, top: x, right: M, bottom: x + p }), h.classList.toggle("cm-tooltip-above", S), h.classList.toggle("cm-tooltip-below", !S), l.positioned && l.positioned(n.space);
    }
  }
  maybeMeasure() {
...
}), Hu = { x: 0, y: 0 }, oh = /* @__PURE__ */ A.define({
  enables: [Iu, Vu]
}), as = /* @__PURE__ */ A.define();
class Zn {
  constructor(t) {
    this.view = t, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new rh(t, as, (e) => this.createHostedView(e));
  }
...
const _u = /* @__PURE__ */ oh.compute([as], (n) => {
  let t = n.facet(as).filter((e) => e);
...
class $u {
  ...
  startHover() {
    ...
    if (i == null || t.y < i.top || t.y > i.bottom || t.x < i.left - this.view.defaultCharacterWidth || t.x > i.right + this.view.defaultCharacterWidth)
      return;
    let s = this.view.bidiSpans(this.view.state.doc.lineAt(e)).find((l) => l.from <= e && l.to >= e), r = s && s.dir == J.RTL ? -1 : 1, o = this.source(this.view, e, t.x < i.left ? -r : r);
    if (o != null && o.then) {
  ...
  mousemove(t) {
    ...
    let i = this.active;
    if (i && !lo(this.lastMove.target) || this.pending) {
      let { pos: s } = i || this.pending, r = (e = i == null ? void 0 : i.end) !== null && e !== void 0 ? e : s;
      (s == r ? this.view.posAtCoords(this.lastMove) != s : !Fu(
        this.view,
        s,
        r,
        t.clientX,
  ...
  mouseleave(t) {
    clearTimeout(this.hoverTimeout), this.hoverTimeout = -1, this.active && !lo(t.relatedTarget) && this.view.dispatch({ effects: this.setHover.of(null) });
  }
  destroy() {
  ...
  let e = _.define(), i = Et.define({
    ...
    update(s, r) {
      if (s && (t.hideOnChange && (r.docChanged || r.selection) || t.hideOn && t.hideOn(r, s)))
        return null;
      if (s && r.docChanged) {
        let o = r.changes.mapPos(s.pos, -1, gt.TrackDel);
        if (o == null)
          return null;
      ...
      for (let o of r.effects)
        o.is(e) && (s = o.value), o.is(Wu) && (s = null);
      return s;
    },
    provide: (s) => as.from(s)
  });
...
const Wu = /* @__PURE__ */ _.define(), ho = /* @__PURE__ */ A.define({
  combine(n) {
    let t, e;
    for (let i of n)
...
function ju(n, t) {
  let e = n.plugin(lh), i = e ? e.specs.indexOf(t) : -1;
  return i > -1 ? e.panels[i] : null;
}
const lh = /* @__PURE__ */ vt.fromClass(class {
  constructor(n) {
    this.input = n.state.facet(Bn), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((e) => e(n));
    let t = n.state.facet(ho);
    this.top = new Ni(n, !0, t.topContainer), this.bottom = new Ni(n, !1, t.bottomContainer), this.top.sync(this.panels.filter((e) => e.top)), this.bottom.sync(this.panels.filter((e) => !e.top));
    for (let e of this.panels)
      e.dom.classList.add("cm-panel"), e.mount && e.mount();
  }
  update(n) {
    let t = n.state.facet(ho);
    this.top.container != t.topContainer && (this.top.sync([]), this.top = new Ni(n.view, !0, t.topContainer)), this.bottom.container != t.bottomContainer && (this.bottom.sync([]), this.bottom = new Ni(n.view, !1, t.bottomContainer)), this.top.syncClasses(), this.bottom.syncClasses();
...
const Qi = /* @__PURE__ */ A.define(), Ku = {
  ...
  updateSpacer: null,
  domEventHandlers: {}
}, Ji = /* @__PURE__ */ A.define();
function qu(n) {
  return [Gu(), Ji.of(Object.assign(Object.assign({}, Ku), n))];
}
const Rn = /* @__PURE__ */ A.define({
  combine: (n) => n.some((t) => t)
});
function Gu(n) {
  let t = [
  ...
  return n && n.fixed === !1 && t.push(Rn.of(!0)), t;
}
const Uu = /* @__PURE__ */ vt.fromClass(class {
  constructor(n) {
    this.view = n, this.prevViewport = n.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight + "px", this.gutters = n.state.facet(Ji).map((t) => new fo(n, t));
    for (let t of this.gutters)
      this.dom.appendChild(t.dom);
    this.fixed = !n.state.facet(Rn), this.fixed && (this.dom.style.position = "sticky"), this.syncGutters(!1), n.scrollDOM.insertBefore(this.dom, n.contentDOM);
  }
  update(n) {
    ...
    n.geometryChanged && (this.dom.style.minHeight = this.view.contentHeight + "px"), this.view.state.facet(Rn) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : ""), this.prevViewport = n.view.viewport;
  }
  syncGutters(n) {
    let t = this.dom.nextSibling;
    n && this.dom.remove();
    let e = H.iter(this.view.state.facet(Qi), this.view.viewport.from), i = [], s = this.gutters.map((r) => new Qu(r, this.view.viewport, -this.view.documentPadding.top));
  ...
  updateGutters(n) {
    let t = n.startState.facet(Ji), e = n.state.facet(Ji), i = n.docChanged || n.heightChanged || n.viewportChanged || !H.eq(n.startState.facet(Qi), n.state.facet(Qi), n.view.viewport.from, n.view.viewport.to);
    if (t == e)
      ...
      for (let r of e) {
        let o = t.indexOf(r);
        o < 0 ? s.push(new fo(this.view, r)) : (this.gutters[o].update(n), s.push(this.gutters[o]));
      }
...
class Qu {
  ...
  line(t, e, i) {
    let s = [];
    Ln(this.cursor, s, e.from), i.length && (s = s.concat(i));
...
class fo {
  constructor(t, e) {
    ...
    this.markers = co(e.markers(t)), e.initialSpacer && (this.spacer = new hh(t, 0, 0, [e.initialSpacer(t)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
  }
  update(t) {
    let e = this.markers;
    if (this.markers = co(this.config.markers(t.view)), this.spacer && this.config.updateSpacer) {
...
class hh {
  ...
  update(t, e, i, s) {
    this.height != e && (this.dom.style.height = (this.height = e) + "px"), this.above != i && (this.dom.style.marginTop = (this.above = i) ? i + "px" : ""), Ju(this.markers, s) || this.setMarkers(t, s);
  }
  setMarkers(t, e) {
...
const Yu = /* @__PURE__ */ new class extends me {
  constructor() {
    super(...arguments), this.elementClass = "cm-activeLineGutter";
  }
}(), Xu = /* @__PURE__ */ Qi.compute(["selection"], (n) => {
  let t = [], e = -1;
...
class P {
  ...
  constructor(t = {}) {
    this.id = td++, this.perNode = !!t.perNode, this.deserialize = t.deserialize || (() => {
  ...
  add(t) {
    ...
    return typeof t != "function" && (t = wt.match(t)), (e) => {
      let i = t(e);
...
class wt {
  ...
  /// Define a node type.
  static define(t) {
    let e = t.props && t.props.length ? /* @__PURE__ */ Object.create(null) : ed, i = (t.top ? 1 : 0) | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), s = new wt(t.name || "", e, t.id, i);
    if (t.props) {
...
class tr {
  ...
  extend(...t) {
    ...
    for (let i of this.types) {
      ...
      e.push(s ? new wt(i.name, s, i.id, i.flags) : i);
    }
    return new tr(e);
  }
}
const Ii = /* @__PURE__ */ new WeakMap(), uo = /* @__PURE__ */ new WeakMap();
var tt;
(function(n) {
...
class Q {
  ...
  cursor(t = 0) {
    return new us(this.topNode, t);
  }
  /// Get a [tree cursor](#common.TreeCursor) pointing into this tree
  /// at the given position and side (see
  /// [`moveTo`](#common.TreeCursor.moveTo).
  cursorAt(t, e = 0, i = 0) {
    let s = Ii.get(this) || this.topNode, r = new us(s);
    return r.moveTo(t, e), Ii.set(this, r._tree), r;
  }
  ...
  resolve(t, e = 0) {
    let i = Qe(Ii.get(this) || this.topNode, t, e, !1);
  ...
  /// the host trees).
  resolveInner(t, e = 0) {
    let i = Qe(uo.get(this) || this.topNode, t, e, !0);
  ...
  iterate(t) {
    let { enter: e, leave: i, from: s = 0, to: r = this.length } = t, o = t.mode || 0, l = (o & tt.IncludeAnonymous) > 0;
    for (let h = this.cursor(o | tt.IncludeAnonymous); ; ) {
      let a = !1;
  ...
  balance(t = {}) {
    return this.children.length <= 8 ? this : sr(wt.none, this.children, this.positions, 0, this.children.length, 0, this.length, (e, i, s) => new Q(this.type, e, i, s, this.propValues), t.makeTree || ((e, i, s) => new Q(wt.none, e, i, s)));
  }
...
class er {
  ...
  fork() {
    return new er(this.buffer, this.index);
  }
}
class Ee {
  ...
  findChild(t, e, i, s, r) {
    ...
    for (let h = t; h != e && !(ch(r, s, o[h + 1], o[h + 2]) && (l = h, i > 0)); h = o[h + 3])
      ;
    return l;
  }
  /// @internal
...
function Qe(n, t, e, i) {
  ...
  let r = i ? 0 : tt.IgnoreOverlays;
  if (i)
    for (let o = n, l = o.parent; l; o = l, l = o.parent)
      o instanceof te && o.index < 0 && ((s = l.enter(t, e, r)) === null || s === void 0 ? void 0 : s.from) != o.from && (n = l);
  for (; ; ) {
    let o = n.enter(t, e, r);
    if (!o)
      return n;
...
class te {
  ...
  nextChild(t, e, i, s, r = 0) {
    for (let o = this; ; ) {
      for (let { children: l, positions: h } = o._tree, a = e > 0 ? l.length : -1; t != a; t += e) {
        ...
        if (ch(s, i, f, f + c.length)) {
          if (c instanceof Ee) {
            if (r & tt.ExcludeBuffers)
              continue;
            let u = c.findChild(0, c.buffer.length, e, i - f, s);
            if (u > -1)
              return new ae(new id(o, c, t, f), null, u);
          } else if (r & tt.IncludeAnonymous || !c.type.isAnonymous || ir(c)) {
            let u;
            if (!(r & tt.IgnoreMounts) && c.props && (u = c.prop(P.mounted)) && !u.overlay)
              return new te(u.tree, f, t, o);
            let d = new te(c, f, t, o);
            return r & tt.IncludeAnonymous || !d.type.isAnonymous ? d : d.nextChild(e < 0 ? c.children.length - 1 : 0, e, i, s);
          }
        }
      }
      if (r & tt.IncludeAnonymous || !o.type.isAnonymous || (o.index >= 0 ? t = o.index + e : t = e < 0 ? -1 : o._parent._tree.children.length, o = o._parent, !o))
        return null;
    }
  }
  get firstChild() {
  ...
  enter(t, e, i = 0) {
    let s;
    if (!(i & tt.IgnoreOverlays) && (s = this._tree.prop(P.mounted)) && s.overlay) {
      let r = t - this.from;
  ...
  resolve(t, e = 0) {
    return Qe(this, t, e, !1);
  }
  resolveInner(t, e = 0) {
    return Qe(this, t, e, !0);
  }
...
class ae {
  ...
  get nextSibling() {
    ...
    return e < (this._parent ? t.buffer[this._parent.index + 3] : t.buffer.length) ? new ae(this.context, this._parent, e) : this.externalSibling(1);
  }
  get prevSibling() {
    let { buffer: t } = this.context, e = this._parent ? this._parent.index + 4 : 0;
    return this.index == e ? this.externalSibling(-1) : new ae(this.context, this._parent, t.findChild(
      e,
      this.index,
      -1,
      0,
...
class us {
  ...
  /// @internal
  constructor(t, e = 0) {
    if (this.mode = e, this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, t instanceof te)
      this.yieldNode(t);
    else {
  ...
  yield(t) {
    return t ? t instanceof te ? (this.buffer = null, this.yieldNode(t)) : (this.buffer = t.context, this.yieldBuf(t.index, t.type)) : !1;
  }
  /// @internal
  toString() {
  ...
  enter(t, e, i = this.mode) {
    return this.buffer ? i & tt.ExcludeBuffers ? !1 : this.enterChild(1, t, e) : this.yield(this._tree.enter(t, e, i));
  }
  ...
  parent() {
    ...
    let t = this.mode & tt.IncludeAnonymous ? this.buffer.parent : this.buffer.parent.nextSignificantParent();
    ...
    for (; i; { index: e, _parent: i } = i)
      if (e > -1)
        for (let r = e + t, o = t < 0 ? -1 : i._tree.children.length; r != o; r += t) {
          ...
          if (this.mode & tt.IncludeAnonymous || l instanceof Ee || !l.type.isAnonymous || ir(l))
            return !1;
        }
    return !0;
  }
  ...
  get node() {
    ...
    for (let s = i; s < this.stack.length; s++)
      e = new ae(this.buffer, e, this.stack[s]);
...
function ir(n) {
  return n.children.some((t) => t instanceof Ee || !t.type.isAnonymous || ir(t));
}
function sd(n) {
  var t;
  let { buffer: e, nodeSet: i, maxBufferLength: s = ah, reused: r = [], minRepeatType: o = i.types.length } = n, l = Array.isArray(e) ? new er(e, e.length) : e, h = i.types, a = 0, c = 0;
  function f(x, M, C, I, st) {
    let { id: V, start: R, end: K, size: pt } = l, Dt = c;
    for (; pt < 0; )
      if (l.next(), pt == -1) {
        let ne = r[V];
        C.push(ne), I.push(R - x);
        return;
      } else if (pt == -3) {
        a = V;
        return;
    ...
    let Ne = h[V], se, Gt, fr = R - x;
    if (K - R <= s && (Gt = w(l.pos - M, st))) {
      let ne = new Uint16Array(Gt.size - Gt.skip), Tt = l.pos - Gt.size, Ut = ne.length;
      for (; l.pos > Tt; )
        Ut = g(Gt.start, ne, Ut);
      se = new Ee(ne, K - Gt.start, i), fr = Gt.start - x;
    } else {
      let ne = l.pos - pt;
      l.next();
      let Tt = [], Ut = [], be = V >= o ? V : -1, Ie = 0, Si = K;
      for (; l.pos > ne; )
        be >= 0 && l.id == be && l.size >= 0 ? (l.end <= Si - s && (d(Tt, Ut, R, Ie, l.end, Si, be, Dt), Ie = Tt.length, Si = l.end), l.next()) : f(R, ne, Tt, Ut, be);
      if (be >= 0 && Ie > 0 && Ie < Tt.length && d(Tt, Ut, R, Ie, R, Si, be, Dt), Tt.reverse(), Ut.reverse(), be > -1 && Ie > 0) {
        let ur = u(Ne);
        se = sr(Ne, Tt, Ut, 0, Tt.length, 0, K - R, ur, ur);
      } else
        se = p(Ne, Tt, Ut, K - R, Dt - K);
    }
    C.push(se), I.push(fr);
  }
  function u(x) {
    return (M, C, I) => {
      let st = 0, V = M.length - 1, R, K;
      if (V >= 0 && (R = M[V]) instanceof Q) {
        if (!V && R.type == x && R.length == I)
          return R;
        (K = R.prop(P.lookAhead)) && (st = C[V] + R.length + K);
      }
      return p(x, M, C, I, st);
    };
  }
  function d(x, M, C, I, st, V, R, K) {
    let pt = [], Dt = [];
    for (; x.length > I; )
      pt.push(x.pop()), Dt.push(M.pop() + C - st);
    x.push(p(i.types[R], pt, Dt, V - st, K - V)), M.push(st - C);
  }
  function p(x, M, C, I, st = 0, V) {
    if (a) {
      let R = [P.contextHash, a];
      V = V ? [R].concat(V) : [R];
    }
    if (st > 25) {
      let R = [P.lookAhead, st];
      V = V ? [R].concat(V) : [R];
    }
    return new Q(x, M, C, I, V);
  }
  function w(x, M) {
    let C = l.fork(), I = 0, st = 0, V = 0, R = C.end - s, K = { size: 0, start: 0, skip: 0 };
    t:
      for (let pt = C.pos - x; C.pos > pt; ) {
        let Dt = C.size;
        if (C.id == M && Dt >= 0) {
          K.size = I, K.start = st, K.skip = V, V += 4, I += 4, C.next();
          continue;
        }
        let Ne = C.pos - Dt;
        if (Dt < 0 || Ne < pt || C.start < R)
          break;
        let se = C.id >= o ? 4 : 0, Gt = C.start;
        for (C.next(); C.pos > Ne; ) {
          if (C.size < 0)
            if (C.size == -3)
              se += 4;
    ...
    return (M < 0 || I == x) && (K.size = I, K.start = st, K.skip = V), K.size > 4 ? K : void 0;
  }
  function g(x, M, C) {
    let { id: I, start: st, end: V, size: R } = l;
    if (l.next(), R >= 0 && I < o) {
      let K = C;
      if (R > 4) {
        let pt = l.pos - (R - 4);
  ...
  let y = [], S = [];
  for (; l.pos > 0; )
    f(n.start || 0, n.bufferStart || 0, y, S, -1);
  let O = (t = n.length) !== null && t !== void 0 ? t : y.length ? S[0] + y[0].length : 0;
  return new Q(h[n.topID], y.reverse(), S.reverse(), O);
}
const po = /* @__PURE__ */ new WeakMap();
function Yi(n, t) {
  if (!n.isAnonymous || t instanceof Ee || t.type != n)
    return 1;
  let e = po.get(t);
  if (e == null) {
    e = 1;
...
function sr(n, t, e, i, s, r, o, l, h) {
  ...
  function d(p, w, g, y, S) {
    for (let O = g; O < y; ) {
      let x = O, M = w[O], C = Yi(n, p[O]);
      for (O++; O < y; O++) {
        let I = Yi(n, p[O]);
        if (C + I >= c)
          break;
      ...
      if (O == x + 1) {
        if (C > c) {
          let I = p[x];
          d(I.children, I.positions, 0, I.children.length, w[x] + S);
          continue;
        }
        f.push(p[x]);
      } else {
        let I = w[O - 1] + p[O - 1].length - M;
        f.push(sr(n, p, w, x, O, M, I, null, h));
      }
      u.push(M + S - r);
    }
  }
...
class Oe {
  ...
  static addTree(t, e = [], i = !1) {
    let s = [new Oe(0, t.length, t, 0, !1, i)];
    for (let r of e)
...
class uh {
  ...
  startParse(t, e, i) {
    return typeof t == "string" && (t = new nd(t)), i = i ? i.length ? i.map((s) => new Ks(s.from, s.to)) : [new Ks(0, 0)] : [new Ks(0, t.length)], this.createParse(t, e || [], i);
  }
...
class $t {
  ...
  */
  constructor(t, e, i) {
    this.set = t, this.base = e, this.modified = i, this.id = rd++;
  }
  /**
  ...
  */
  static defineModifier() {
    let t = new ds();
    return (e) => e.modified.indexOf(t) > -1 ? e : ds.get(e.base || e, e.modified.concat(t).sort((i, s) => i.id - s.id));
  }
}
let od = 0;
class ds {
  constructor() {
    this.instances = [], this.id = od++;
  }
  static get(t, e) {
    if (!e.length)
      return t;
    let i = e[0].instances.find((l) => l.base == t && ld(e, l.modified));
    if (i)
      return i;
    let s = [], r = new $t(s, t, e);
    for (let l of e)
  ...
  for (let e in n) {
    ...
    for (let s of e.split(" "))
      if (s) {
        ...
        if (!a)
          throw new RangeError("Invalid path: " + s);
        let c = new ps(i, o, h > 0 ? r.slice(0, h) : null);
        t[a] = c.sort(t[a]);
      }
  }
  return ph.add(t);
...
function cd(n, t, e, i = 0, s = n.length) {
  let r = new fd(i, Array.isArray(t) ? t : [t], e);
...
class fd {
  ...
  highlightRange(t, e, i, s, r) {
    ...
    let a = s, c = ud(t) || ps.empty, f = ad(r, c.tags);
    ...
    if (u && u.overlay) {
      ...
      for (let g = 0, y = l; ; g++) {
        let S = g < u.overlay.length ? u.overlay[g] : null, O = S ? S.from + l : h, x = Math.max(e, y), M = Math.min(i, O);
        if (x < M && w)
          for (; t.from < M && (this.highlightRange(t, x, M, s, r), this.startSpan(Math.min(M, t.to), a), !(t.to >= O || !t.nextSibling())); )
            ;
        if (!S || O > i)
          break;
        y = S.to + l, y > e && (this.highlightRange(d.cursor(), Math.max(e, S.from + l), Math.min(i, y), "", p), this.startSpan(Math.min(i, y), a));
      }
      w && t.parent();
...
function ud(n) {
  let t = n.type.prop(ph);
  for (; t && t.context && !n.matchContext(t.context); )
    t = t.next;
  return t || null;
}
const k = $t.define, Vi = k(), re = k(), go = k(re), mo = k(re), oe = k(), Hi = k(oe), qs = k(oe), _t = k(), ke = k(_t), Vt = k(), Ht = k(), En = k(), ii = k(En), _i = k(), m = {
  /**
  A comment.
  */
  comment: Vi,
  ...
  */
  bitwiseOperator: k(Ht),
  /**
  Comparison [operator](#highlight.tags.operator).
  */
  compareOperator: k(Ht),
  /**
...
var Gs;
const _e = /* @__PURE__ */ new P();
function dd(n) {
  return A.define({
    combine: n ? (t) => t.concat(n) : void 0
  });
}
const pd = /* @__PURE__ */ new P();
class Bt {
  /**
  ...
  */
  constructor(t, e, i = [], s = "") {
    this.data = t, this.name = s, N.prototype.hasOwnProperty("tree") || Object.defineProperty(N.prototype, "tree", { get() {
      return St(this);
    } }), this.parser = e, this.extension = [
      we.of(this),
      N.languageData.of((r, o, l) => {
        let h = wo(r, o, l), a = h.type.prop(_e);
        if (!a)
          return [];
        let c = r.facet(a), f = h.type.prop(pd);
        if (f) {
  ...
  */
  isActiveAt(t, e, i = -1) {
    return wo(t, e, i).type.prop(_e) == this.data;
  }
  /**
  ...
  */
  findRegions(t) {
    ...
    if (!e || !e.allowsNesting)
      return [];
    let i = [], s = (r, o) => {
      if (r.prop(_e) == this.data) {
        i.push({ from: o, to: o + r.length });
        return;
      }
      let l = r.prop(P.mounted);
      if (l) {
        if (l.tree.prop(_e) == this.data) {
          if (l.overlay)
      ...
      for (let h = 0; h < r.children.length; h++) {
        let a = r.children[h];
        a instanceof Q && s(a, r.positions[h] + o);
      }
    };
    return s(St(t), 0), i;
  }
...
Bt.setState = /* @__PURE__ */ _.define();
function wo(n, t, e) {
  let i = n.facet(we), s = St(n).topNode;
  if (!i || i.allowsNesting)
    for (let r = s; r; r = r.enter(t, e, tt.ExcludeBuffers))
      r.type.isTop && (s = r);
  return s;
}
class gs extends Bt {
  ...
  */
  static define(t) {
    let e = dd(t.languageData);
    return new gs(e, t.parser.configure({
      props: [_e.add((i) => i.isTop ? e : void 0)]
    }), t.name);
  }
  /**
  ...
  */
  configure(t, e) {
    return new gs(this.data, this.parser.configure(t), e || this.name);
  }
  get allowsNesting() {
...
class ms {
  ...
  */
  static create(t, e, i) {
    return new ms(t, e, [], Q.empty, 0, i, [], null);
  }
  startParse() {
  ...
  work(t, e) {
    return e != null && e >= this.state.doc.length && (e = void 0), this.tree != Q.empty && this.isDone(e ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
      ...
      for (this.parse || (this.parse = this.startParse()), e != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > e) && e < this.state.doc.length && this.parse.stopAt(e); ; ) {
        ...
        if (s)
          if (this.fragments = this.withoutTempSkipped(Oe.addTree(s, this.fragments, this.parse.stoppedAt != null)), this.treeLen = (i = this.parse.stoppedAt) !== null && i !== void 0 ? i : this.state.doc.length, this.tree = s, this.parse = null, this.treeLen < (e ?? this.state.doc.length))
  ...
  */
  changes(t, e) {
    ...
    if (this.takeTree(), !t.empty) {
      let h = [];
      if (t.iterChangedRanges((a, c, f, u) => h.push({ fromA: a, toA: c, fromB: f, toB: u })), i = Oe.applyChanges(i, h), s = Q.empty, r = 0, o = { from: t.mapPos(o.from, -1), to: t.mapPos(o.to, 1) }, this.skipped.length) {
        l = [];
    ...
    return new ms(this.parser, e, i, s, r, o, l, this.scheduleOn);
  }
  /**
  @internal
  */
      ...
      createParse(e, i, s) {
        ...
        return {
          ...
          advance() {
            ...
            return this.parsedPos = o, new Q(wt.none, [], [], o - r);
          },
          stoppedAt: null,
          stopAt() {
          }
...
function yo(n, t, e) {
  return Oe.applyChanges(n, [{ fromA: t, toA: e, fromB: t, toB: e }]);
}
class Je {
  constructor(t) {
  ...
  apply(t) {
    ...
    return e.work(20, i) || e.takeTree(), new Je(e);
  }
  static init(t) {
    let e = Math.min(3e3, t.doc.length), i = ms.create(t.facet(we).parser, t, { from: 0, to: e });
    return i.work(20, e) || i.takeTree(), new Je(i);
  }
}
Bt.state = /* @__PURE__ */ Et.define({
  create: Je.init,
  update(n, t) {
    for (let e of t.effects)
      if (e.is(Bt.setState))
        return e.value;
    return t.startState.facet(we) != t.state.facet(we) ? Je.init(t.state) : n.apply(t);
  }
});
let mh = (n) => {
  let t = setTimeout(
...
typeof requestIdleCallback < "u" && (mh = (n) => {
...
const Us = typeof navigator < "u" && (!((Gs = navigator.scheduling) === null || Gs === void 0) && Gs.isInputPending) ? () => navigator.scheduling.isInputPending() : null, md = /* @__PURE__ */ vt.fromClass(class {
  constructor(t) {
    this.view = t, this.working = null, this.workScheduled = 0, this.chunkEnd = -1, this.chunkBudget = -1, this.work = this.work.bind(this), this.scheduleWork();
  }
  update(t) {
    let e = this.view.state.field(Bt.state).context;
  ...
  scheduleWork() {
    if (this.working)
      return;
    let { state: t } = this.view, e = t.field(Bt.state);
  ...
  work(t) {
    ...
    if (this.chunkEnd < e && (this.chunkEnd < 0 || this.view.hasFocus) && (this.chunkEnd = e + 3e4, this.chunkBudget = 3e3), this.chunkBudget <= 0)
      return;
    let { state: i, viewport: { to: s } } = this.view, r = i.field(Bt.state);
    if (r.tree == r.context.tree && r.context.isDone(
      s + 1e5
      /* MaxParseAhead */
    ))
      return;
    let o = Date.now() + Math.min(this.chunkBudget, 100, t && !Us ? Math.max(25, t.timeRemaining() - 5) : 1e9), l = r.context.treeLen < s && i.doc.length > s + 1e3, h = r.context.work(() => Us && Us() || Date.now() > o, s + (l ? 0 : 1e5));
    this.chunkBudget -= Date.now() - e, (h || this.chunkBudget <= 0) && (r.context.takeTree(), this.view.dispatch({ effects: Bt.setState.of(new Je(r.context)) })), this.chunkBudget > 0 && !(h && !l) && this.scheduleWork(), this.checkAsyncSchedule(r.context);
  }
...
const yd = /* @__PURE__ */ A.define(), nr = /* @__PURE__ */ A.define({
  combine: (n) => {
    if (!n.length)
      return "  ";
    let t = n[0];
...
function wi(n, t) {
  let e = "", i = n.tabSize, s = n.facet(nr)[0];
  if (s == "	") {
    for (; t >= i; )
      e += "	", t -= i;
    s = " ";
...
class Ds {
  ...
  */
  constructor(t, e = {}) {
    this.state = t, this.options = e, this.unit = ws(t);
  }
  /**
  ...
  */
  countColumn(t, e = t.length) {
    return As(t, this.state.tabSize, e);
  }
  /**
...
function bd(n, t, e) {
  return yh(t.resolveInner(e).enterUnfinishedNodesBefore(e), e, n);
}
function kd(n) {
  return n.pos == n.options.simulateBreak && n.options.simulateDoubleBreak;
}
function xd(n) {
  let t = n.type.prop(wh);
  if (t)
    return t;
  let e = n.firstChild, i;
  if (e && (i = e.type.prop(P.closedBy))) {
    let s = n.lastChild, r = s && i.indexOf(s.name) > -1;
    return (o) => Ad(o, !0, 1, void 0, r && !kd(o) ? s.from : void 0);
  }
...
function Ad(n, t, e, i, s) {
  let r = n.textAfter, o = r.match(/^\s*/)[0].length, l = i && r.slice(o, o + i.length) == i || s == n.pos + o, h = t ? Cd(n) : null;
  return h ? l ? n.column(h.from) : n.column(h.to) : n.baseIndent + (l ? 0 : n.unit * e);
}
function bo({ except: n, units: t = 1 } = {}) {
  return (e) => {
...
const Dd = /* @__PURE__ */ A.define(), bh = /* @__PURE__ */ new P();
function Td(n) {
...
function Pd(n, t, e) {
  ...
  for (let o = s; o; o = o.parent) {
    ...
    if (l && (o.to < i.length - 50 || i.length == n.doc.length || !Bd(o))) {
      let h = l(o, n);
...
const Ts = /* @__PURE__ */ _.define({ map: kh }), xi = /* @__PURE__ */ _.define({ map: kh });
function xh(n) {
  let t = [];
...
const Pe = /* @__PURE__ */ Et.define({
  ...
  update(n, t) {
    n = n.map(t.changes);
    for (let e of t.effects)
      e.is(Ts) && !Rd(n, e.value.from, e.value.to) ? n = n.update({ add: [ko.range(e.value.from, e.value.to)] }) : e.is(xi) && (n = n.update({
...
function bs(n, t, e) {
  var i;
  let s = null;
  return (i = n.field(Pe, !1)) === null || i === void 0 || i.between(t, e, (r, o) => {
...
function vh(n, t) {
  return n.field(Pe, !1) ? t : t.concat(_.appendConfig.of(Ah()));
}
const Ld = (n) => {
  for (let t of xh(n)) {
    let e = ys(n.state, t.from, t.to);
    if (e)
      return n.dispatch({ effects: vh(n.state, [Ts.of(e), Sh(n, e)]) }), !0;
  }
  return !1;
}, Ed = (n) => {
  if (!n.state.field(Pe, !1))
    return !1;
  let t = [];
  for (let e of xh(n)) {
    let i = bs(n.state, e.from, e.to);
    i && t.push(xi.of(i), Sh(n, i, !1));
  }
...
const Nd = (n) => {
  ...
  for (let i = 0; i < t.doc.length; ) {
    let s = n.lineBlockAt(i), r = ys(t, s.from, s.to);
    r && e.push(Ts.of(r)), i = (r ? n.lineBlockAt(r.to) : s).to + 1;
  }
  return e.length && n.dispatch({ effects: vh(n.state, e) }), !!e.length;
}, Id = (n) => {
...
function Ah(n) {
  let t = [Pe, Fd];
  return n && t.push(Ch.of(n)), t;
}
const ko = /* @__PURE__ */ E.replace({ widget: /* @__PURE__ */ new class extends Le {
  toDOM(n) {
    let { state: t } = n, e = t.facet(Ch), i = (r) => {
      let o = n.lineBlockAt(n.posAtDOM(r.target)), l = bs(n.state, o.from, o.to);
      l && n.dispatch({ effects: xi.of(l) }), r.preventDefault();
    };
    if (e.placeholderDOM)
      return e.placeholderDOM(n, i);
    let s = document.createElement("span");
    return s.textContent = e.placeholderText, s.setAttribute("aria-label", t.phrase("folded code")), s.title = t.phrase("unfold"), s.className = "cm-foldPlaceholder", s.onclick = i, s;
  }
}() }), _d = {
  openText: "⌄",
  closedText: "›",
...
function $d(n = {}) {
  let t = Object.assign(Object.assign({}, _d), n), e = new Qs(t, !0), i = new Qs(t, !1), s = vt.fromClass(class {
    constructor(o) {
    ...
    buildMarkers(o) {
      ...
      for (let h of o.viewportLineBlocks) {
        let a = bs(o.state, h.from, h.to) ? i : ys(o.state, h.from, h.to) ? e : null;
    ...
    qu({
      ...
      domEventHandlers: Object.assign(Object.assign({}, r), { click: (o, l, h) => {
        if (r.click && r.click(o, l, h))
          return !0;
        let a = bs(o.state, l.from, l.to);
        if (a)
          return o.dispatch({ effects: xi.of(a) }), !0;
        let c = ys(o.state, l.from, l.to);
...
class vi {
  constructor(t, e) {
    ...
    this.scope = o instanceof Bt ? (l) => l.prop(_e) == o.data : o ? (l) => l == o : void 0, this.style = gh(t.map((l) => ({
      tag: l.tag,
      class: l.class || s(Object.assign({}, l, { tag: null }))
    })), {
      all: r
    }).style, this.module = i ? new ue(i) : null, this.themeType = e.themeType;
  }
  /**
...
const Nn = /* @__PURE__ */ A.define(), Oh = /* @__PURE__ */ A.define({
  combine(n) {
    return n.length ? [n[0]] : null;
  }
});
function Js(n) {
  let t = n.facet(Nn);
  return t.length ? t : n.facet(Oh);
}
function xo(n, t) {
  let e = [Wd], i;
  return n instanceof vi && (n.module && e.push(T.styleModule.of(n.module)), i = n.themeType), t != null && t.fallback ? e.push(Oh.of(n)) : i ? e.push(Nn.computeN([T.darkTheme], (s) => s.facet(T.darkTheme) == (i == "dark") ? [n] : [])) : e.push(Nn.of(n)), e;
}
class zd {
  constructor(t) {
    this.markCache = /* @__PURE__ */ Object.create(null), this.tree = St(t.state), this.decorations = this.buildDeco(t, Js(t.state));
  }
  update(t) {
    let e = St(t.state), i = Js(t.state), s = i != Js(t.startState);
  ...
  buildDeco(t, e) {
    ...
    for (let { from: s, to: r } of t.visibleRanges)
      cd(this.tree, e, (o, l, h) => {
        i.add(o, l, this.markCache[h] || (this.markCache[h] = E.mark({ class: h })));
      }, s, r);
    return i.finish();
  }
}
const Wd = /* @__PURE__ */ Kn.high(/* @__PURE__ */ vt.fromClass(zd, {
  decorations: (n) => n.decorations
})), jd = /* @__PURE__ */ vi.define([
  {
    tag: m.meta,
    color: "#404740"
  },
...
]), Kd = /* @__PURE__ */ T.baseTheme({
  "&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
  "&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), Mh = 1e4, Dh = "()[]{}", Th = /* @__PURE__ */ A.define({
  combine(n) {
    return Cs(n, {
      afterCursor: !0,
      brackets: Dh,
...
}), qd = /* @__PURE__ */ E.mark({ class: "cm-matchingBracket" }), Gd = /* @__PURE__ */ E.mark({ class: "cm-nonmatchingBracket" });
function Ud(n) {
  let t = [], e = n.matched ? qd : Gd;
  return t.push(e.range(n.start.from, n.start.to)), n.end && t.push(e.range(n.end.from, n.end.to)), t;
}
const Qd = /* @__PURE__ */ Et.define({
  create() {
    return E.none;
  },
  update(n, t) {
    ...
    for (let s of t.state.selection.ranges) {
      if (!s.empty)
        continue;
      let r = jt(t.state, s.head, -1, i) || s.head > 0 && jt(t.state, s.head - 1, 1, i) || i.afterCursor && (jt(t.state, s.head, 1, i) || s.head < t.state.doc.length && jt(t.state, s.head + 1, -1, i));
...
function Vn(n) {
  let t = n.type.prop(Xd);
  return t ? t(n.node) : n;
}
function jt(n, t, e, i = {}) {
  let s = i.maxScanDistance || Mh, r = i.brackets || Dh, o = St(n), l = o.resolveInner(t, e);
  for (let h = l; h; h = h.parent) {
    let a = In(h.type, e, r);
    if (a && h.from < h.to) {
      let c = Vn(h);
      if (c && (e > 0 ? t >= c.from && t < c.to : t > c.from && t <= c.to))
        return Zd(n, t, e, h, c, a, r);
    }
  }
  return tp(n, t, e, o, l.type, s, r);
}
...
function tp(n, t, e, i, s, r, o) {
  ...
  for (let u = 0; !c.next().done && u <= r; ) {
    ...
    for (let w = e > 0 ? 0 : d.length - 1, g = e > 0 ? d.length : -1; w != g; w += e) {
      let y = o.indexOf(d[w]);
      if (!(y < 0 || i.resolveInner(p + w, 1).type != s))
        if (y % 2 == 0 == e > 0)
          f++;
        else {
          if (f == 1)
...
const ep = /* @__PURE__ */ Object.create(null), vo = [wt.none], So = [], ip = /* @__PURE__ */ Object.create(null);
for (let [n, t] of [
  ...
  ip[n] = /* @__PURE__ */ sp(ep, t);
function Ys(n, t) {
  So.indexOf(n) > -1 || (So.push(n), console.warn(t));
}
function sp(n, t) {
  let e = null;
  for (let r of t.split(".")) {
    let o = n[r] || m[r];
    o ? typeof o == "function" ? e ? e = o(e) : Ys(r, `Modifier ${r} used at start of tag`) : e ? Ys(r, `Tag ${r} used as modifier`) : e = o : Ys(r, `Unknown highlighting tag ${r}`);
  }
  if (!e)
    return 0;
  let i = t.replace(/ /g, "_"), s = wt.define({
    id: vo.length,
    name: i,
    props: [dh({ [i]: e })]
  });
  return vo.push(s), s.id;
}
const np = (n) => {
  let { state: t } = n, e = t.doc.lineAt(t.selection.main.from), i = hr(n.state, e.from);
...
const ni = 50;
function hp(n, { open: t, close: e }, i, s) {
  let r = n.sliceDoc(i - ni, i), o = n.sliceDoc(s, s + ni), l = /\s*$/.exec(r)[0].length, h = /^\s*/.exec(o)[0].length, a = r.length - l;
  ...
  let c, f;
  s - i <= 2 * ni ? c = f = n.sliceDoc(i, s) : (c = n.sliceDoc(i, i + ni), f = n.sliceDoc(s - ni, s));
...
function Ph(n, t, e = t.selection.ranges) {
  let i = e.map((r) => hr(t, r.from).block);
  if (!i.every((r) => r))
    return null;
  let s = e.map((r, o) => hp(t, i[o], r.from, r.to));
  if (n != 2 && !s.every((r) => r))
...
function cp(n, t, e = t.selection.ranges) {
  let i = [], s = -1;
  for (let { from: r, to: o } of e) {
    let l = i.length, h = 1e9, a = hr(t, r).line;
    if (a) {
      for (let c = r; c <= o; ) {
...
function Bh(n, t) {
  return Nt(n, (e) => e.empty ? n.moveByChar(e, t) : Ps(e, t));
}
function at(n) {
  return n.textDirectionAt(n.state.selection.main.head) == J.LTR;
}
const Rh = (n) => Bh(n, !at(n)), Lh = (n) => Bh(n, at(n));
function Eh(n, t) {
  return Nt(n, (e) => e.empty ? n.moveByGroup(e, t) : Ps(e, t));
}
const fp = (n) => Eh(n, !at(n)), up = (n) => Eh(n, at(n));
function dp(n, t, e) {
  if (t.type.prop(e))
    return !0;
  let i = t.to - t.from;
...
function Bs(n, t, e) {
  let i = St(n).resolveInner(t.head), s = e ? P.closedBy : P.openedBy;
  for (let h = t.head; ; ) {
    let a = e ? i.childAfter(h) : i.childBefore(h);
    if (!a)
      break;
    dp(n, a, s) ? i = a : h = e ? a.to : a.from;
  }
  let r = i.type.prop(s), o, l;
  return r && (o = e ? jt(n, i.from, 1) : jt(n, i.to, -1)) && o.matched ? l = e ? o.end.to : o.end.from : l = e ? i.to : i.from, b.cursor(l, e ? -1 : 1);
}
const pp = (n) => Nt(n, (t) => Bs(n.state, t, !at(n))), gp = (n) => Nt(n, (t) => Bs(n.state, t, at(n)));
function Nh(n, t) {
  return Nt(n, (e) => {
    if (!e.empty)
      return Ps(e, t);
...
function _h(n, t) {
  let e = Hh(n), { state: i } = n, s = Ze(i.selection, (o) => o.empty ? n.moveVertically(o, t, e.height) : Ps(o, t));
  if (s.eq(i.selection))
    return !1;
  let r;
  if (e.selfScroll) {
...
const mp = (n) => Nt(n, (t) => ye(n, t, !0)), wp = (n) => Nt(n, (t) => ye(n, t, !1)), yp = (n) => Nt(n, (t) => ye(n, t, !at(n))), bp = (n) => Nt(n, (t) => ye(n, t, at(n))), kp = (n) => Nt(n, (t) => b.cursor(n.lineBlockAt(t.head).from, 1)), xp = (n) => Nt(n, (t) => b.cursor(n.lineBlockAt(t.head).to, -1));
function vp(n, t, e) {
  let i = !1, s = Ze(n.selection, (r) => {
    let o = jt(n, r.head, -1) || jt(n, r.head, 1) || r.head > 0 && jt(n, r.head - 1, 1) || r.head < n.doc.length && jt(n, r.head + 1, -1);
    if (!o || !o.end)
      return r;
    i = !0;
...
const Sp = ({ state: n, dispatch: t }) => vp(n, t, !1);
function Mt(n, t) {
  let e = Ze(n.state.selection, (i) => {
    let s = t(i);
...
function $h(n, t) {
  return Mt(n, (e) => n.moveByChar(e, t));
}
const Fh = (n) => $h(n, !at(n)), zh = (n) => $h(n, at(n));
function Wh(n, t) {
  return Mt(n, (e) => n.moveByGroup(e, t));
}
const Cp = (n) => Wh(n, !at(n)), Ap = (n) => Wh(n, at(n)), Op = (n) => Mt(n, (t) => Bs(n.state, t, !at(n))), Mp = (n) => Mt(n, (t) => Bs(n.state, t, at(n)));
function jh(n, t) {
  return Mt(n, (e) => n.moveVertically(e, t));
}
const Kh = (n) => jh(n, !1), qh = (n) => jh(n, !0);
function Gh(n, t) {
  return Mt(n, (e) => n.moveVertically(e, t, Hh(n).height));
}
const Ao = (n) => Gh(n, !1), Oo = (n) => Gh(n, !0), Dp = (n) => Mt(n, (t) => ye(n, t, !0)), Tp = (n) => Mt(n, (t) => ye(n, t, !1)), Pp = (n) => Mt(n, (t) => ye(n, t, !at(n))), Bp = (n) => Mt(n, (t) => ye(n, t, at(n))), Rp = (n) => Mt(n, (t) => b.cursor(n.lineBlockAt(t.head).from)), Lp = (n) => Mt(n, (t) => b.cursor(n.lineBlockAt(t.head).to)), Mo = ({ state: n, dispatch: t }) => (t(qt(n, { anchor: 0 })), !0), Do = ({ state: n, dispatch: t }) => (t(qt(n, { anchor: n.doc.length })), !0), To = ({ state: n, dispatch: t }) => (t(qt(n, { anchor: n.selection.main.anchor, head: 0 })), !0), Po = ({ state: n, dispatch: t }) => (t(qt(n, { anchor: n.selection.main.anchor, head: n.doc.length })), !0), Ep = ({ state: n, dispatch: t }) => (t(n.update({ selection: { anchor: 0, head: n.doc.length }, userEvent: "select" })), !0), Np = ({ state: n, dispatch: t }) => {
  let e = Ls(n).map(({ from: i, to: s }) => b.range(i, Math.min(s + 1, n.doc.length)));
  return t(n.update({ selection: b.create(e), userEvent: "select" })), !0;
}, Ip = ({ state: n, dispatch: t }) => {
  let e = Ze(n.selection, (i) => {
    var s;
    let r = St(n).resolveInner(i.head, 1);
    for (; !(r.from < i.from && r.to >= i.to || r.to > i.to && r.from <= i.from || !(!((s = r.parent) === null || s === void 0) && s.parent)); )
      r = r.parent;
    return b.range(r.to, r.from);
  });
  return t(qt(n, e)), !0;
}, Vp = ({ state: n, dispatch: t }) => {
...
function Rs(n, t) {
  ...
  let e = "delete.selection", { state: i } = n, s = i.changeByRange((r) => {
    ...
    if (o == l) {
      let h = t(o);
      h < o ? (e = "delete.backward", h = $i(n, h, !1)) : h > o && (e = "delete.forward", h = $i(n, h, !0)), o = Math.min(o, h), l = Math.max(l, h);
    } else
      o = $i(n, o, !1), l = $i(n, l, !0);
...
const Uh = (n, t) => Rs(n, (e) => {
  ...
  if (!t && e > s.from && e < s.from + 200 && !/[^ \t]/.test(r = s.text.slice(0, e - s.from))) {
    if (r[r.length - 1] == "	")
      return e - 1;
    let l = As(r, i.tabSize), h = l % ws(i) || ws(i);
    for (let a = 0; a < h && r[r.length - 1 - a] == " "; a++)
      e--;
    o = e;
  } else
    o = mt(s.text, e - s.from, t, t) + s.from, o == e && s.number != (t ? i.doc.lines : 1) && (o += t ? 1 : -1);
  return o;
}), _n = (n) => Uh(n, !1), Qh = (n) => Uh(n, !0), Jh = (n, t) => Rs(n, (e) => {
  ...
  for (let l = null; ; ) {
    ...
    let h = mt(r.text, i - r.from, t) + r.from, a = r.text.slice(Math.min(i, h) - r.from, Math.max(i, h) - r.from), c = o(a);
    if (l != null && c != l)
      break;
    (a != " " || i != e) && (l = c), i = h;
  }
  return i;
}), Yh = (n) => Jh(n, !1), Hp = (n) => Jh(n, !0), Xh = (n) => Rs(n, (t) => {
...
}, Fp = ({ state: n, dispatch: t }) => {
  if (n.readOnly)
    return !1;
  let e = n.changeByRange((i) => {
    if (!i.empty || i.from == 0 || i.from == n.doc.length)
      return { range: i };
    let s = i.from, r = n.doc.lineAt(s), o = s == r.from ? s - 1 : mt(r.text, s - r.from, !1) + r.from, l = s == r.to ? s + 1 : mt(r.text, s - r.from, !0) + r.from;
    return {
...
const zp = ({ state: n, dispatch: t }) => Zh(n, t, !1), Wp = ({ state: n, dispatch: t }) => Zh(n, t, !0);
function ta(n, t, e) {
  if (n.readOnly)
    return !1;
  let i = [];
...
const jp = ({ state: n, dispatch: t }) => ta(n, t, !1), Kp = ({ state: n, dispatch: t }) => ta(n, t, !0), qp = (n) => {
  if (n.state.readOnly)
    return !1;
  let { state: t } = n, e = t.changes(Ls(t).map(({ from: s, to: r }) => (s > 0 ? s-- : r < t.doc.length && r++, { from: s, to: r }))), i = Ze(t.selection, (s) => n.moveVertically(s, !0)).map(e);
  return n.dispatch({ changes: e, selection: i, scrollIntoView: !0, userEvent: "delete.line" }), !0;
};
function Gp(n, t) {
  if (/\(\)|\[\]|\{\}/.test(n.sliceDoc(t - 1, t + 1)))
    return { from: t, to: t };
  let e = St(n).resolveInner(t), i = e.childBefore(t), s = e.childAfter(t), r;
  return i && s && i.to <= t && s.from >= t && (r = i.type.prop(P.closedBy)) && r.indexOf(s.name) > -1 && n.doc.lineAt(i.to).from == n.doc.lineAt(s.from).from ? { from: i.to, to: s.from } : null;
}
const Up = /* @__PURE__ */ ea(!1), Qp = /* @__PURE__ */ ea(!0);
function ea(n) {
  return ({ state: t, dispatch: e }) => {
    if (t.readOnly)
      return !1;
    let i = t.changeByRange((s) => {
      let { from: r, to: o } = s, l = t.doc.lineAt(r), h = !n && r == o && Gp(t, r);
      n && (r = o = (o <= l.to ? l : t.doc.lineAt(o)).to);
      let a = new Ds(t, { simulateBreak: r, simulateDoubleBreak: !!h }), c = rr(a, r);
...
const Jp = ({ state: n, dispatch: t }) => {
  if (n.readOnly)
    return !1;
  let e = /* @__PURE__ */ Object.create(null), i = new Ds(n, { overrideIndentation: (r) => {
    let o = e[r];
    return o ?? -1;
  } }), s = ar(n, (r, o, l) => {
    let h = rr(i, r.from);
    if (h == null)
      return;
    /\S/.test(r.text) || (h = 0);
    let a = /^\s*/.exec(r.text)[0], c = wi(n, h);
...
}, Yp = ({ state: n, dispatch: t }) => n.readOnly ? !1 : (t(n.update(ar(n, (e, i) => {
  i.push({ from: e.from, insert: n.facet(nr) });
}), { userEvent: "input.indent" })), !0), Xp = ({ state: n, dispatch: t }) => n.readOnly ? !1 : (t(n.update(ar(n, (e, i) => {
  let s = /^\s*/.exec(e.text)[0];
  if (!s)
    return;
  let r = As(s, n.tabSize), o = 0, l = wi(n, Math.max(0, r - ws(n)));
  for (; o < s.length && o < l.length && s.charCodeAt(o) == l.charCodeAt(o); )
    o++;
  i.push({ from: e.from + o, to: e.from + s.length, insert: l.slice(o) });
}), { userEvent: "delete.dedent" })), !0), Zp = [
  { key: "Ctrl-b", run: Rh, shift: Fh, preventDefault: !0 },
  { key: "Ctrl-f", run: Lh, shift: zh },
  { key: "Ctrl-p", run: Ih, shift: Kh },
  { key: "Ctrl-n", run: Vh, shift: qh },
  { key: "Ctrl-a", run: kp, shift: Rp },
  { key: "Ctrl-e", run: xp, shift: Lp },
  { key: "Ctrl-d", run: Qh },
  { key: "Ctrl-h", run: _n },
  { key: "Ctrl-k", run: Xh },
  { key: "Ctrl-Alt-h", run: Yh },
  { key: "Ctrl-o", run: $p },
  { key: "Ctrl-t", run: Fp },
  { key: "Ctrl-v", run: Hn }
], tg = /* @__PURE__ */ [
  { key: "ArrowLeft", run: Rh, shift: Fh, preventDefault: !0 },
  { key: "Mod-ArrowLeft", mac: "Alt-ArrowLeft", run: fp, shift: Cp, preventDefault: !0 },
  { mac: "Cmd-ArrowLeft", run: yp, shift: Pp, preventDefault: !0 },
  { key: "ArrowRight", run: Lh, shift: zh, preventDefault: !0 },
  { key: "Mod-ArrowRight", mac: "Alt-ArrowRight", run: up, shift: Ap, preventDefault: !0 },
  { mac: "Cmd-ArrowRight", run: bp, shift: Bp, preventDefault: !0 },
  { key: "ArrowUp", run: Ih, shift: Kh, preventDefault: !0 },
  { mac: "Cmd-ArrowUp", run: Mo, shift: To },
  { mac: "Ctrl-ArrowUp", run: Co, shift: Ao },
  { key: "ArrowDown", run: Vh, shift: qh, preventDefault: !0 },
  { mac: "Cmd-ArrowDown", run: Do, shift: Po },
  { mac: "Ctrl-ArrowDown", run: Hn, shift: Oo },
  { key: "PageUp", run: Co, shift: Ao },
  { key: "PageDown", run: Hn, shift: Oo },
  { key: "Home", run: wp, shift: Tp, preventDefault: !0 },
  { key: "Mod-Home", run: Mo, shift: To },
  { key: "End", run: mp, shift: Dp, preventDefault: !0 },
  { key: "Mod-End", run: Do, shift: Po },
  { key: "Enter", run: Up },
  { key: "Mod-a", run: Ep },
  { key: "Backspace", run: _n, shift: _n },
  { key: "Delete", run: Qh },
  { key: "Mod-Backspace", mac: "Alt-Backspace", run: Yh },
  { key: "Mod-Delete", mac: "Alt-Delete", run: Hp },
  { mac: "Mod-Backspace", run: _p },
  { mac: "Mod-Delete", run: Xh }
].concat(/* @__PURE__ */ Zp.map((n) => ({ mac: n.key, run: n.run, shift: n.shift }))), eg = /* @__PURE__ */ [
  { key: "Alt-ArrowLeft", mac: "Ctrl-ArrowLeft", run: pp, shift: Op },
  { key: "Alt-ArrowRight", mac: "Ctrl-ArrowRight", run: gp, shift: Mp },
  { key: "Alt-ArrowUp", run: zp },
  { key: "Shift-Alt-ArrowUp", run: jp },
  { key: "Alt-ArrowDown", run: Wp },
  { key: "Shift-Alt-ArrowDown", run: Kp },
  { key: "Escape", run: Vp },
  { key: "Mod-Enter", run: Qp },
  { key: "Alt-l", mac: "Ctrl-l", run: Np },
  { key: "Mod-i", run: Ip, preventDefault: !0 },
  { key: "Mod-[", run: Xp },
  { key: "Mod-]", run: Yp },
  { key: "Mod-Alt-\\", run: Jp },
  { key: "Shift-Mod-k", run: qp },
  { key: "Shift-Mod-\\", run: Sp },
  { key: "Mod-/", run: np },
  { key: "Alt-A", run: op }
].concat(tg);
class ks {
  ...
  static start(t, e, i = 0) {
    ...
    return new ks(t, [], e, i, i, 0, [], 0, s ? new Bo(s, s.start) : null, 0, null);
  }
  ...
  split() {
    ...
    for (; t && s == t.bufferBase; )
      t = t.parent;
    return new ks(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, i, s, this.curContext, this.lookAhead, t);
  }
  ...
  updateContext(t) {
    if (t != this.curContext.context) {
      let e = new Bo(this.curContext.tracker, t);
...
class xs {
  ...
  static create(t, e = t.bufferBase + t.buffer.length) {
    return new xs(t, e, e - t.bufferBase);
  }
  maybeNext() {
  ...
  fork() {
    return new xs(this.stack, this.pos, this.index);
  }
}
function Fi(n, t = Uint16Array) {
  if (typeof n != "string")
    return n;
  let e = null;
...
class sg {
  /// @internal
  constructor(t, e) {
    this.input = t, this.ranges = e, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = Lo, this.rangeIndex = 0, this.pos = this.chunkPos = e[0].from, this.range = e[0], this.end = e[e.length - 1].to, this.readNext();
  }
  /// @internal
  resolveOffset(t, e) {
  ...
  /// @internal
  reset(t, e) {
    if (e ? (this.token = e, e.start = t, e.lookAhead = t + 1, e.value = e.extended = -1) : this.token = Lo, this.pos != t) {
...
class je {
  ...
  token(t, e) {
    let { parser: i } = e.p;
    ng(this.data, t, e, this.id, i.data, i.tokenPrecTable);
  }
}
  ...
  t:
    for (; l & n[o]; ) {
      ...
      for (let d = o + 3; d < a; d += 2)
        if ((n[d + 1] & l) > 0) {
          let p = n[d];
          if (h.allows(p) && (t.token.value == -1 || t.token.value == p || rg(p, t.token.value, s, r))) {
            t.acceptToken(p);
            break;
          }
        }
      let c = t.next, f = 0, u = n[o + 2];
      if (t.next < 0 && u > f && n[a + u * 3 - 3] == 65535 && n[a + u * 3 - 3] == 65535) {
        o = n[a + u * 3 - 1];
        continue t;
      }
      for (; f < u; ) {
        let d = f + u >> 1, p = a + d + (d << 1), w = n[p], g = n[p + 1] || 65536;
        if (c < w)
          u = d;
        else if (c >= g)
          f = d + 1;
...
function Io(n, t, e) {
  let i = n.cursor(tt.IncludeAnonymous);
  for (i.moveTo(t); ; )
...
class og {
  ...
  nextFragment() {
    ...
    if (t) {
      for (this.safeFrom = t.openStart ? Io(t.tree, t.from + t.offset, 1) - t.offset : t.from, this.safeTo = t.openEnd ? Io(t.tree, t.to + t.offset, -1) - t.offset : t.to; this.trees.length; )
...
class lg {
  constructor(t, e) {
    this.stream = e, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = t.tokenizers.map((i) => new Xi());
  }
  getActions(t) {
    ...
    for (; this.actions.length > e; )
      this.actions.pop();
    return h && t.setLookAhead(h), !i && t.pos == this.stream.end && (i = new Xi(), i.value = t.p.parser.eofTerm, i.start = i.end = t.pos, e = this.addActions(t, i.value, i.end, e)), this.mainToken = i, this.actions;
  }
  getMainToken(t) {
    if (this.mainToken)
      return this.mainToken;
    let e = new Xi(), { pos: i, p: s } = t;
      ...
      for (let a = o.stateSlot(
        ...
        if (l[a] == 65535)
          if (l[a + 1] == 1)
            ...
            s == 0 && l[a + 1] == 2 && (s = this.putAction(Qt(l, a + 2), e, i, s));
            break;
          }
        l[a] == e && (s = this.putAction(Qt(l, a + 1), e, i, s));
      }
    return s;
  }
}
...
class hg {
  constructor(t, e, i, s) {
    this.parser = t, this.input = e, this.ranges = s, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new sg(e, s), this.tokens = new lg(t, this.stream), this.topTerm = t.top[1];
    let { from: r } = s[0];
    this.stacks = [ks.start(this, t.top[0], r)], this.fragments = i.length && this.stream.end - r > t.bufferLength * 4 ? new og(i, t.nodeSet) : null;
  }
  get parsedPos() {
  ...
  advance() {
    ...
    if (!i.length) {
      ...
      if (this.parser.strict)
        throw Pt && s && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), new SyntaxError("No parse at " + e);
  ...
  advanceStack(t, e, i) {
    let s = t.pos, { parser: r } = this, o = Pt ? this.stackID(t) + " -> " : "";
    ...
    if (this.fragments) {
      ...
      for (let f = this.fragments.nodeAt(s); f; ) {
        ...
        if (!(f instanceof Q) || f.children.length == 0 || f.positions[0] > 0)
          break;
        let d = f.children[0];
        if (d instanceof Q && f.positions[0] == 0)
          f = d;
        else
          break;
      }
    ...
    for (let a = 0; a < h.length; ) {
      ...
      if (p.apply(c, f, u), Pt && console.log(o + this.stackID(p) + ` (via ${c & 65536 ? `reduce of ${r.getName(
        c & 65535
        /* Action.ValueMask */
  ...
  runRecovery(t, e, i) {
    let s = null, r = !1;
    for (let o = 0; o < t.length; o++) {
      let l = t[o], h = e[o << 1], a = e[(o << 1) + 1], c = Pt ? this.stackID(l) + " -> " : "";
      ...
      this.stream.end > l.pos ? (a == l.pos && (a++, h = 0), l.recoverByDelete(h, a), Pt && console.log(c + this.stackID(l) + ` (via recover-delete ${this.parser.getName(h)})`), Ho(l, i)) : (!s || s.score < l.score) && (s = l);
    }
    return s;
  }
  // Convert the stack's buffer to a syntax tree.
  stackToTree(t) {
    return t.close(), Q.build({
      buffer: xs.create(t),
  ...
  stackID(t) {
    let e = (Xs || (Xs = /* @__PURE__ */ new WeakMap())).get(t);
    return e || Xs.set(t, e = String.fromCodePoint(this.nextStackID++)), e + t;
  }
}
function Ho(n, t) {
  for (let e = 0; e < t.length; e++) {
...
class vs extends uh {
  ...
  constructor(t) {
    ...
    this.nodeSet = new tr(e.map((l, h) => wt.define({
  ...
  configure(t) {
    let e = Object.assign(Object.create(vs.prototype), this);
    ...
    return t.tokenizers && (e.tokenizers = this.tokenizers.map((i) => {
      ...
      return e.specializers[s] = _o(o), o;
...
const fg = dh({
  ...
  tokenPrec: 0
}), dg = /* @__PURE__ */ gs.define({
  name: "json",
  parser: /* @__PURE__ */ ug.configure({
    props: [
      /* @__PURE__ */ wh.add({
        Object: /* @__PURE__ */ bo({ except: /^\s*\}/ }),
        Array: /* @__PURE__ */ bo({ except: /^\s*\]/ })
      }),
      /* @__PURE__ */ bh.add({
        "Object Array": Td
      })
...
class ve {
  ...
  static init(t, e, i) {
    let s = t, r = i.facet(ra).markerFilter;
    r && (s = r(s));
    let o = E.set(s.map((l) => l.from == l.to || l.from == l.to - 1 && i.doc.lineAt(l.from).to == l.from ? E.widget({
      widget: new Cg(l),
      diagnostic: l
    }).range(l.from) : E.mark({
    ...
    return new ve(o, e, Ye(o));
  }
}
function Ye(n, t = null, e = 0) {
  let i = null;
  return n.between(e, 1e9, (s, r, { spec: o }) => {
    if (!(t && o.diagnostic != t))
      return i = new gg(s, r, o.diagnostic), !1;
  }), i;
}
function mg(n, t) {
  let e = n.startState.doc.lineAt(t.pos);
  return !!(n.effects.some((i) => i.is(sa)) || n.changes.touchesRange(e.from, e.to));
}
function wg(n, t) {
  return n.field(kt, !1) ? t : t.concat(_.appendConfig.of(Mg));
}
const sa = /* @__PURE__ */ _.define(), cr = /* @__PURE__ */ _.define(), na = /* @__PURE__ */ _.define(), kt = /* @__PURE__ */ Et.define({
  create() {
    return new ve(E.none, null, null);
  },
  update(n, t) {
    if (t.docChanged) {
      ...
      if (n.selected) {
        ...
        i = Ye(e, n.selected.diagnostic, s) || Ye(e, null, s);
      }
      n = new ve(e, n.panel, i);
    }
    for (let e of t.effects)
      e.is(sa) ? n = ve.init(e.value, n.panel, t.state) : e.is(cr) ? n = new ve(n.diagnostics, e.value ? Es.open : null, n.selected) : e.is(na) && (n = new ve(n.diagnostics, n.panel, e.value));
    return n;
  },
  provide: (n) => [
    Bn.from(n, (t) => t.panel),
...
}), yg = /* @__PURE__ */ E.mark({ class: "cm-lintRange cm-lintRange-active" });
function bg(n, t, e) {
  let { diagnostics: i } = n.state.field(kt), s = [], r = 2e8, o = 0;
  i.between(t - (e < 0 ? 1 : 0), t + (e > 0 ? 1 : 0), (h, a, { spec: c }) => {
    t >= h && t <= a && (h == a || (t > h || e > 0) && (t < a || e < 0)) && (s.push(c.diagnostic), r = Math.min(h, r), o = Math.max(a, o));
  });
  let l = n.state.facet(ra).tooltipFilter;
...
function kg(n, t) {
  return Wt("ul", { class: "cm-tooltip-lint" }, t.map((e) => la(n, e, !1)));
}
const xg = (n) => {
  let t = n.state.field(kt, !1);
  (!t || !t.panel) && n.dispatch({ effects: wg(n.state, [cr.of(!0)]) });
  let e = ju(n, Es.open);
  return e && e.dom.querySelector(".cm-panel-lint ul").focus(), !0;
}, $o = (n) => {
  let t = n.state.field(kt, !1);
  return !t || !t.panel ? !1 : (n.dispatch({ effects: cr.of(!1) }), !0);
}, vg = (n) => {
  let t = n.state.field(kt, !1);
  if (!t)
    return !1;
  ...
  { key: "F8", run: vg }
], ra = /* @__PURE__ */ A.define({
  combine(n) {
    return Object.assign({ sources: n.map((t) => t.source) }, Cs(n.map((t) => t.config), {
      delay: 750,
      markerFilter: null,
      tooltipFilter: null,
      needsRefresh: null
...
function la(n, t, e) {
  var i;
  let s = e ? oa(t.actions) : [];
  return Wt("li", { class: "cm-diagnostic cm-diagnostic-" + t.severity }, Wt("span", { class: "cm-diagnosticText" }, t.renderMessage ? t.renderMessage() : t.message), (i = t.actions) === null || i === void 0 ? void 0 : i.map((r, o) => {
    let l = !1, h = (u) => {
      if (u.preventDefault(), l)
        return;
      l = !0;
      let d = Ye(n.state.field(kt).diagnostics, t);
  ...
  }), t.source && Wt("div", { class: "cm-diagnosticSource" }, t.source));
}
class Cg extends Le {
  constructor(t) {
  ...
  toDOM() {
    return Wt("span", { class: "cm-lintPoint cm-lintPoint-" + this.diagnostic.severity });
  }
}
class Fo {
  constructor(t, e) {
    this.diagnostic = e, this.id = "item_" + Math.floor(Math.random() * 4294967295).toString(16), this.dom = la(t, e, !0), this.dom.id = this.id, this.dom.setAttribute("role", "option");
  }
}
class Es {
  constructor(t) {
    ...
    let e = (s) => {
      if (s.keyCode == 27)
        ...
        let { diagnostic: r } = this.items[this.selectedIndex], o = oa(r.actions);
        for (let l = 0; l < o.length; l++)
          if (o[l].toUpperCase().charCodeAt(0) == s.keyCode) {
            let h = Ye(this.view.state.field(kt).diagnostics, r);
    ...
    this.list = Wt("ul", {
      ...
      onkeydown: e,
      onclick: i
    }), this.dom = Wt("div", { class: "cm-panel-lint" }, this.list, Wt("button", {
      type: "button",
      name: "close",
  ...
  get selectedIndex() {
    let t = this.view.state.field(kt).selected;
    if (!t)
      return -1;
  ...
  update() {
    let { diagnostics: t, selected: e } = this.view.state.field(kt), i = 0, s = !1, r = null;
    for (t.between(0, this.view.state.doc.length, (o, l, { spec: h }) => {
      ...
      a < 0 ? (c = new Fo(this.view, h.diagnostic), this.items.splice(i, 0, c), s = !0) : (c = this.items[a], a > i && (this.items.splice(i, a - i), s = !0)), e && c.diagnostic == e.diagnostic ? c.dom.hasAttribute("aria-selected") || (c.dom.setAttribute("aria-selected", "true"), r = c) : c.dom.hasAttribute("aria-selected") && c.dom.removeAttribute("aria-selected"), i++;
  ...
  moveSelection(t) {
    if (this.selectedIndex < 0)
      return;
    let e = this.view.state.field(kt), i = Ye(e.diagnostics, this.items[t].diagnostic);
...
function Ag(n, t = 'viewBox="0 0 40 40"') {
  return `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${t}>${encodeURIComponent(n)}</svg>')`;
}
function zi(n) {
  return Ag(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${n}" fill="none" stroke-width=".7"/>`, 'width="6" height="3"');
}
const Og = /* @__PURE__ */ T.baseTheme({
  ".cm-diagnostic": {
  ...
  ".cm-lintRange-error": { backgroundImage: /* @__PURE__ */ zi("#d11") },
  ...
  kt,
  /* @__PURE__ */ T.decorations.compute([kt], (n) => {
    let { selected: t, panel: e } = n.field(kt);
    return !t || !e || t.from == t.to ? E.none : E.set([
      yg.range(t.from, t.to)
    ]);
  }),
  /* @__PURE__ */ zu(bg, { hideOn: mg }),
  Og
], Dg = "#e5c07b", zo = "#e06c75", Tg = "#56b6c2", Pg = "#ffffff", Zi = "#abb2bf", $n = "#7d8799", Bg = "#61afef", Rg = "#98c379", Wo = "#d19a66", Lg = "#c678dd", Eg = "#21252b", jo = "#2c313a", Ko = "#282c34", Zs = "#353a42", Ng = "#3E4451", qo = "#528bff", Ig = /* @__PURE__ */ T.theme({
  "&": {
    color: Zi,
    backgroundColor: Ko
  },
  ...
  ".cm-cursor, .cm-dropCursor": { borderLeftColor: qo },
  "&.cm-focused > .cm-scroller > .cm-selectionLayer .cm-selectionBackground, .cm-selectionBackground, .cm-content ::selection": { backgroundColor: Ng },
  ".cm-panels": { backgroundColor: Eg, color: Zi },
...
window.__hst_controls_dark.push(ha);
var Go;
(Go = window.__hst_controls_dark_ready) == null || Go.call(window);
const Hg = {
  name: "HstJson",
  inheritAttrs: !1
}, _g = /* @__PURE__ */ X({
  ...
  setup(n, { emit: t }) {
    const e = n;
    let i;
    const s = it(""), r = it(!1), o = it(), l = {
      light: [T.baseTheme({}), xo(jd)],
      dark: [Ig, xo(Vg)]
    }, h = new yi(), a = [
      Zu(),
      Ru(),
      ...
      T.updateListener.of((c) => {
        s.value = c.view.state.doc.toString();
      }),
      h.of(l.light)
    ];
    return fa(() => {
      i = new T({
        ...
        i.dispatch({
          effects: [
            h.reconfigure(l[ha.value ? "dark" : "light"])
          ]
        });
      });
    }), ts(() => e.modelValue, () => {
      let c;
      try {
        c = JSON.stringify(JSON.parse(s.value)) === JSON.stringify(e.modelValue);
      } catch {
        c = !1;
      }
      ...
      r.value = !1;
      try {
        t("update:modelValue", JSON.parse(s.value));
      } catch {
        r.value = !0;
      }
    }), (c, f) => (D(), q(Lt, {
      title: c.title,
      class: ut(["histoire-json htw-cursor-text", c.$attrs.class]),
      style: Ot(c.$attrs.style)
    }, {
      actions: W(() => [
        r.value ? Rt((D(), q(xt(zn), {
          key: 0,
...
const $g = (n, t) => {
  ...
  setup(n, { emit: t }) {
    ...
    return (h, a) => (D(), q(Lt, {
      title: h.title,
      class: ut(["histoire-select htw-cursor-text htw-items-center", h.$attrs.class]),
      style: Ot(h.$attrs.style)
    }, {
      actions: W(() => [
        ot(h.$slots, "actions")
...
}), qg = Uo, Gg = va, Ug = Ma, Qg = Ba, Jg = Ea, Yg = Ia, Xg = $a, Zg = Wa, tm = Ya, em = oc, im = pc, sm = xc, nm = Me, rm = Oc, om = Fg, lm = Kg, dm = {
  HstButton: qg,
  HstButtonGroup: Gg,
  HstCheckbox: Ug,
  HstCheckboxList: Qg,
...
export {
  qg as HstButton,
  Gg as HstButtonGroup,
  Ug as HstCheckbox,
  Qg as HstCheckboxList,
  lm as HstColorSelect,
  em as HstColorShades,
  nm as HstCopyIcon,
  om as HstJson,
  Yg as HstNumber,
  rm as HstRadio,
