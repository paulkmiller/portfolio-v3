...
type LayoutRouteId = RouteId | "/(blog-article)/blog-posts" | "/(blog-article)/customization" | "/(blog-article)/moving-to-colorado" | "/(blog-article)/project-structure" | "/(waves)" | "/(waves)/404" | "/(waves)/blog" | null
