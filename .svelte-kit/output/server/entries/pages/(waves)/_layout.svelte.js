...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${
    (($$result.head += `<!-- HEAD_svelte-1l2d7ky_START --><link rel="“canonical”"${add_attribute(
      "href",
      siteBaseUrl,
      0
      ...
      image,
      0
    )}><meta name="twitter:card" content="summary_large_image"><script src="https://cdn.jsdelivr.net/npm/particles.js@2.0.0"><\/script><!-- HEAD_svelte-1l2d7ky_END -->`),
    "")
  }
