...
const HeroImage = create_ssr_component(
...
const SingleSparkle = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { color } = $$props;
    let { size } = $$props;
    let { style } = $$props;
    ...
    return `<div class="wrapper svelte-sixv8c" style="${
      "top: " +
      escape(style.top, true) +
      "; left: " +
      escape(style.left, true) +
      ";"
    }"><svg${add_attribute("width", size, 0)}${add_attribute(
      "height",
      size,
      0
    )} viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-sixv8c"><path d="M80 0C80 0 84.2846 41.2925 101.496 58.504C118.707 75.7154 160 80 160 80C160 80 118.707 84.2846 101.496 101.496C84.2846 118.707 80 160 80 160C80 160 75.7154 118.707 58.504 101.496C41.2925 84.2846 0 80 0 80C0 80 41.2925 75.7154 58.504 58.504C75.7154 41.2925 80 0 80 0Z"${add_attribute(
      "fill",
      color,
      0
    )}></path></svg>
...
const Sparkles = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    ...
    return `<div class="sparkle-wrapper svelte-exdx8u">${each(
      sparkles,
      (sparkle) => {
  ...
  <span class="slot-wrapper svelte-exdx8u">${
    slots.default ? slots.default({}) : ``
  }</span>
</div>`;
  }
...
const SparklingHighlight = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { color = "default" } = $$props;
    ...
    if ($$props.color === void 0 && $$bindings.color && color !== void 0)
      $$bindings.color(color);
    if (
      $$props.sparkleColor === void 0 &&
      $$bindings.sparkleColor &&
      sparkleColor !== void 0
    )
      $$bindings.sparkleColor(sparkleColor);
    $$result.css.add(css$7);
    return `${validate_component(Sparkles, "Sparkles").$$render(
      $$result,
      { color: sparkleColor },
      {},
      {
        default: () => {
          return `<strong class="${
            escape(null_to_empty(color), true) + " svelte-8f8x6d"
          }">${slots.default ? slots.default({}) : ``}</strong>`;
        },
      }
    )}`;
  }
...
const DiscoverButton = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { side = false } = $$props;
    if ($$props.side === void 0 && $$bindings.side && side !== void 0)
      $$bindings.side(side);
    $$result.css.add(css$6);
    return `<button class="${["svelte-160e42u", side ? "button-with-side" : ""]
      .join(" ")
      .trim()}"><div class="${["svelte-160e42u", side ? "side" : ""]
      .join(" ")
      .trim()}"></div>
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="hero" class="svelte-14zg98j"><div class="info svelte-14zg98j"><h1 class="svelte-14zg98j">Paul Miller</h1>
    <h2 class="svelte-14zg98j">I am a cat dad, gamer, and...
      ${validate_component(SparklingHighlight, "SparklingHighlight").$$render(
        $$result,
        { color: "secondary" },
        {},
        {
    ...
    <p class="svelte-14zg98j">Bringing Designs to Life <span class="secondary svelte-14zg98j">&amp;</span><br>
      Probably playing ${validate_component(Tooltip, "Tooltip").$$render(
        $$result,
        { tip },
        {},
        {
    ...
    <div class="socials svelte-14zg98j"><span class="svelte-14zg98j">Socials:</span>
      ${validate_component(Socials, "Socials").$$render(
        $$result,
        {},
        {},
        {}
      )}</div>
    ${validate_component(DiscoverButton, "DiscoverButton").$$render(
      $$result,
      { side: true },
      {},
      {
...
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  <div class="ctas svelte-jsmmw5">${validate_component(
    Sparkles,
    "Sparkles"
  ).$$render(
    $$result,
    ...
    {},
    {
      default: () => {
        return `${validate_component(Button, "Button").$$render(
          ...
          {
            icon: () => {
              return `${validate_component(Email, "EmailIcon").$$render(
                $$result,
                { slot: "icon" },
                {},
                {}
...
const RecentPosts = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { posts } = $$props;
    ...
    return `${validate_component(ContentSection, "ContentSection").$$render(
      ...
      {
        button: () => {
          return `<div slot="button">${validate_component(
            Button,
            "Button"
          ).$$render(
            $$result,
...
const ProjectCard = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { name } = $$props;
    ...
    return `${validate_component(Card, "Card").$$render(
      ...
      {
        footer: () => {
          return `<div class="footer svelte-1w50j5m" slot="footer">${
            tags && tags.length > 0
              ? `<div class="tags svelte-1w50j5m">${each(tags, (tag) => {
        ...
        content: () => {
          return `<div class="content svelte-1w50j5m" slot="content"><div class="title svelte-1w50j5m"><span>${escape(
            name
          )}</span>
    ...
    <h6>${escape(description)}</h6></div>`;
        ...
        image: () => {
          return `<div class="image" slot="image">${validate_component(
            Image,
            "Image"
          ).$$render(
            $$result,
...
const ParticlesBackground = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
...
const Projects = create_ssr_component(
  ($$result, $$props, $$bindings, slots) => {
    let { projects } = $$props;
    if (
  ...
  <div class="projects-container svelte-1ixyf5e"><div class="two-group-grid svelte-1ixyf5e">${each(
    projects,
    (project) => {
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  return `<div class="container">${validate_component(Hero, "Hero").$$render(
    $$result,
    {},
    {},
    {}
  ...
  ${
    posts && posts.length > 0
      ? `${validate_component(RecentPosts, "RecentPosts").$$render(
          $$result,
          { posts },
          {},
          {}
