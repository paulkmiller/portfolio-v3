...
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="hero" class="svelte-14zg98j"><div class="info svelte-14zg98j"><h1 class="svelte-14zg98j">Paul Miller</h1>
    ...
    <p class="svelte-14zg98j">Bringing Designs to Life <span class="secondary svelte-14zg98j">&amp;</span>
      probably playing<br> <a href="https://steamcommunity.com/id/Kahram/" target="_blank">games</a>, ${validate_component(Tooltip, "Tooltip").$$render($$result, { tip }, {}, {
    default: () => {
      return `<a href="https://www.instagram.com/obewan_kanobi/" target="_blank">exploring the area</a>`;
    }
  })}, 
      or petting my cats.
    </p>
...
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<section id="about" class="wrapper svelte-jsmmw5"><div class="text svelte-jsmmw5">
    <p>I&#39;m a seasoned Front End Developer who loves bringing designs to 
      life through code. There&#39;s nothing quite like the thrill of 
      transforming a static mockup into an interactive, engaging 
      experience that users can enjoy.
    </p>
    <p>Over the years, I&#39;ve had the opportunity to work with a wide range 
      of technologies, from JavaScript frameworks like React and Vue to 
      backend systems like Ruby on Rails and PHP. More recently, I&#39;ve 
      been diving into SvelteKit and Go, along with headless CMS solutions 
      like Strapi and Contentful.
    </p>
    <p>If you&#39;re looking for a Front End Developer who&#39;s equal parts creative 
      and technical, I&#39;d love to chat. Feel free to check out my blog to see 
      what I&#39;m up to! And if you have a design that you&#39;re eager to see 
