...
const css$3 = {
  code: "#about.svelte-1e5ziel.svelte-1e5ziel{position:relative;display:grid;grid-template-columns:1fr;align-items:center;justify-content:space-between;padding-bottom:50px;gap:20px}@media(max-width: 767px){#about.svelte-1e5ziel.svelte-1e5ziel{grid-template-columns:1fr;justify-items:center;gap:20px}}#about.svelte-1e5ziel .text.svelte-1e5ziel{display:flex;flex-direction:column;gap:20px}@media(max-width: 767px){}#about.svelte-1e5ziel .ctas.svelte-1e5ziel{display:flex;flex-wrap:wrap;align-items:center;gap:10px;width:100%}",
  map: null
};
const About = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$3);
  return `<section id="about" class="wrapper svelte-1e5ziel"><div class="text svelte-1e5ziel">
		...
		<div class="ctas svelte-1e5ziel">${validate_component(Sparkles, "Sparkles").$$render($$result, {}, {}, {
    default: () => {
...
const ProjectCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Card, "Card").$$render($$result, { additionalClass: "project-card" }, {}, {
    ...
    content: () => {
      return `<div class="content svelte-eilkw8" slot="content"><div class="title svelte-eilkw8"><span><!-- HTML_TAG_START -->${name}<!-- HTML_TAG_END --></span></div>
