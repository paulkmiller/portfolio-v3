...
const ContentSection = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<section${add_attribute("id", id, 0)} class="${"content-section " + escape(align, true) + " svelte-1snaw8w"}"><div class="title-area svelte-1snaw8w">${title || description ? `<div class="text svelte-1snaw8w">${title ? `<h2>${escape(title)}</h2>` : ``}
