...
const Telegram = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg width="100%" height="100%" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 5L2 12.5L9 13.5M21 5L18.5 20L9 13.5M21 5L9 13.5M9 13.5V19L12.2488 15.7229" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"></path></svg>`;
});
...
const Socials = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="socials svelte-t4kqcq"><a href="#" target="_blank" rel="noopener noreferrer" title="Say Hi on Telegram" class="svelte-t4kqcq">${validate_component(Telegram, "TelegramIcon").$$render($$result, {}, {}, {})}</a>
	<a href="#" target="_blank" rel="me noreferrer" title="Say Hi on Mastodon" class="svelte-t4kqcq">${validate_component(Mastodon, "MastodonIcon").$$render($$result, {}, {}, {})}</a>
	<a href="#" target="_blank" rel="noopener noreferrer" title="See my GitHub profile" class="svelte-t4kqcq">${validate_component(Github, "GitHubIcon").$$render($$result, {}, {}, {})}</a>
	<a href="#" target="_blank" rel="noopener noreferrer" title="Connect on LinkedIn" class="svelte-t4kqcq">${validate_component(Linkedin, "LinkedInIcon").$$render($$result, {}, {}, {})}</a>
	<a href="#" target="_blank" rel="noopener noreferrer" title="Send an email" class="svelte-t4kqcq">${validate_component(Email, "EmailIcon").$$render($$result, {}, {}, {})}</a>
</div>`;
});
export {
  Github as G,
