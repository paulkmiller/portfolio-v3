...
const Callout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$result.css.add(css);
  return `<div class="${
    "callout-block " + escape(type ?? "", true) + " svelte-sxx0n0"
  }">${
    type
...
const metadata = {
  ...
  excerpt:
    "Turns out, moving across the country in the dead of night, is not the best plan.",
...
${validate_component(Callout, "Callout").$$render(
  $$result,
  { type: "info" },
  {},
  {
...
export { Page as P, __vite_glob_0_0 as _, metadata as m };
